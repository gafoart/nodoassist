// Check No Deprecated Channel Access script supports NodoAssist repository automation.
...
const RULES: Rule[] = [
  ...
  },
  {
    ...
    pattern: /from\s+["']nodoassist\/plugin-sdk\/group-access["']/u,
  },
  {
  ...
  },
  {
    ...
    pattern: /from\s+["']nodoassist\/plugin-sdk\/command-auth["']/u,
  },
  {
