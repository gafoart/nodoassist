...
const (
	...
	envDocsI18nProvider      = "NODOASSIST_DOCS_I18N_PROVIDER"
	envDocsI18nModel         = "NODOASSIST_DOCS_I18N_MODEL"
...
func validateNoTranslationTranscriptArtifacts(source, translated string) error {
	...
	for _, token := range []string{"<nodoassist_docs_i18n_input>", "</nodoassist_docs_i18n_input>"} {
