...
- Keep product names in English: NodoAssist, Raspberry Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the NodoAssist Gateway, use “Gateway 网关”.
