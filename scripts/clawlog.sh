...
show_usage() {
    cat << EOF
clawlog - NodoAssist Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View NodoAssist logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    NodoAssist logs flow through the macOS unified log (subsystem: ai.nodoassist).
