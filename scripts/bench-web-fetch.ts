...
const TEXT_BODY = "NodoAssist web_fetch direct text benchmark body.".repeat(160);
...
const toolConfig: NodoAssistConfig = {
  tools: {
    web: {
      fetch: {
        cacheTtlMinutes: 0,
...
function printUsage(): void {
  process.stdout.write(`NodoAssist web_fetch benchmark
