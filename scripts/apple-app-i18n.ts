...
const CATALOGS = [
  {
    ...
    coverage: {
      ...
      "apps/shared/NodoAssistKit/Sources/NodoAssistChatUI/ChatMessageViews.swift": ["Writing"],
    },
  },
  {
    path: "apps/macos/Sources/NodoAssist/Resources/Localizable.xcstrings",
    coverage: {
      "apps/macos/Sources/NodoAssist/ChannelsSettings+ChannelSections.swift": [
        "Logout",
        "Refresh",
        "Save",
      ],
      "apps/macos/Sources/NodoAssist/CronSettings+Rows.swift": ["Run now"],
    },
  },
] as const;
