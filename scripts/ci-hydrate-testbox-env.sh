...
profile_path="${1:-$HOME/.nodoassist-testbox-live.profile}"
helper_path="${2:-$HOME/.local/bin/nodoassist-testbox-env}"
...
profile_path="\${NODOASSIST_TESTBOX_PROFILE_FILE:-\$default_profile_path}"
