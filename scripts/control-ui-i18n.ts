// Control Ui I18N script supports NodoAssist repository automation.
...
import { completeSimple, type AssistantMessage, type Model } from "nodoassist/plugin-sdk/llm";
...
const ENV_PROVIDER = "NODOASSIST_CONTROL_UI_I18N_PROVIDER";
const ENV_MODEL = "NODOASSIST_CONTROL_UI_I18N_MODEL";
const ENV_THINKING = "NODOASSIST_CONTROL_UI_I18N_THINKING";
const ENV_BATCH_CHAR_BUDGET = "NODOASSIST_CONTROL_UI_I18N_BATCH_CHAR_BUDGET";
const ENV_PROMPT_TIMEOUT = "NODOASSIST_CONTROL_UI_I18N_PROMPT_TIMEOUT";
const ENV_AUTH_OPTIONAL = "NODOASSIST_CONTROL_UI_I18N_AUTH_OPTIONAL";
...
const DEFAULT_GLOSSARY: readonly GlossaryEntry[] = [
  { source: "NodoAssist", target: "NodoAssist" },
