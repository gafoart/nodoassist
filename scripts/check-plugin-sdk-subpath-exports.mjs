...
async function main() {
  ...
  if (violations.length === 0) {
    console.log("OK: all referenced nodoassist/plugin-sdk/<subpath> imports are exported.");
    return;
  }

  console.error(
    "Rule: every referenced nodoassist/plugin-sdk/<subpath> must exist in the public package exports.",
  );
