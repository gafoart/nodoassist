...
function parseArgs(argv, env = process.env) {
  const opts = parseFlagArgs(
    argv,
    {
      ...
      maxWallMs: readBudgetEnvNumber("NODOASSIST_TEST_PERF_MAX_WALL_MS", env),
      baselineWallMs: readBudgetEnvNumber("NODOASSIST_TEST_PERF_BASELINE_WALL_MS", env),
      maxRegressionPct: readBudgetEnvNumber("NODOASSIST_TEST_PERF_MAX_REGRESSION_PCT", env) ?? 10,
      reportOnly: readBooleanEnv("NODOASSIST_TEST_PERF_REPORT_ONLY", env),
    },
    [
