...
IMAGE_NAME="$(docker_e2e_resolve_image "nodoassist-crestodian-planner-e2e" NODOASSIST_CRESTODIAN_PLANNER_E2E_IMAGE)"
CONTAINER_NAME="nodoassist-crestodian-planner-e2e-$$"
RUN_LOG="$(mktemp -t nodoassist-crestodian-planner-log.XXXXXX)"
...
NODOASSIST_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 crestodian-planner empty)"
