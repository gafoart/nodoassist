...
IMAGE_NAME="$(docker_e2e_resolve_image "nodoassist-crestodian-first-run-e2e" NODOASSIST_CRESTODIAN_FIRST_RUN_E2E_IMAGE)"
CONTAINER_NAME="nodoassist-crestodian-first-run-e2e-$$"
RUN_LOG="$(mktemp -t nodoassist-crestodian-first-run-log.XXXXXX)"
...
NODOASSIST_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 crestodian-first-run empty)"
