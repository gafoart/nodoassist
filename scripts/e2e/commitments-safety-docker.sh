...
IMAGE_NAME="$(docker_e2e_resolve_image "nodoassist-commitments-safety-e2e" NODOASSIST_COMMITMENTS_SAFETY_E2E_IMAGE)"
CONTAINER_NAME="nodoassist-commitments-safety-e2e-$$"
RUN_LOG="$(mktemp -t nodoassist-commitments-safety-log.XXXXXX)"
