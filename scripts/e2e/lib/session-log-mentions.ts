// Session Log Mentions script supports NodoAssist repository automation.
...
export function readSessionLogMentionLimits(
  ...
  return {
    fileMaxBytes: readPositiveIntEnv(
      "NODOASSIST_SESSION_LOG_MENTION_FILE_MAX_BYTES",
      DEFAULT_FILE_MAX_BYTES,
      env,
    ),
    totalMaxBytes: readPositiveIntEnv(
      "NODOASSIST_SESSION_LOG_MENTION_TOTAL_MAX_BYTES",
