...
MODEL_REF="${NODOASSIST_OPENAI_CHAT_TOOLS_MODEL:?missing NODOASSIST_OPENAI_CHAT_TOOLS_MODEL}"
GATEWAY_LOG="/tmp/nodoassist-openai-chat-tools-gateway.log"
CLIENT_LOG="/tmp/nodoassist-openai-chat-tools-client.log"
gateway_pid=""
...
PORT="$PORT" NODOASSIST_GATEWAY_TOKEN="$TOKEN" MODEL_REF="$MODEL_REF" \
