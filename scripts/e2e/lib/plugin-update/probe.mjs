...
const pluginRecordSnapshot = () => {
  const config = readJson(nodoassistPath("nodoassist.json"));
...
function nodoassistPath(...parts) {
  return path.join(home, ".nodoassist", ...parts);
}
...
function seedInstallState() {
  writeJson(nodoassistPath("extensions", "lossless-claw", "package.json"), {
    name: "@example/lossless-claw",
    version: "0.9.0",
  });
  writeJson(process.env.NODOASSIST_CONFIG_PATH, { plugins: {} });
  writePluginInstallIndexForE2E({
    version: 1,
    warning: "DO NOT EDIT. This file is generated by NodoAssist plugin registry commands.",
...
function isCorruptPluginDisabledAfterUpdate(evidence, pluginId) {
  ...
  return (
    ...
    message.includes("NodoAssist will continue without it")
  );
}
...
function assertCorruptPluginDetails(plugins, pluginId) {
  ...
  const expectedFragments = disabledAfterFailure
    ? [
        ...
        "NodoAssist will continue without it",
