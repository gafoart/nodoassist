// Macos Discord script supports NodoAssist repository automation.
...
export class MacosDiscordSmoke {
  constructor(
    private input: {
      ...
      guest: MacosGuest;
      guestNode: string;
      guestNodoAssist: string;
      guestNodoAssistEntry: string;
      runDir: string;
      vmName: string;
    },
  ) {}
...
${this.input.guestNode} ${this.input.guestNodoAssistEntry} config set channels.discord.token ${shellQuote(this.input.config.token)}
${this.input.guestNode} ${this.input.guestNodoAssistEntry} config set channels.discord.enabled true
${this.input.guestNode} ${this.input.guestNodoAssistEntry} config set channels.discord.groupPolicy allowlist
${this.input.guestNode} ${this.input.guestNodoAssistEntry} config set channels.discord.guilds ${shellQuote(guilds)} --strict-json
${this.input.guestNode} ${this.input.guestNodoAssistEntry} doctor --fix --yes --non-interactive
...
JS
${this.input.guestNode} ${this.input.guestNodoAssistEntry} plugins enable discord
${this.input.guestNode} ${this.input.guestNodoAssistEntry} gateway restart
${this.input.guestNode} ${this.input.guestNodoAssistEntry} channels status --probe --json`);
  }
