...
IMAGE_NAME="$(docker_e2e_resolve_image "nodoassist-session-runtime-context-e2e" NODOASSIST_SESSION_RUNTIME_CONTEXT_E2E_IMAGE)"
CONTAINER_NAME="nodoassist-session-runtime-context-e2e-$$"
RUN_LOG="$(mktemp -t nodoassist-session-runtime-context-log.XXXXXX)"
