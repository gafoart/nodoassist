...
| Commits         | `scripts/committer "<message>" <files...>`                                     | Preferred scoped commit helper for NodoAssist changes.                                                             |
...
- `release-*`, `nodoassist-npm-*`, and `plugin-*-release-*`: release preparation,
