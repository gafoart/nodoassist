...
function ensureNodoAssistExtensionAlias(params) {
  ...
  const aliasDir = path.join(params.distExtensionsRoot, "node_modules", "nodoassist");
...
function shouldCopyRuntimeFile(relativePath) {
  return (
    ...
    isPathOrNestedPath(relativePath, "nodoassist.plugin.json") ||
...
export function stageBundledPluginRuntime(params = {}) {
  ...
  ensureNodoAssistExtensionAlias({ repoRoot, distExtensionsRoot });
