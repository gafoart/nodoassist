...
export function shouldInstallPlaywrightSystemDependencies(options = {}) {
  ...
  return (
    ...
    isTruthyEnvFlag(env.NODOASSIST_TESTBOX)
  );
}
...
export function ensurePlaywrightChromium(options = {}) {
  ...
  if (env.NODOASSIST_UI_E2E_ALLOW_MISSING_CHROMIUM === "1") {
    log(
      `[ui-e2e] Playwright Chromium is missing at ${executablePath}; NODOASSIST_UI_E2E_ALLOW_MISSING_CHROMIUM=1 leaves the lane skipped.`,
    );
    return 0;
  }
