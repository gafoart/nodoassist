// Android Version script supports NodoAssist repository automation.
...
export function renderAndroidVersionProperties(version: ResolvedAndroidVersion): string {
  return `# Shared Android version defaults.\n# Source of truth: apps/android/version.json\n# Generated by scripts/android-sync-versioning.ts.\n\nNODOASSIST_ANDROID_VERSION_NAME=${version.canonicalVersion}\nNODOASSIST_ANDROID_VERSION_CODE=${version.versionCode}\n`;
}
