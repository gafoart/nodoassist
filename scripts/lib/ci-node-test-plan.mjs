...
const GATEWAY_STARTUP_HEALTH_RUNTIME_ENV = {
  NODOASSIST_VITEST_NO_OUTPUT_TIMEOUT_MS: "60000",
};
...
function resolveAgentCoreShardName(file) {
  ...
  if (
    ...
    name.startsWith("nodoassist-tools") ||
...
function resolveInfraShardName(file) {
  ...
  if (
    ...
    name.startsWith("tmp-nodoassist-dir")
  ) {
  ...
  if (
    ...
    name.startsWith("nodoassist-exec-env") ||
  ...
  if (
    ...
    name.startsWith("git-") ||
    name.startsWith("nodoassist-root") ||
  ...
  [
    ...
    [
      ...
      },
      {
        ...
        env: {
          NODOASSIST_TUI_PTY_INCLUDE_LOCAL: "1",
        },
        requiresDist: false,
        runner: "blacksmith-4vcpu-ubuntu-2404",
      },
