  ...
  return {
    ...
    ...(qaState
      ? {
          ...
          NODOASSIST_HOME: qaState.home,
          NODOASSIST_STATE_DIR: qaState.stateDir,
          NODOASSIST_CONFIG_PATH: qaState.configPath,
        }
      : {}),
    NODOASSIST_BUILD_PRIVATE_QA: "1",
    NODOASSIST_ENABLE_PRIVATE_QA_CLI: "1",
    NODOASSIST_RUN_NODE_SKIP_DTS_BUILD: env.NODOASSIST_RUN_NODE_SKIP_DTS_BUILD ?? "1",
    NODOASSIST_TEST_DISABLE_UPDATE_CHECK: env.NODOASSIST_TEST_DISABLE_UPDATE_CHECK ?? "1",
