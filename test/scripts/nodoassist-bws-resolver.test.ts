...
const resolverPath = path.resolve("scripts/secrets/nodoassist-bws-resolver.mjs");

function makeTempDir(): string {
  const dir = mkdtempSync(path.join(tmpdir(), "nodoassist-bws-resolver-"));
  tempDirs.push(dir);
  return dir;
}
...
describe("nodoassist-bws-resolver", () => {
