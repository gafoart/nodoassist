// NodoAssist release ClawHub runtime-state script tests cover its CLI-only parser.
import { spawnSync } from "node:child_process";
import { describe, expect, it } from "vitest";

const SCRIPT_PATH = "scripts/nodoassist-release-clawhub-runtime-state.ts";
...
describe("scripts/nodoassist-release-clawhub-runtime-state.ts", () => {
