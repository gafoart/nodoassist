// NodoAssist runtime test setup installs runtime mocks and cleanup.
...
const WORKER_RUNTIME_STATE = Symbol.for("nodoassist.testSetupRuntimeState");
const WORKER_PLUGIN_RUNTIME_HELPERS = Symbol.for("nodoassist.testSetupPluginRuntimeHelpers");
const WORKER_CLEANUP_HELPERS = Symbol.for("nodoassist.testSetupCleanupHelpers");
...
const createStubPlugin = (params: {
  ...
  config: {
    ...
    isConfigured: async (_account, cfg: NodoAssistConfig) => {
      const channels = cfg.channels as Record<string, unknown> | undefined;
