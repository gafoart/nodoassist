...
const residue = {
  legacyProfileDir: "/tmp/nodoassist-home/browser/clawd",
  legacyUserDataDir: "/tmp/nodoassist-home/browser/clawd/user-data",
  canonicalUserDataDir: "/tmp/nodoassist-home/browser/nodoassist/user-data",
};
...
describe("browser clawd profile residue health check", () => {
  ...
  it("reports legacy clawd profile residue through doctor lint", async () => {
    ...
    const cfg: NodoAssistConfig = { browser: { profiles: { nodoassist: { color: "#FF4500" } } } };
