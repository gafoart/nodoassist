...
type PromptDefaultModelResult = { model?: string; config?: NodoAssistConfig };
...
function resolveConfiguredModelRaw(cfg: NodoAssistConfig): string {
  return resolveAgentModelPrimaryValue(cfg.agents?.defaults?.model) ?? "";
}

function resolveConfiguredModelKeys(cfg: NodoAssistConfig): string[] {
