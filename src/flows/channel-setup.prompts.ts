    ...
    await prompter.note(
      [
        ...
        t("wizard.channels.dmPolicyApprove", {
          command: formatCliCommand(`nodoassist pairing approve ${policy.channel} <code>`),
        }),
        ...
        t("wizard.channels.dmPolicyMultiUser", {
          command: formatCliCommand('nodoassist config set session.dmScope "per-channel-peer"'),
        }),
