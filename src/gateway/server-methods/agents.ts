...
import { normalizeOptionalString as resolveOptionalStringParam } from "@nodoassist/normalization-core/string-coerce";
import {
  ErrorCodes,
  errorShape,
...
function resolveAgentIdOrError(agentIdRaw: string, cfg: NodoAssistConfig) {
