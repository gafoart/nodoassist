...
// Removes NodoAssist-only envelopes before messages are shown in UI/RPC results.
...
/** Strips NodoAssist envelope metadata from one display message without mutating it. */
