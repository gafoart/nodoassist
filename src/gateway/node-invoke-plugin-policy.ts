...
import type {
  ...
  NodoAssistPluginNodeInvokePolicyResult,
  NodoAssistPluginNodeInvokeTransportResult,
...
function createApprovalRuntime(params: {
  ...
  pluginId: string;
}): NodoAssistPluginNodeInvokePolicyContext["approvals"] | undefined {
...
export async function applyPluginNodeInvokePolicy(params: {
...
}): Promise<NodoAssistPluginNodeInvokePolicyResult | null> {
  ...
  const invokeNode: NodoAssistPluginNodeInvokePolicyContext["invokeNode"] = async (
    override = {},
