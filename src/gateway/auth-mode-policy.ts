...
export function hasAmbiguousGatewayAuthModeConfig(cfg: NodoAssistConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: NodoAssistConfig): void {
