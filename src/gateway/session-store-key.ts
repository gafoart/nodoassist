...
function resolveDefaultStoreAgentId(cfg: NodoAssistConfig): string {
...
export function resolveSessionStoreAgentId(cfg: NodoAssistConfig, canonicalKey: string): string {
