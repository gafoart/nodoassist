// NodoAssist Gateway client facade.
// Injects NodoAssist host dependencies into the shared gateway-client package.
...
function createNodoAssistGatewayClientHostDeps(
  overrides?: GatewayClientHostDeps,
): GatewayClientHostDeps {
  return {
    // This wrapper is the only place the package reaches into NodoAssist runtime
...
export class GatewayClient {
  ...
  constructor(opts: GatewayClientOptions) {
    this.#client = new BaseGatewayClient({
      ...
      hostDeps: createNodoAssistGatewayClientHostDeps(opts.hostDeps),
    });
  }
