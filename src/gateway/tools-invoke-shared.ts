...
function resolveSessionKey(params: { cfg: NodoAssistConfig; input: ToolsInvokeInput }): string {
...
function resolveMemoryToolDisableReasons(cfg: NodoAssistConfig): string[] {
