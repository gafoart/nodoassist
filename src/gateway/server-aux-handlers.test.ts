...
function createSnapshot(config: NodoAssistConfig): PreparedSecretsRuntimeSnapshot {
  return {
...
function activateSnapshot(config: NodoAssistConfig) {
  activateSecretsRuntimeSnapshot(createSnapshot(config));
}

function mockResolvedSecrets(config: NodoAssistConfig) {
