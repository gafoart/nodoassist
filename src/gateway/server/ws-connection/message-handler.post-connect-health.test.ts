...
describe("resolvePinnedClientMetadata", () => {
  ...
  it.each([
    ["nodoassist-ios", "iOS 26.5.0", "iOS 26.4.2", "iPhone"],
    ["nodoassist-ios", "iPadOS 26.5.0", "iPadOS 26.4.2", "iPad"],
    ["nodoassist-ios", "iPadOS 26.5.0", "iOS 26.4.2", "iPad"],
    ["nodoassist-android", "Android 16", "Android 15", "Android"],
  ])(
