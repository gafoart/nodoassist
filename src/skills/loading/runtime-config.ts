...
function hasConfiguredSkillApiKeyRef(config?: NodoAssistConfig): boolean {
...
export function resolveSkillRuntimeConfig(config?: NodoAssistConfig): NodoAssistConfig | undefined {
