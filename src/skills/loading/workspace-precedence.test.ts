...
import type { NodoAssistSkillMetadata, SkillEntry } from "../types.js";
...
const fixtureSuite = createFixtureSuite("nodoassist-skills-prompt-suite-");
...
function createSkillEntry(params: {
  name: string;
  description?: string;
  metadata?: NodoAssistSkillMetadata;
}): SkillEntry {
