// Workshop config helpers resolve skill workshop settings from NodoAssist config.
...
export function resolveSkillWorkshopConfig(config?: NodoAssistConfig): SkillWorkshopConfig {
