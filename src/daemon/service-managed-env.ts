...
const MANAGED_SERVICE_ENV_KEYS_VAR = "NODOASSIST_SERVICE_MANAGED_ENV_KEYS";

// Tracks which service environment keys NodoAssist owns across reinstall/start flows.
