 ...
 *
 * Maps channel-specific direct/group/channel labels into NodoAssist chat types.
 */
...
/**
 * Normalizes channel-specific chat type labels into NodoAssist conversation kinds.
 */
