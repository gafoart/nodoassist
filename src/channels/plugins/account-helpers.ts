...
export function createAccountListHelpers(
  ...
  options?: {
    ...
    hasImplicitDefaultAccount?: (cfg: NodoAssistConfig) => boolean;
  },
) {
  function hasImplicitDefaultAccount(cfg: NodoAssistConfig): boolean {
  ...
  function resolveConfiguredDefaultAccountId(cfg: NodoAssistConfig): string | undefined {
    const channel = cfg.channels?.[channelKey] as Record<string, unknown> | undefined;
  ...
  function listAccountIds(cfg: NodoAssistConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: NodoAssistConfig): string {
