...
export type ChannelConfigAdapter<ResolvedAccount> = {
  ...
  resolveAccount: (cfg: NodoAssistConfig, accountId?: string | null) => ResolvedAccount;
  inspectAccount?: (cfg: NodoAssistConfig, accountId?: string | null) => unknown;
  defaultAccountId?: (cfg: NodoAssistConfig) => string;
  setAccountEnabled?: (params: {
    cfg: NodoAssistConfig;
    accountId: string;
    enabled: boolean;
  }) => NodoAssistConfig;
  deleteAccount?: (params: { cfg: NodoAssistConfig; accountId: string }) => NodoAssistConfig;
  isEnabled?: ChannelAdapterCallback<(account: ResolvedAccount, cfg: NodoAssistConfig) => boolean>;
  disabledReason?: ChannelAdapterCallback<
    (account: ResolvedAccount, cfg: NodoAssistConfig) => string
  >;
  isConfigured?: ChannelAdapterCallback<
    (account: ResolvedAccount, cfg: NodoAssistConfig) => boolean | Promise<boolean>
  >;
  unconfiguredReason?: ChannelAdapterCallback<
    (account: ResolvedAccount, cfg: NodoAssistConfig) => string
  >;
  describeAccount?: ChannelAdapterCallback<
    (account: ResolvedAccount, cfg: NodoAssistConfig) => ChannelAccountSnapshot
  >;
  ...
  hasConfiguredState?: (params: { cfg: NodoAssistConfig; env?: NodeJS.ProcessEnv }) => boolean;
  hasPersistedAuthState?: (params: { cfg: NodoAssistConfig; env?: NodeJS.ProcessEnv }) => boolean;
...
export type ChannelGatewayAdapter<ResolvedAccount = unknown> = {
  ...
  resolveGatewayAuthBypassPaths?: (params: { cfg: NodoAssistConfig }) => string[];
...
export type ChannelDoctorAdapter = {
  ...
  normalizeCompatibilityConfig?: (params: { cfg: NodoAssistConfig }) => ChannelDoctorConfigMutation;
...
export type ChannelLifecycleAdapter = {
  onAccountConfigChanged?: (params: {
    prevCfg: NodoAssistConfig;
    nextCfg: NodoAssistConfig;
    accountId: string;
    runtime: RuntimeEnv;
  }) => Promise<void> | void;
...
export type ChannelApprovalDeliveryAdapter = {
  hasConfiguredDmRoute?: (params: { cfg: NodoAssistConfig }) => boolean;
...
export type ChannelAllowlistAdapter = {
  applyConfigEdit?: (params: {
    ...
    | Promise<
      ...
      >
    | null;
  readConfig?: (params: { cfg: NodoAssistConfig; accountId?: string | null }) =>
    | {
...
export type ChannelConversationBindingSupport = {
  ...
  createManager?: (params: { cfg: NodoAssistConfig; accountId?: string | null }) =>
    | {
