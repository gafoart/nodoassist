...
export type ChannelAgentToolFactory = (params: { cfg?: NodoAssistConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: NodoAssistConfig; accountId?: string | null }) => string[];
