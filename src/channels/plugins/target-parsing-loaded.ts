...
/** @deprecated Use `channelRouteTargetsMatchExact` from `nodoassist/plugin-sdk/channel-route`. */
...
/** @deprecated Use `channelRouteTargetsShareConversation` from `nodoassist/plugin-sdk/channel-route`. */
