...
type ConfigGroupPolicyWarningCollector<Params extends { cfg: NodoAssistConfig }> = (
  params: Params,
) => string[];
...
export function projectConfigWarningCollector<Params extends { cfg: NodoAssistConfig }>(
  collector: WarningCollector<{ cfg: NodoAssistConfig }>,
): WarningCollector<Params> {
  return projectWarningCollector((params) => ({ cfg: params.cfg }), collector);
}

export function projectConfigAccountIdWarningCollector<
  Params extends { cfg: NodoAssistConfig; accountId?: string | null },
>(
  collector: WarningCollector<{ cfg: NodoAssistConfig; accountId?: string | null }>,
): WarningCollector<Params> {
...
export function projectAccountConfigWarningCollector<
  ResolvedAccount,
  ProjectedCfg,
  Params extends { account: ResolvedAccount; cfg: NodoAssistConfig },
>(
  projectCfg: (cfg: NodoAssistConfig) => ProjectedCfg,
...
export function createAllowlistProviderRestrictSendersWarningCollector<ResolvedAccount>(
  params: {
    providerConfigPresent: (cfg: NodoAssistConfig) => boolean;
  ...
  return createAllowlistProviderGroupPolicyWarningCollector({
    providerConfigPresent: params.providerConfigPresent,
    resolveGroupPolicy: ({ account }: { account: ResolvedAccount; cfg: NodoAssistConfig }) =>
...
export function createAllowlistProviderGroupPolicyWarningCollector<
  Params extends { cfg: NodoAssistConfig },
>(params: {
  providerConfigPresent: (cfg: NodoAssistConfig) => boolean;
