 ...
 *
 * Stores, claims, completes, and tombstones inbound channel events in NodoAssist state.
 */
...
import type {
  ...
  DB as NodoAssistStateKyselyDatabase,
} from "../../state/nodoassist-state-db.generated.js";
import {
...
type ChannelIngressDatabase = Pick<NodoAssistStateKyselyDatabase, "channel_ingress_events">;
...
/** Creates a durable channel/account-scoped ingress queue backed by the NodoAssist state database. */
