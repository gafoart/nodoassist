...
export type ChannelMessageSendTextContext<TConfig = NodoAssistConfig> = {
  cfg: TConfig;
  to: string;
  text: string;
...
export type ChannelMessageSendMediaContext<TConfig = NodoAssistConfig> =
...
export type ChannelMessageSendPayloadContext<TConfig = NodoAssistConfig> =
  ChannelMessageSendTextContext<TConfig> & {
...
export type ChannelMessageSendPollContext<TConfig = NodoAssistConfig> = Omit<
  ChannelMessageSendTextContext<TConfig>,
  "text" | "threadId"
> & {
  poll: PollInput;
...
export type ChannelMessageSendAttemptContext<TConfig = NodoAssistConfig> =
...
export type ChannelMessageSendFailureContext<TConfig = NodoAssistConfig> =
  ChannelMessageSendAttemptContext<TConfig> & {
    error: unknown;
    attemptToken?: unknown;
  };
...
export type ChannelMessageUnknownSendContext<TConfig = NodoAssistConfig> = {
  cfg: TConfig;
  queueId: string;
  channel: string;
  to: string;
