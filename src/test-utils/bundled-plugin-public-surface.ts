...
function findBundledPluginMetadataFast(
  ...
  const rawRoots = [
    ...
    path.resolve(NODOASSIST_PACKAGE_ROOT, "extensions"),
    path.resolve(NODOASSIST_PACKAGE_ROOT, "dist-runtime", "extensions"),
    path.resolve(NODOASSIST_PACKAGE_ROOT, "dist", "extensions"),
