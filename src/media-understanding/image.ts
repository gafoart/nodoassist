...
// provider hook.
import { clampPositiveTimerTimeoutMs } from "@nodoassist/normalization-core/number-coercion";
...
async function resolveImageRuntime(params: {
  ...
  await ensureNodoAssistModelsJson(params.cfg, params.agentDir, modelsOptions);
