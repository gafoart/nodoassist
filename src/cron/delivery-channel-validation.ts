...
function hasExplicitChannelConfigEntry(cfg: NodoAssistConfig): boolean {
...
export async function assertValidCronCreateDelivery(cfg: NodoAssistConfig, job: CronJobCreate) {
