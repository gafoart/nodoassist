...
export const INSTALLED_PLUGIN_INDEX_WARNING =
  "DO NOT EDIT. This file is generated by NodoAssist from plugin manifests, install records, and config policy. Use `nodoassist plugins registry --refresh`, `nodoassist plugins install/update/uninstall`, or `nodoassist plugins enable/disable` instead.";
...
export type InstalledPluginIndexRecord = {
  ...
  /**
   * Package-authored nodoassist.install metadata. This describes catalog/package
