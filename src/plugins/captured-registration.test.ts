...
import type { AnyAgentTool, NodoAssistPluginApi } from "./types.js";
...
describe("captured plugin registration", () => {
  ...
  it("returns synthetic scheduled-turn ids independent of human-readable names", async () => {
    let scheduleSessionTurn: NodoAssistPluginApi["scheduleSessionTurn"] | undefined;
    let registerSessionSchedulerJob: NodoAssistPluginApi["registerSessionSchedulerJob"] | undefined;
    const captured = capturePluginRegistration({
