...
function resolveMemoryRuntimePluginIds(config: NodoAssistConfig): string[] {
...
function resolveMemoryRuntimeWorkspaceDir(cfg: NodoAssistConfig): string | undefined {
...
function ensureMemoryRuntime(cfg?: NodoAssistConfig) {
...
export async function closeActiveMemorySearchManagers(cfg?: NodoAssistConfig): Promise<void> {
  void cfg;
