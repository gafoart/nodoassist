/** Tests bundle manifest parsing for Codex, Claude, Cursor, and NodoAssist formats. */
...
function makeTempDir() {
  return makeTrackedTempDir("nodoassist-bundle-manifest", tempDirs);
}
...
describe("bundle manifest parsing", () => {
  it("does not treat nodoassist.bundle.json as a bundle manifest", () => {
    const rootDir = makeTempDir();
    writeBundleManifest(rootDir, "nodoassist.bundle.json", {
      name: "Not Real",
      skills: ["skills"],
    });
