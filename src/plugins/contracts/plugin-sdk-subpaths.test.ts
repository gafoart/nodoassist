...
import * as commandAuthSdk from "nodoassist/plugin-sdk/command-auth";
import type {
  ChannelMessageActionContext as CoreChannelMessageActionContext,
  NodoAssistPluginApi as CoreNodoAssistPluginApi,
  PluginRuntime as CorePluginRuntime,
} from "nodoassist/plugin-sdk/core";
import * as providerEntrySdk from "nodoassist/plugin-sdk/provider-entry";
import type { GetReplyOptions as ReplyRuntimeGetReplyOptions } from "nodoassist/plugin-sdk/reply-runtime";
import * as zalouserSdk from "nodoassist/plugin-sdk/zalouser";
...
import type {
  ...
  NodoAssistPluginApi as SharedNodoAssistPluginApi,
...
describe("plugin-sdk subpath exports", () => {
  ...
  beforeAll(() => {
    deprecatedChannelRuntimeMatches = findRepoFilesContaining({
      ...
      pattern:
        /(?:from\s+|import\s+(?:type\s+)?|import\s*\(\s*)["']nodoassist\/plugin-sdk\/channel-runtime(?=["'])/u,
      exclude: [
  ...
  it("keeps shared plugin-sdk types aligned", () => {
    ...
    expectTypeOf<CoreNodoAssistPluginApi>().toMatchTypeOf<NodoAssistPluginApi>();
    expectTypeOf<CorePluginRuntime>().toMatchTypeOf<PluginRuntime>();
    expectTypeOf<CoreChannelMessageActionContext>().toMatchTypeOf<ChannelMessageActionContext>();
    expectTypeOf<CoreNodoAssistPluginApi>().toMatchTypeOf<SharedNodoAssistPluginApi>();
  ...
  it("keeps repeated silent-token semantics visible through the reply-chunking subpath", async () => {
    const replyChunkingSdk = await importResolvedPluginSdkSubpath(
      "nodoassist/plugin-sdk/reply-chunking",
    );
