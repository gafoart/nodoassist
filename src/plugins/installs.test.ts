  ...
  it.each([
    {
      ...
      input: {
        ...
        version: "1.2.3",
        resolvedSpec: "@nodoassist/demo@1.2.3",
...
describe("resolveNpmInstallRecordSpec", () => {
  it("uses an exact resolved registry spec when managed installs request pinning", () => {
    expect(
      resolveNpmInstallRecordSpec({
        requestedSpec: "@nodoassist/codex",
        resolution: {
          name: "@nodoassist/codex",
          version: "2026.5.30-beta.1",
          resolvedSpec: "@nodoassist/codex@2026.5.30-beta.1",
        },
        pinResolvedRegistrySpec: true,
      }),
    ).toBe("@nodoassist/codex@2026.5.30-beta.1");
  });
    ...
    expect(
      resolveNpmInstallRecordSpec({
        ...
        resolution: {
          name: "@nodoassist/codex",
          version: "2026.5.30-beta.1",
          resolvedSpec: "@nodoassist/codex@beta",
        },
        pinResolvedRegistrySpec: true,
      }),
    ).toBe("@nodoassist/codex");
