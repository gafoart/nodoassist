...
type LoadNodoAssistProviderIndex =
  typeof import("../model-catalog/index.js").loadNodoAssistProviderIndex;
...
const loadNodoAssistProviderIndex = vi.hoisted(() =>
  vi.fn<LoadNodoAssistProviderIndex>(() => ({ version: 1, providers: {} })),
);
...
function vllmPluginWithPackageInstall(): InstalledPluginIndexRecord {
  return {
    pluginId: "vllm",
    origin: "global",
    manifestPath: "/Users/test/.nodoassist/plugins/vllm/nodoassist.plugin.json",
    manifestHash: "hash",
    rootDir: "/Users/test/.nodoassist/plugins/vllm",
    enabled: true,
    startup: {
      sidecar: false,
      memory: false,
    ...
    compat: [],
    packageName: "@nodoassist/vllm",
    packageInstall: {
      npm: {
        spec: "@nodoassist/vllm-fork@1.0.0",
        packageName: "@nodoassist/vllm-fork",
        selector: "1.0.0",
...
describe("provider install catalog", () => {
  beforeEach(() => {
    vi.clearAllMocks();
    loadNodoAssistProviderIndex.mockReturnValue({ version: 1, providers: {} });
      ...
      plugins: [
        {
          pluginId: "openai",
          origin: "bundled",
          manifestPath: "/repo/extensions/openai/nodoassist.plugin.json",
          manifestHash: "hash",
          ...
          compat: [],
          packageName: "@nodoassist/openai",
          packageInstall: {
            defaultChoice: "npm",
            npm: {
              spec: "@nodoassist/openai@1.2.3",
              packageName: "@nodoassist/openai",
              selector: "1.2.3",
              selectorKind: "exact-version",
              exactVersion: true,
    ...
    expect(resolveProviderInstallCatalogEntries()).toEqual([
      {
        ...
        origin: "bundled",
        install: {
          npmSpec: "@nodoassist/openai@1.2.3",
    ...
    loadPluginRegistrySnapshot.mockReturnValue(
      registrySnapshot({
        installRecords: {
          vllm: {
            source: "npm",
            spec: "@nodoassist/vllm",
            resolvedSpec: "@nodoassist/vllm@2.0.0",
  ...
  it("preserves durable ClawHub install records for provider setup reinstall hints", () => {
    loadPluginRegistrySnapshot.mockReturnValue(
      registrySnapshot({
        installRecords: {
          vllm: {
            source: "clawhub",
            spec: "clawhub:nodoassist/vllm@2026.5.2",
            integrity: "sha256-clawpack",
            clawhubPackage: "nodoassist/vllm",
          },
        },
        plugins: [vllmPluginWithPackageInstall()],
      }),
    ...
    expect(resolveProviderInstallCatalogEntry("vllm")).toEqual({
      ...
      origin: "global",
      install: {
        clawhubSpec: "clawhub:nodoassist/vllm@2026.5.2",
      ...
      plugins: [
        {
          ...
          origin: "global",
          manifestPath: "/Users/test/.nodoassist/plugins/demo-provider/nodoassist.plugin.json",
          manifestHash: "hash",
          rootDir: "/Users/test/.nodoassist/plugins/demo-provider",
          enabled: true,
          startup: {
            sidecar: false,
            memory: false,
      ...
      plugins: [
        {
          pluginId: "demo-provider",
          origin: "workspace",
          manifestPath: "/repo/extensions/demo-provider/nodoassist.plugin.json",
          manifestHash: "hash",
  ...
  it("surfaces provider-index install metadata when the provider plugin is not installed", () => {
    loadNodoAssistProviderIndex.mockReturnValue({
      version: 1,
      providers: {
        moonshot: {
          id: "moonshot",
          ...
          plugin: {
            id: "moonshot",
            package: "@nodoassist/plugin-moonshot",
            install: {
              npmSpec: "@nodoassist/plugin-moonshot@1.2.3",
              defaultChoice: "npm",
    ...
    expect(resolveProviderInstallCatalogEntry("moonshot-api-key")).toEqual({
      ...
      installSource: {
        defaultChoice: "npm",
        npm: {
          spec: "@nodoassist/plugin-moonshot@1.2.3",
          packageName: "@nodoassist/plugin-moonshot",
          selector: "1.2.3",
          selectorKind: "exact-version",
          exactVersion: true,
          expectedIntegrity: "sha512-moonshot",
    ...
    listOfficialExternalProviderCatalogEntries.mockReturnValue([
      {
        ...
        nodoassist: {
          ...
          install: {
            npmSpec: "@nodoassist/qwen-provider",
            defaultChoice: "npm",
          },
        },
      },
  ...
  it("surfaces provider-index ClawHub install metadata as the preferred source", () => {
      ...
      providers: {
        moonshot: {
          ...
          plugin: {
            ...
            package: "@nodoassist/plugin-moonshot",
            install: {
              clawhubSpec: "clawhub:nodoassist/moonshot@2026.5.2",
              npmSpec: "@nodoassist/plugin-moonshot@2026.5.2",
              defaultChoice: "clawhub",
              expectedIntegrity: "sha512-moonshot",
            },
          },
    ...
    expect(resolveProviderInstallCatalogEntry("moonshot-api-key")).toEqual({
      ...
      installSource: {
        defaultChoice: "clawhub",
        clawhub: {
          spec: "clawhub:nodoassist/moonshot@2026.5.2",
          packageName: "nodoassist/moonshot",
          version: "2026.5.2",
          exactVersion: true,
        },
        npm: {
          spec: "@nodoassist/plugin-moonshot@2026.5.2",
          packageName: "@nodoassist/plugin-moonshot",
          selector: "2026.5.2",
          selectorKind: "exact-version",
          exactVersion: true,
      ...
      plugins: [
        {
          pluginId: "moonshot",
          origin: "bundled",
          manifestPath: "/repo/extensions/moonshot/nodoassist.plugin.json",
          manifestHash: "hash",
  ...
  it("keeps missing provider-index entries visible when only some provider plugins are installed", () => {
    ...
    loadNodoAssistProviderIndex.mockReturnValue({
      ...
      providers: {
        groq: {
          ...
          plugin: {
            id: "groq",
            package: "@nodoassist/plugin-groq",
            install: {
              npmSpec: "@nodoassist/plugin-groq@1.0.0",
              defaultChoice: "npm",
            },
          },
          authChoices: [
        ...
        vllm: {
          ...
          plugin: {
            id: "vllm",
            package: "@nodoassist/plugin-vllm",
            install: {
              clawhubSpec: "clawhub:nodoassist/vllm@2026.5.2",
              npmSpec: "@nodoassist/plugin-vllm@2026.5.2",
              defaultChoice: "clawhub",
            },
          },
          authChoices: [
    ...
    expect(resolveProviderInstallCatalogEntry("vllm-server")).toEqual({
      ...
      installSource: {
        ...
        npm: {
          spec: "@nodoassist/plugin-vllm@2026.5.2",
          packageName: "@nodoassist/plugin-vllm",
          selector: "2026.5.2",
          selectorKind: "exact-version",
          exactVersion: true,
