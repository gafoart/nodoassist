...
import type { NodoAssistPluginCliCommandDescriptor, PluginLogger } from "./types.js";
...
const PLUGIN_CLI_ENTRIES_CACHE_KEY = Symbol.for("nodoassist.plugin-cli-registration-entries-cache");
...
export const loadValidatedConfigForPluginRegistration =
  async (): Promise<NodoAssistConfig | null> => {
