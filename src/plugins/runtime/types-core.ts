...
type RuntimeConfigMutationContext = {
  snapshot: import("../../config/types.nodoassist.js").ConfigFileSnapshot;
...
type RuntimeMutateConfigFileParams<T = void> = {
  ...
  mutate: (
    draft: import("../../config/types.nodoassist.js").NodoAssistConfig,
    context: RuntimeConfigMutationContext,
  ) => Promise<T | void> | T | void;
};
type RuntimeReplaceConfigFileParams = {
  nextConfig: import("../../config/types.nodoassist.js").NodoAssistConfig;
  baseHash?: string;
  afterWrite: RuntimeConfigAfterWrite;
  writeOptions?: RuntimeWriteConfigOptions;
};
...
export type PluginRuntimeCore = {
  ...
  config: {
    ...
    current: () => DeepReadonly<import("../../config/types.nodoassist.js").NodoAssistConfig>;
    /**
     ...
     */
    loadConfig: () => import("../../config/types.nodoassist.js").NodoAssistConfig;
    /**
     ...
     */
    writeConfigFile: (
      cfg: import("../../config/types.nodoassist.js").NodoAssistConfig,
  ...
  media: {
    ...
    detectMime: typeof import("@nodoassist/media-core/mime").detectMime;
    mediaKindFromMime: typeof import("@nodoassist/media-core/constants").mediaKindFromMime;
  ...
  modelAuth: {
    ...
    getApiKeyForModel: (params: {
      model: import("nodoassist/plugin-sdk/llm").Model<import("nodoassist/plugin-sdk/llm").Api>;
      cfg?: import("../../config/types.nodoassist.js").NodoAssistConfig;
      workspaceDir?: string;
