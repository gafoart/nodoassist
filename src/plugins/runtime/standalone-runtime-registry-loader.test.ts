...
vi.mock("../loader.js", async (importOriginal) => {
  ...
  return {
    ...actual,
    loadNodoAssistPlugins: (...args: Parameters<typeof loaderMocks.loadNodoAssistPlugins>) =>
      loaderMocks.loadNodoAssistPlugins(...args),
  };
});
...
beforeEach(() => {
  loaderMocks.loadNodoAssistPlugins.mockReset();
});
...
describe("ensureStandaloneRuntimePluginRegistryLoaded", () => {
  it("reuses a compatible gateway startup registry for gateway-bindable dispatch load options", () => {
    ...
    expect(loaderMocks.loadNodoAssistPlugins).not.toHaveBeenCalled();
  });
  ...
  it("loads a fresh registry when dispatch config is not startup-compatible", () => {
    ...
    loaderMocks.loadNodoAssistPlugins.mockReturnValue(loadedRegistry);
    ...
    expect(loaderMocks.loadNodoAssistPlugins).toHaveBeenCalledOnce();
  });
});
...
describe("ensureStandaloneRuntimePluginRegistryLoaded tool-discovery installs", () => {
  it("does not replace active or pinned channel registries during tool discovery", () => {
    ...
    loaderMocks.loadNodoAssistPlugins.mockReturnValue(toolRegistry);
  ...
  it("still installs a non-tool-discovery active load (migration provider path)", () => {
    ...
    loaderMocks.loadNodoAssistPlugins.mockReturnValue(migrationRegistry);
