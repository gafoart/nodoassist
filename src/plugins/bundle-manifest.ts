/** Reads Codex/Claude/Cursor bundle manifests into NodoAssist plugin manifest metadata. */
...
export type BundlePluginManifest = {
  ...
  // Only include hook roots that NodoAssist can execute via HOOK.md + handler files.
  hooks: string[];
