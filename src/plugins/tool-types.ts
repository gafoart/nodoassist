...
export type NodoAssistPluginActiveModelContext = {
  provider?: string;
  modelId?: string;
  modelRef?: string;
};
...
export type NodoAssistPluginToolContext = {
   ...
   * the local operator, installed plugin code, or a modified NodoAssist runtime.
   */
  activeModel?: NodoAssistPluginActiveModelContext;
  browser?: {
...
export type NodoAssistPluginToolFactory = (
  ctx: NodoAssistPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type NodoAssistPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type NodoAssistPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
