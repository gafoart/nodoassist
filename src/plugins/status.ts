...
import { normalizeNodoAssistVersionBase } from "../config/version.js";
...
import { loadNodoAssistPlugins } from "./loader.js";
...
function resolveReportedPluginVersion(
  ...
  return (
    normalizeNodoAssistVersionBase(resolveCompatibilityHostVersion(env)) ??
    normalizeNodoAssistVersionBase(plugin.version) ??
    plugin.version
  );
}
