...
import type { NodoAssistPluginConfigSchema } from "./types.js";
...
type BuildPluginConfigSchemaOptions = {
  ...
  safeParse?: NodoAssistPluginConfigSchema["safeParse"];
};
...
export function emptyPluginConfigSchema(): NodoAssistPluginConfigSchema {
  return {
