...
const ENV: NodeJS.ProcessEnv = { HOME: "/tmp/nodoassist-test-home" };
let loadCase = 0;

const RECORDS: Record<string, PluginInstallRecord> = {
  weixin: {
    source: "npm",
    spec: "@tencent-weixin/nodoassist-weixin@2.3.7",
    installPath:
      "/tmp/nodoassist-test-home/.nodoassist/npm/node_modules/@tencent-weixin/nodoassist-weixin",
...
async function loadWithMocks(params: {
  ...
  vi.doMock("./discovery.js", () => ({ discoverNodoAssistPlugins: discoverSpy }));
...
function createChannelCandidate(params: {
  ...
  return {
    ...
    source: "/tmp/nodoassist-test-plugin/index.js",
    rootDir: "/tmp/nodoassist-test-plugin",
    origin: params.origin ?? "global",
    packageName: "@vendor/nodoassist-test-plugin",
    packageManifest: {
