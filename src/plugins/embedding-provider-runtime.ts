...
export function listEmbeddingProviders(cfg?: NodoAssistConfig): EmbeddingProviderAdapter[] {
...
function resolveEmbeddingProviderLookupIds(id: string, cfg?: NodoAssistConfig): string[] {
