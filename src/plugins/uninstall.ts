...
import { relinkNodoAssistPeerDependenciesInManagedNpmRoot } from "./plugin-peer-link.js";
...
export function removePluginFromConfig(
  ...
  pluginId: string,
  opts?: { channelIds?: string[] },
): { config: NodoAssistConfig; actions: Omit<UninstallActions, "directory"> } {
  ...
  const config: NodoAssistConfig = {
    ...
    channels: channels as NodoAssistConfig["channels"],
  };
