...
/** Returns true when a command name is owned by built-in NodoAssist command handling. */
...
export function listPluginInvocationKeys(command: NodoAssistPluginCommandDefinition): string[] {
