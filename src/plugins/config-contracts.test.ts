...
const mocks = vi.hoisted(() => {
  ...
  return {
    discoverNodoAssistPlugins: vi.fn(() => ({ candidates: [], diagnostics: [] })),
...
vi.mock("./discovery.js", () => ({
  discoverNodoAssistPlugins: mocks.discoverNodoAssistPlugins,
}));
...
function createPluginRecord(
  ...
  return {
    ...
    hooks: [],
    source: `/tmp/${overrides.id}/nodoassist.plugin.json`,
...
describe("resolvePluginConfigContractsById", () => {
  beforeEach(() => {
    mocks.discoverNodoAssistPlugins.mockReset();
    mocks.discoverNodoAssistPlugins.mockReturnValue({ candidates: [], diagnostics: [] });
