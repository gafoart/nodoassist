...
import type { NodoAssistPluginService, NodoAssistPluginServiceContext } from "./types.js";
...
function createRegistry(
  services: NodoAssistPluginService[],
...
function expectServiceLogger(ctx: NodoAssistPluginServiceContext) {
...
function expectServiceContexts(
  contexts: NodoAssistPluginServiceContext[],
  config: Parameters<typeof startPluginServices>[0]["config"],
) {
...
describe("startPluginServices", () => {
  ...
  it("starts services and stops them in reverse order", async () => {
    const starts: string[] = [];
    const stops: string[] = [];
    const contexts: NodoAssistPluginServiceContext[] = [];
  ...
  it("grants internal diagnostics only to trusted diagnostics exporter services", async () => {
    ...
    const prometheusContexts: NodoAssistPluginServiceContext[] = [];
    ...
    const officialDiagnosticsOtelContexts: NodoAssistPluginServiceContext[] = [];
    ...
    const officialInstallContexts: NodoAssistPluginServiceContext[] = [];
    ...
    const untrustedContexts: NodoAssistPluginServiceContext[] = [];
    ...
    const spoofedContexts: NodoAssistPluginServiceContext[] = [];
