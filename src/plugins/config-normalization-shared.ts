...
import { normalizeArrayBackedTrimmedStringList } from "@nodoassist/normalization-core/string-normalization";
...
export function hasExplicitPluginConfig(plugins?: NodoAssistConfig["plugins"]): boolean {
  if (!plugins) {
    return false;
  }
