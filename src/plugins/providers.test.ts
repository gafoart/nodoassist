...
type LoadNodoAssistPlugins = typeof import("./loader.js").loadNodoAssistPlugins;
...
const loadNodoAssistPluginsMock = vi.fn<LoadNodoAssistPlugins>();
...
function expectLastSetupRegistryCall(params: {
  ...
  const call = getLastMockCallArg(loadNodoAssistPluginsMock, "NodoAssist plugin setup loader");
...
function getLastSetupLoadedPluginConfig() {
  const call = expectRecordFields(
    getLastMockCallArg(loadNodoAssistPluginsMock, "NodoAssist plugin setup loader"),
    {},
  );
...
function createAutoEnabledProviderConfig() {
  const rawConfig: NodoAssistConfig = {
    plugins: {},
  };
  const autoEnabledConfig: NodoAssistConfig = {
    ...rawConfig,
    plugins: {
      entries: {
        google: { enabled: true },
...
describe("resolvePluginProviders", () => {
  beforeAll(async () => {
    ...
    vi.doMock("./loader.js", () => ({
      loadNodoAssistPlugins: (...args: Parameters<LoadNodoAssistPlugins>) =>
        loadNodoAssistPluginsMock(...args),
