...
import { normalizeStructuredPromptSection } from "@nodoassist/ai/internal/shared";
...
/**
 * Delegate a context-engine compaction request to NodoAssist's built-in runtime compaction path.
 *
