...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("nodoassist.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("nodoassist.contextEngineRegistryState");
