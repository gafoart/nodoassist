...
import type { AcpRuntime, AcpRuntimeHandle } from "@nodoassist/acp-core/runtime/types";
...
export async function runManagerInitializeSession(params: {
  ...
  enforceConcurrentSessionLimit: (params: { cfg: NodoAssistConfig; sessionKey: string }) => void;
