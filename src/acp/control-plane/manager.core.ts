...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: NodoAssistConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: NodoAssistConfig): AcpManagerObservabilitySnapshot {
  ...
  private async evictIdleRuntimeHandles(cfg: NodoAssistConfig): Promise<void> {
