...
import type { AcpRuntime, AcpRuntimeCapabilities } from "@nodoassist/acp-core/runtime/types";
...
export type { AcpRuntime, NodoAssistConfig, SessionAcpMeta };
...
const ORIGINAL_STATE_DIR = process.env.NODOASSIST_STATE_DIR;
...
export function installAcpSessionManagerTestLifecycle(): void {
  ...
  afterEach(() => {
    if (ORIGINAL_STATE_DIR === undefined) {
      ...
      setTestEnvValue("NODOASSIST_STATE_DIR", ORIGINAL_STATE_DIR);
    }
