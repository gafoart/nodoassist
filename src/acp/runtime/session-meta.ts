...
import { safeParseJson } from "@nodoassist/normalization-core";
...
type AcpSessionsTable = NodoAssistStateKyselyDatabase["acp_sessions"];
type AcpSessionMetaDatabase = Pick<NodoAssistStateKyselyDatabase, "acp_sessions">;
...
}): { cfg: NodoAssistConfig; storePath: string } {
...
function selectAcpSessionRows(options: NodoAssistStateDatabaseOptions = {}): AcpSessionRow[] {
