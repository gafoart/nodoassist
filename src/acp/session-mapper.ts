/** Resolves ACP request metadata into NodoAssist Gateway session keys and reset behavior. */
import { readBool, readString } from "@nodoassist/acp-core/meta";
...
/** Parses ACP request metadata into NodoAssist session routing hints. */
