      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["nodoassist gateway run", "Run the gateway in the foreground."],
            ["nodoassist gateway status", "Show service status plus connectivity/capability."],
            ["nodoassist gateway discover", "Find local and wide-area gateway beacons."],
            ["nodoassist gateway stability", "Show recent stability diagnostics."],
            ["nodoassist gateway call health", "Call a gateway RPC method directly."],
