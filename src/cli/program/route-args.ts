...
/** Parse `nodoassist health` flags for the route-first status family. */
...
/** Parse `nodoassist status` flags without registering the full command tree. */
...
/** Parse `nodoassist gateway status` RPC-only flags accepted by the fast route. */
...
/** Parse `nodoassist sessions` filters for JSON/list route execution. */
...
/** Parse `nodoassist agents list` display switches for route-first execution. */
...
/** Parse `nodoassist config get <path>` while preserving root option handling. */
...
/** Parse `nodoassist config unset <path>` and its mutation guard flags. */
...
/** Parse `nodoassist models list` filters for the lightweight model catalog route. */
...
/** Parse `nodoassist models status` probe controls for the route-first status path. */
...
/** Parse `nodoassist channels list` display flags for the route-first list path. */
...
/** Parse `nodoassist channels status` probe flags without full CLI registration. */
...
/** Parse JSON-only `nodoassist plugins list` flags for plugin inventory output. */
...
/** Parse both `nodoassist tasks --json` and `nodoassist tasks list --json` aliases. */
...
/** Parse JSON-only `nodoassist tasks audit` filters for the route-first audit path. */
