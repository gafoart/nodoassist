...
/** Register `nodoassist agent` for one Gateway-backed agent turn. */
...
${formatHelpExamples([
  ['nodoassist agent --to +15555550123 --message "status update"', "Start a new session."],
  ['nodoassist agent --agent ops --message "Summarize logs"', "Use a specific agent."],
  ["nodoassist agent --agent ops --message-file ./task.md", "Read a multiline message file."],
  [
  ...
  ['nodoassist agent --to +15555550123 --message "Summon reply" --deliver', "Deliver reply."],
  [
