    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["nodoassist directory self --channel slack", "Show the connected account identity."],
          [
            'nodoassist directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["nodoassist directory groups list --channel discord", "List available groups/channels."],
          [
            "nodoassist directory groups members --channel discord --group-id <id>",
