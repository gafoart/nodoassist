...
import { readBestEffortConfig, type NodoAssistConfig } from "../config/config.js";
  ...
  if (!params.approvals) {
    return {
      ...
      note: params.nativePolicy
        ? "This node enforces a host-native exec policy; NodoAssist approvals-file policy math does not apply."
