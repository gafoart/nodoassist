...
export function registerPluginsCli(program: Command) {
  const plugins = program
    .command("plugins")
    .description("Manage NodoAssist plugins and extensions")
    .addHelpText(
      "after",
      () =>
  ...
  marketplace
    .command("entries")
    .description("List entries from the configured NodoAssist marketplace feed")
  ...
  marketplace
    .command("refresh")
    .description("Refresh the configured NodoAssist marketplace feed snapshot")
