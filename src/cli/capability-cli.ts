...
import { detectMime, extensionForMime, normalizeMimeType } from "@nodoassist/media-core/mime";
import {
...
const LOCAL_MODEL_RUN_SYSTEM_PROMPT = "You are a personal assistant running inside NodoAssist.";
...
function getAuthProfileIdsForProvider(cfg: NodoAssistConfig, providerId: string): string[] {
...
function pinRuntimeConfigSnapshot(config: NodoAssistConfig): void {
