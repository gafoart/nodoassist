...
import { loadNodoAssistProviderIndex, normalizeNodoAssistProviderIndex } from "./index.js";

describe("NodoAssist provider index", () => {
  it("normalizes provider preview catalog rows through model catalog validation", () => {
    const index = normalizeNodoAssistProviderIndex({
      version: 1,
      providers: {
        Moonshot: {
          id: "moonshot",
  ...
  it("loads the bundled provider index without runtime plugin loading", () => {
    const index = loadNodoAssistProviderIndex();
