// Bundled NodoAssist provider index advertises pre-install provider metadata for model picker discovery.
import type { NodoAssistProviderIndex } from "./types.js";

// NodoAssist-owned preview metadata for providers whose plugins may not be
...
export const NODOASSIST_PROVIDER_INDEX = {
  version: 1,
  providers: {
    moonshot: {
      id: "moonshot",
...
} satisfies NodoAssistProviderIndex;
