...
import { maxBytesForKind, type MediaKind } from "@nodoassist/media-core/constants";
import type { NodoAssistConfig } from "../config/types.nodoassist.js";

const MB = 1024 * 1024;

/** Resolves the global generated-media byte cap from the user-facing MB config value. */
export function resolveConfiguredMediaMaxBytes(cfg?: NodoAssistConfig): number | undefined {
...
export function resolveGeneratedMediaMaxBytes(cfg: NodoAssistConfig | undefined, kind: MediaKind) {
