...
function primeConfiguredContextWindowsFromConfig(cfg: NodoAssistConfig): NodoAssistConfig {
...
function primeConfiguredContextWindows(): NodoAssistConfig | undefined {
...
export function ensureContextWindowCacheLoaded(cfgOverride?: NodoAssistConfig): Promise<void> {
...
export async function refreshContextWindowCache(cfg: NodoAssistConfig): Promise<void> {
  beginContextWindowCacheRefresh();
