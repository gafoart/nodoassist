// Covers conversion from NodoAssist bundle-MCP config into Codex app-server
...
describe("buildCodexMcpServersConfig", () => {
  it("normalizes NodoAssist MCP servers into Codex app-server mcp_servers shape", () => {
    ...
    expect(
      ...
      nodoassist: {
        ...
        bearer_token_env_var: "NODOASSIST_MCP_TOKEN",
        http_headers: {
          "x-static": "static-value",
        },
        env_http_headers: {
