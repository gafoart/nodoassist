...
type ModelsConfig = NonNullable<NodoAssistConfig["models"]>;
...
export async function resolveProvidersForModelsJsonWithDeps(
  ...
  // only the explicit providers. See nodoassist#66957.
...
export async function planNodoAssistModelsJsonWithDeps(
  params: {
    cfg: NodoAssistConfig;
...
export async function planNodoAssistModelsJson(
  params: Parameters<typeof planNodoAssistModelsJsonWithDeps>[0],
): Promise<ModelsJsonPlan> {
  return planNodoAssistModelsJsonWithDeps(params);
}
