...
describe("workspace bootstrap file caching", () => {
  ...
  beforeEach(async () => {
    ...
    workspaceDir = await makeTempWorkspace("nodoassist-bootstrap-cache-test-");
  });
  ...
  it("caches files independently by path", async () => {
    ...
    const workspace1 = await makeTempWorkspace("nodoassist-cache-test1-");
    const workspace2 = await makeTempWorkspace("nodoassist-cache-test2-");
