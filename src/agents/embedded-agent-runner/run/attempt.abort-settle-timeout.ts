...
type AbortSettleTimeoutEnv = Partial<
  Pick<NodeJS.ProcessEnv, "NODOASSIST_EMBEDDED_ABORT_SETTLE_TIMEOUT_MS" | "NODOASSIST_TEST_FAST">
>;
...
export function resolveEmbeddedAbortSettleTimeoutMs(
  ...
  const override = parseStrictPositiveInteger(env.NODOASSIST_EMBEDDED_ABORT_SETTLE_TIMEOUT_MS);
  if (override !== undefined) {
    return override;
  }
  return env.NODOASSIST_TEST_FAST === "1" ? 250 : 2_000;
}
