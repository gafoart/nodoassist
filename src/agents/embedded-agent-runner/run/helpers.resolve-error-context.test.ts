...
describe("resolveActiveErrorContext", () => {
  ...
  it("ignores the embedded NodoAssist harness provider when the model provider is known", () => {
    // The NodoAssist harness id is a transport wrapper, not the provider users
