...
import { isDefaultAgentRuntimeId, NODOASSIST_AGENT_RUNTIME_ID } from "../agent-runtime-id.js";
...
function restrictiveAllowlistOmitsPlugin(config: NodoAssistConfig | undefined, pluginId: string) {
...
export async function ensureSelectedAgentHarnessPlugin(params: {
  ...
  if (
    ...
    runtime === NODOASSIST_AGENT_RUNTIME_ID ||
