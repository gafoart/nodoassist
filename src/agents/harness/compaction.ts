 ...
 *
 * CLI runtimes and NodoAssist-native compaction stay on the embedded runner path; plugin harnesses
  ...
  try {
    ...
    if (agentHarnessRuntimeOverride) {
      ...
      if (message.includes("does not support")) {
        ...
        // to native compaction preserves existing NodoAssist behavior instead of failing rotation.
        return undefined;
      }
    }
    throw err;
