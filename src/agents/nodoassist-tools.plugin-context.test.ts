...
import { resolveNodoAssistPluginToolInputs } from "./nodoassist-tools.plugin-context.js";
import { applyPluginToolDeliveryDefaults } from "./plugin-tool-delivery-defaults.js";
import type { AnyAgentTool } from "./tools/common.js";

describe("nodoassist plugin tool context", () => {
  it("forwards trusted requester sender identity", () => {
    const result = resolveNodoAssistPluginToolInputs({
      options: {
        config: {} as never,
