...
const configFingerprintCache = new WeakMap<NodoAssistConfig, string>();
...
function resolveProviderAuthConfigFingerprint(cfg: NodoAssistConfig | undefined): string | null {
  if (!cfg) {
    return null;
  }
...
function collectProviderAuthWarmRuntimeAuthLookups(cfg: NodoAssistConfig): {
