/**
 * Runtime context resolver for NodoAssist plugin tools.
 *
...
/** Options provided by agent runtime callers when invoking NodoAssist plugin tools. */
...
export function resolveNodoAssistPluginToolInputs(params: {
  options?: NodoAssistPluginToolOptions;
