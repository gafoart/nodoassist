...
function getPackageDir(): string {
  ...
  const envDir = process.env.NODOASSIST_PACKAGE_DIR;
  if (envDir) {
    if (envDir === "~") {
      return homedir();
    }
...
// =============================================================================
// App Config (from package.json nodoassistConfig)
// =============================================================================
...
const nodoAssistConfigName: string | undefined = pkg.nodoassistConfig?.name;
export const APP_NAME: string = nodoAssistConfigName || "nodoassist";
export const CONFIG_DIR_NAME: string = pkg.nodoassistConfig?.configDir || ".nodoassist";
...
// =============================================================================
// User Config Paths (~/.nodoassist/agent/*)
// =============================================================================

/** Get the agent config directory (e.g., ~/.nodoassist/agent/) */
