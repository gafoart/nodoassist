...
const LEGACY_WORKSPACE_STATE_DIRNAME = ".nodoassist";
const LEGACY_WORKSPACE_STATE_FILENAME = "workspace-state.json";
const WORKSPACE_STATE_FILENAME = "nodoassist-workspace-state.json";
...
const WORKSPACE_ATTESTATION_HEADER = "nodoassist-workspace-attestation:v1";
...
export class WorkspaceVanishedError extends Error {
  ...
  constructor(params: { workspaceDir: string; attestationPath: string }) {
    super(
      `NodoAssist workspace appears to have disappeared after a recent initialization: ${params.workspaceDir}. ` +
