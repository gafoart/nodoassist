 ...
 * Converts provider-specific usage shapes into NodoAssist's normalized input,
...
/** Normalize provider-specific token usage fields into NodoAssist usage buckets. */
