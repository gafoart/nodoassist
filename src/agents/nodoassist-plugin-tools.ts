/**
 * NodoAssist plugin tool resolver.
 *
...
import {
  resolveNodoAssistPluginToolInputs,
  type NodoAssistPluginToolOptions,
} from "./nodoassist-tools.plugin-context.js";
import { applyPluginToolDeliveryDefaults } from "./plugin-tool-delivery-defaults.js";
import type { AnyAgentTool } from "./tools/common.js";

type ResolveNodoAssistPluginToolsOptions = NodoAssistPluginToolOptions & {
...
export function resolveNodoAssistPluginToolsForOptions(params: {
  options?: ResolveNodoAssistPluginToolsOptions;
  ...
  const resolveApiKeyForProvider = authProfileStore
    ...
    : undefined;
  const pluginToolInputs = resolveNodoAssistPluginToolInputs({
