...
const TEST_AGENT_DIR = "/tmp/nodoassist-pdf-model-config";
...
vi.mock("./model-config.helpers.js", () => ({
  ...
  hasProviderAuthForTool: ({ provider, cfg }: { provider: string; cfg?: NodoAssistConfig }) => {
  ...
  resolveDefaultModelRef: (cfg?: NodoAssistConfig) => {
