...
function hasExplicitDefaultPrimaryModel(cfg?: NodoAssistConfig): boolean {
...
function pickMaxBytes(cfg?: NodoAssistConfig, maxBytesMb?: number): number | undefined {
...
async function runImagePrompt(params: {
  ...
  const providerCfg: NodoAssistConfig = effectiveCfg ?? {};
