 ...
 */
import { normalizeFastMode, type FastMode } from "@nodoassist/normalization-core/string-coerce";
import type {
  SessionsListParams,
...
interface EmbeddedGatewayRuntime {
  ...
  resolveEffectiveChatHistoryMaxChars: (cfg: NodoAssistConfig) => number;
