...
const DEFAULT_MISSING_TOOL_RESULT_TEXT =
  "[nodoassist] missing tool result in session history; inserted synthetic error result for transcript repair.";
const SYNTHETIC_MISSING_TOOL_RESULT_DETAIL_KEY = "nodoassistSyntheticMissingToolResult";
...
function makeMissingToolResult(params: {
  ...
  // explicit NodoAssist diagnostic text unless the caller opts in.
  text?: string;
