...
function resolveOpenAIProviderConfig(config: NodoAssistConfig | undefined) {
...
function openAIProviderUsesCustomBaseUrl(config: NodoAssistConfig | undefined): boolean {
