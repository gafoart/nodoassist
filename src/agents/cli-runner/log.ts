...
export const CLI_BACKEND_LOG_OUTPUT_ENV = "NODOASSIST_CLI_BACKEND_LOG_OUTPUT";
/** Legacy env var accepted for Claude CLI output logging. */
export const LEGACY_CLAUDE_CLI_LOG_OUTPUT_ENV = "NODOASSIST_CLAUDE_CLI_LOG_OUTPUT";
