    ...
    const result = parseCliJsonl(
      [
        ...
        JSON.stringify({
          type: "tool_use",
          timestamp: "2026-06-16T19:36:47.000Z",
          tool_name: "mcp_nodoassist_create_goal",
          tool_id: "tool-1",
...
describe("createCliJsonlStreamingParser", () => {
  ...
  it("streams Gemini message deltas and tool events", () => {
    ...
    expect(starts).toEqual([
      {
        toolCallId: "tool-1",
        name: "mcp_nodoassist_create_goal",
        kind: "tool_use",
      ...
      [
        ...
        JSON.stringify({
          ...
          event: {
            type: "content_block_delta",
            index: 0,
            delta: { type: "input_json_delta", partial_json: '{"query":"nodoassist"}' },
          },
        }),
        JSON.stringify({
          type: "stream_event",
  ...
  it.each([
    {
      ...
      name: "web_search",
      input: { query: "nodoassist" },
      result: [{ type: "web_search_result", title: "NodoAssist", url: "https://example.com" }],
      isError: false,
    },
    {
