 ...
 * Encodes cwd into a safe directory name under ~/.nodoassist/agent/sessions/.
 */
...
export class SessionManager {
   ...
   * @param sessionDir Optional session directory. If omitted, uses default (~/.nodoassist/agent/sessions/<encoded-cwd>/).
   */
