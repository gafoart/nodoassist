...
import { resetApiProviders } from "@nodoassist/ai/providers";
...
export class AgentSession {
  ...
  /**
   * @deprecated Use the NodoAssist session export command instead.
   * @param outputPath Optional output path (defaults to session directory)
   * @returns Path to exported file
   */
  async exportToHtml(_outputPath?: string): Promise<string> {
    throw new Error(
      "AgentSession.exportToHtml is deprecated; use the NodoAssist session export command.",
    );
  }
