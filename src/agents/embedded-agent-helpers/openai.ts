 ...
 * pairs directly into the provider payload, so NodoAssist must normalize here.
 */
 ...
 *
 * NodoAssist persists provider-specific reasoning metadata in `thinkingSignature`; if that metadata
