...
export const PLUGIN_MODEL_CATALOG_GENERATED_BY = "nodoassist-plugin-model-catalog-v1";
...
/** Detects model catalogs generated by NodoAssist rather than user-authored JSON. */
