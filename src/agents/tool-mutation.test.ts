...
describe("tool mutation helpers", () => {
  ...
  it.each([
    ...
    ["exec", "gh search prs --repo nodoassist/nodoassist tool-mutation --json number,title,state"],
    ["bash", "gh pr view 123 --repo nodoassist/nodoassist --json title,state"],
  ...
  it.each([
    ...
    ["exec", "gh api --method POST repos/nodoassist/nodoassist/issues"],
