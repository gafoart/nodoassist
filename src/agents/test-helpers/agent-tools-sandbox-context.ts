...
export function createAgentToolsSandboxContext(
  ...
  return {
    ...
    runtimeId: params.containerName ?? "nodoassist-sbx-test",
    runtimeLabel: params.containerName ?? "nodoassist-sbx-test",
    containerName: params.containerName ?? "nodoassist-sbx-test",
