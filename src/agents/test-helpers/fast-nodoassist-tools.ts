/**
 * Fast NodoAssist tool-bundle mock.
 *
...
const createNodoAssistToolsMock = vi.fn(
  (options?: { enableHeartbeatTool?: boolean; recordToolPrepStage?: (name: string) => void }) => {
    options?.recordToolPrepStage?.("nodoassist-tools:test-helper");
    return coreTools
...
vi.mock("../nodoassist-tools.js", () => ({
  createNodoAssistTools: createNodoAssistToolsMock,
  testing: {
    setDepsForTest: () => {},
  },
}));
