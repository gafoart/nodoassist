...
function requireExecTool(tools: ReturnType<typeof createNodoAssistCodingTools>) {
...
describe("Agent-specific exec tool defaults", () => {
  ...
  it("should apply agent-specific exec host defaults over global defaults", async () => {
    ...
    const mainTools = createNodoAssistCodingTools({
      config: cfg,
      sessionKey: "agent:main:main",
    ...
    const helperTools = createNodoAssistCodingTools({
      config: cfg,
