 ...
 */
import { parseStrictNonNegativeInteger } from "@nodoassist/normalization-core/number-coercion";
...
export function buildProviderReauthCommand(
  ...
  return formatCliCommand(
    `nodoassist models auth login --provider ${quotePosixShellArg(trimmed)} --force`,
    env,
  );
}
