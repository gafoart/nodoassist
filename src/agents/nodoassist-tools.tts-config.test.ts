// Verifies createNodoAssistTools wires shared config and context into the TTS tool.
import { beforeEach, describe, expect, it, vi } from "vitest";
import type { NodoAssistConfig } from "../config/types.nodoassist.js";
import { testing, createNodoAssistTools } from "./nodoassist-tools.js";
...
const mocks = vi.hoisted(() => {
  ...
  return {
    ...
    textToSpeech: vi.fn(async () => ({
      success: true,
      audioPath: "/tmp/nodoassist/tts-config-test.opus",
      provider: "microsoft",
...
vi.mock("./nodoassist-tools.nodes-workspace-guard.js", () => ({
...
describe("createNodoAssistTools TTS config wiring", () => {
  beforeEach(() => {
...
describe("createNodoAssistTools media generation session wiring", () => {
  beforeEach(() => {
    mocks.createImageGenerateToolOptions.mockClear();
    mocks.createMusicGenerateToolOptions.mockClear();
    mocks.createVideoGenerateToolOptions.mockClear();
...
describe("createNodoAssistTools session status route context wiring", () => {
  beforeEach(() => {
...
describe("createNodoAssistTools cron context wiring", () => {
  beforeEach(() => {
    mocks.createCronToolOptions.mockClear();
  });
