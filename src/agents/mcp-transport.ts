 ...
 * streamable-HTTP SDK transports with NodoAssist auth, redirect, and logging rules.
 */
import {
  SSEClientTransport,
...
function attachStderrLogging(serverName: string, transport: NodoAssistStdioClientTransport) {
