...
describe("splitSdkTools", () => {
  ...
  it("keeps NodoAssist-managed custom tools in NodoAssist runtime's session allowlist", () => {
    // Session tools are NodoAssist-managed custom tools; dropping them from the
