...
type SandboxRegistryTable = NodoAssistStateKyselyDatabase["sandbox_registry_entries"];
type SandboxRegistryDatabase = Pick<NodoAssistStateKyselyDatabase, "sandbox_registry_entries">;
