...
export const DEFAULT_SANDBOX_IMAGE = "nodoassist-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "nodoassist-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "nodoassist-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "nodoassist-sandbox-common:bookworm-slim";
...
export const DEFAULT_SANDBOX_BROWSER_PREFIX = "nodoassist-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "nodoassist-sandbox-browser";
