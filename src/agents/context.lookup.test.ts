...
const contextTestState = vi.hoisted(() => {
  const state = {
    ...
    runtimeConfigSnapshot: null as NodoAssistConfig | null,
    runtimeConfigSourceSnapshot: null as NodoAssistConfig | null,
...
vi.mock("../config/runtime-source-projection.js", () => ({
  projectConfigOntoRuntimeSourceSnapshot: (config: NodoAssistConfig) =>
