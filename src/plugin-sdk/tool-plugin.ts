...
export const toolPluginMetadataSymbol = Symbol.for("nodoassist.plugin-sdk.tool-plugin.metadata");

/** Runtime context supplied to a concrete tool plugin execution handler. */
export type ToolPluginExecutionContext = {
  /** Plugin runtime API for tool implementations that need NodoAssist services. */
...
export type ToolPluginFactoryContext<TConfig> = {
  ...
  toolContext: NodoAssistPluginToolContext;
};
