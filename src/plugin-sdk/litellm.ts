...
import type { ModelDefinitionConfig, NodoAssistConfig } from "../config/types.js";
import { loadBundledPluginPublicSurfaceModuleSync } from "./facade-loader.js";

type FacadeModule = {
  applyLitellmConfig: (cfg: NodoAssistConfig) => NodoAssistConfig;
  applyLitellmProviderConfig: (cfg: NodoAssistConfig) => NodoAssistConfig;
...
/** Apply LiteLLM defaults to the full NodoAssist config. */
