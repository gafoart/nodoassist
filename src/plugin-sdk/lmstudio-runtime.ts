...
/** Normalized model metadata used by NodoAssist provider catalogs. */
...
export const LMSTUDIO_DEFAULT_MODEL_ID: FacadeModule["LMSTUDIO_DEFAULT_MODEL_ID"] =
  "qwen/qwen3.5-9b";
/** Stable provider id used in NodoAssist config and provider catalogs. */
...
/** Map one raw LM Studio model entry into NodoAssist model metadata. */
...
/** Discover NodoAssist model definitions from an LM Studio server. */
