...
export type { NodoAssistConfig, ModelApi, ModelDefinitionConfig, ModelProviderConfig };
export {
...
export type ProviderOnboardPresetAppliers<TArgs extends unknown[]> = {
  applyProviderConfig: (cfg: NodoAssistConfig, ...args: TArgs) => NodoAssistConfig;
  applyConfig: (cfg: NodoAssistConfig, ...args: TArgs) => NodoAssistConfig;
};
...
function hasAgentDefaultModelPrimary(cfg: NodoAssistConfig): boolean {
...
>(params: {
  ...
  applyPreset: (cfg: NodoAssistConfig, preset: TParams) => NodoAssistConfig;
  primaryModelRef: string;
...
export function applyOpencodeZenModelDefault(cfg: NodoAssistConfig): {
