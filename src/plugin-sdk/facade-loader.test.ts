...
const FACADE_LOADER_GLOBAL = "__nodoassistTestLoadBundledPluginPublicSurfaceModuleSync";
...
describe("plugin-sdk facade loader", () => {
  it("honors trusted bundled plugin dir overrides under the package root", () => {
    const pluginId = nextTrustedPluginId("nodoassist-facade-loader-override-");
    const overrideA = createBundledPluginFixture({
      pluginId,
      kind: "dist",
      prefix: "nodoassist-facade-loader-a-",
      marker: "override-a",
    });
    const overrideB = createBundledPluginFixture({
      pluginId,
      kind: "dist-runtime",
      prefix: "nodoassist-facade-loader-b-",
      marker: "override-b",
    });

    process.env.NODOASSIST_BUNDLED_PLUGINS_DIR = overrideA.bundledPluginsDir;
    ...
    process.env.NODOASSIST_BUNDLED_PLUGINS_DIR = overrideB.bundledPluginsDir;
  ...
  it("falls back to package source surfaces when an override dir lacks a bundled plugin", () => {
    const fixture = createPackageSourcePluginFixture({
      prefix: "nodoassist-facade-loader-source-fallback-",
      marker: "source-fallback",
    });
    process.env.NODOASSIST_BUNDLED_PLUGINS_DIR = createTempDirSync(
      "nodoassist-facade-loader-empty-",
    );
  ...
  it("shares loaded facade ids with facade-runtime", () => {
    const fixture = createBundledPluginFixture({
      prefix: "nodoassist-facade-loader-ids-",
      marker: "identity-check",
    });
    process.env.NODOASSIST_BUNDLED_PLUGINS_DIR = fixture.bundledPluginsDir;
  ...
  it("uses native require for Windows dist facade loads", () => {
    const fixture = createBundledPluginFixture({
      prefix: "nodoassist-facade-loader-windows-",
  ...
  it("breaks circular facade re-entry during module evaluation", () => {
    const fixture = createCircularPluginFixture("nodoassist-facade-loader-circular-");
    process.env.NODOASSIST_BUNDLED_PLUGINS_DIR = fixture.bundledPluginsDir;
  ...
  it("clears the cache on load failure so retries re-execute", () => {
    const fixture = createThrowingPluginFixture("nodoassist-facade-loader-throw-");
    process.env.NODOASSIST_BUNDLED_PLUGINS_DIR = fixture.bundledPluginsDir;
