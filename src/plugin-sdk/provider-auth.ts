...
export type { NodoAssistConfig } from "../config/config.js";
...
function readGithubCopilotDomainFromConfig(config?: NodoAssistConfig): string | undefined {
...
export async function resolveCopilotApiToken(params: {
  ...
  githubDomain?: string;
  /**
   * NodoAssist config used to resolve the persisted `githubDomain` provider
