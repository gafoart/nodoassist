...
export const DEFAULT_NODOASSIST_BROWSER_ENABLED = true;
...
export const DEFAULT_NODOASSIST_BROWSER_COLOR = "#FF4500";
/** Default NodoAssist-managed browser profile name. */
export const DEFAULT_NODOASSIST_BROWSER_PROFILE_NAME = "nodoassist";
/** Default browser profile selected when config omits a profile name. */
export const DEFAULT_BROWSER_DEFAULT_PROFILE_NAME = "nodoassist";
...
export const DEFAULT_UPLOAD_DIR = path.join(resolvePreferredNodoAssistTmpDir(), "uploads");
