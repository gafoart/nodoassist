...
import { runSetupWizardFinalize } from "nodoassist/plugin-sdk/plugin-test-runtime";
...
describe("createOptionalChannelSetupSurface", () => {
  it("returns a matched adapter and wizard for optional plugins", async () => {
    ...
    expect(
      ...
      "Example setup requires @nodoassist/example to be installed. Docs: https://docs.openclaw.ai/channels/example",
    );
    ...
    ).rejects.toThrow("@nodoassist/example");
  });
});
