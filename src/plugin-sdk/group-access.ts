...
/** @deprecated Use `resolveChannelMessageIngress` from `nodoassist/plugin-sdk/channel-ingress-runtime`. */
...
/** @deprecated Use route descriptors with `resolveChannelMessageIngress` from `nodoassist/plugin-sdk/channel-ingress-runtime`. */
...
/** @deprecated Use `resolveOpenProviderRuntimeGroupPolicy` plus `resolveChannelMessageIngress` from `nodoassist/plugin-sdk/channel-ingress-runtime`. */
