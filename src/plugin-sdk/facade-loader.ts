...
let cachedNodoAssistPackageRoot: string | undefined;

function getNodoAssistPackageRoot() {
  if (cachedNodoAssistPackageRoot) {
    return cachedNodoAssistPackageRoot;
  }
  cachedNodoAssistPackageRoot =
...
function resolveFacadeModuleLocation(params: {
  ...
  return resolveBundledFacadeModuleLocation({
    ...
    packageRoot: getNodoAssistPackageRoot(),
    bundledPluginsDir,
  });
}
...
function resolveFacadeBoundaryOpenParams(boundaryRoot: string): {
  ...
  if (isPathAtOrInside(boundaryRoot, getNodoAssistPackageRoot())) {
    return { boundaryLabel: "NodoAssist package root", rejectHardlinks: false };
  }
...
export function resetFacadeLoaderStateForTest(): void {
  ...
  cachedNodoAssistPackageRoot = undefined;
}
