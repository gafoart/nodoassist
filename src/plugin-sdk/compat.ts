 ...
 * older broad plugin-sdk imports. Use focused nodoassist/plugin-sdk subpaths
 * instead.
 */
...
const shouldWarnCompatImport =
  ...
  process.env.NODOASSIST_SUPPRESS_PLUGIN_SDK_COMPAT_WARNING !== "1";

if (shouldWarnCompatImport) {
  process.emitWarning(
    "nodoassist/plugin-sdk/compat is deprecated for new plugins. Migrate to focused nodoassist/plugin-sdk/<subpath> imports. See https://docs.openclaw.ai/plugins/sdk-migration",
    {
      code: "NODOASSIST_PLUGIN_SDK_COMPAT_DEPRECATED",
      detail:
...
export { resolvePreferredNodoAssistTmpDir } from "./temp-path.js";
...
/** @deprecated Use `nodoassist/plugin-sdk/channel-outbound`. */
