...
import {
  ...
  type NodoAssistPluginApiWithoutFacades,
} from "../plugins/api-facades.js";
import type { NodoAssistPluginApi } from "./plugin-runtime.js";

/** Partial plugin API overrides accepted by the SDK test helper. */
export type TestPluginApiInput = Partial<NodoAssistPluginApi>;

/** Create a minimal plugin API object for plugin-sdk contract and unit tests. */
export function createTestPluginApi(api: TestPluginApiInput = {}): NodoAssistPluginApi {
  ...
  const mergedApi = {
    ...
    on() {},
    ...flatApi,
  } as NodoAssistPluginApiWithoutFacades;
