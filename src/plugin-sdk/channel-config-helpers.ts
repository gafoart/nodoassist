...
type ChannelConfigAccessorParams<Config extends NodoAssistConfig = NodoAssistConfig> = {
  cfg: Config;
  accountId?: string | null;
};
...
type MultiAccountChannelConfigAdapterParams<
  ...
  Config extends NodoAssistConfig = NodoAssistConfig,
> = {
  sectionKey: string;
...
> {
  const base = {
    resolveAllowFrom({ cfg, accountId }: { cfg: NodoAssistConfig; accountId?: string | null }) {
...
function setTopLevelChannelEnabledInConfigSection<Config extends NodoAssistConfig>(params: {
  cfg: Config;
  sectionKey: string;
  enabled: boolean;
}): Config {
...
function removeTopLevelChannelConfigSection<Config extends NodoAssistConfig>(params: {
  cfg: Config;
  sectionKey: string;
}): Config {
...
function clearTopLevelChannelConfigFields<Config extends NodoAssistConfig>(params: {
  cfg: Config;
  sectionKey: string;
  clearBaseFields: string[];
}): Config {
