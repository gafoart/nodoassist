...
type EnsureAuthProfileStore =
  typeof import("nodoassist/plugin-sdk/provider-auth").ensureAuthProfileStore;
type ListProfilesForProvider =
  typeof import("nodoassist/plugin-sdk/provider-auth").listProfilesForProvider;
...
function installSharedAuthProfileStoreHooks(state: { authStore: AuthProfileStore }) {
  beforeEach(() => {
    vi.doMock("nodoassist/plugin-sdk/provider-auth", async () => {
