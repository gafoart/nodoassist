// NodoAssist-owned tool runtime contract helpers mock agent tool runtimes in SDK tests.
...
export function installNodoAssistOwnedToolHooks(params?: {
 ...
 * Pair with `installNodoAssistOwnedToolHooks()` when a test asserts before/after hook behavior.
 */
...
export function resetNodoAssistOwnedToolHooks(): void {
  resetGlobalHookRunner();
  resetPluginRuntimeStateForTest();
