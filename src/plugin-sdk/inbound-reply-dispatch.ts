/**
 * @deprecated Use `nodoassist/plugin-sdk/channel-inbound` for inbound runners and
 * dispatch predicates. Use `nodoassist/plugin-sdk/channel-outbound` for message
 * delivery helpers.
 */
