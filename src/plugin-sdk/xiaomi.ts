...
type FacadeModule = {
  applyXiaomiConfig: (cfg: NodoAssistConfig) => NodoAssistConfig;
  applyXiaomiProviderConfig: (cfg: NodoAssistConfig) => NodoAssistConfig;
...
/** Apply Xiaomi provider defaults to the full NodoAssist config. */
