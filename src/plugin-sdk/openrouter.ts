...
type FacadeModule = {
  applyOpenrouterConfig: (cfg: NodoAssistConfig) => NodoAssistConfig;
  applyOpenrouterProviderConfig: (cfg: NodoAssistConfig) => NodoAssistConfig;
...
/** Apply OpenRouter defaults to the full NodoAssist config. */
