...
describe("avatar policy", () => {
  ...
  it("detects avatar-like path strings", () => {
    expect(looksLikeAvatarPath("avatars/nodoassist.svg")).toBe(true);
    expect(looksLikeAvatarPath("nodoassist.webp")).toBe(true);
