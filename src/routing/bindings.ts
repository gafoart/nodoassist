...
export function listBindings(cfg: NodoAssistConfig): AgentRouteBinding[] {
  return listRouteBindings(cfg);
}

export function listBoundAccountIds(cfg: NodoAssistConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: NodoAssistConfig) {
