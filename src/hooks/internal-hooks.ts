/**
 * Hook system for NodoAssist agent events
 *
 ...
 */
const INTERNAL_HOOK_HANDLERS_KEY = Symbol.for("nodoassist.internalHookHandlers");
...
const INTERNAL_HOOKS_ENABLED_KEY = Symbol.for("nodoassist.internalHooksEnabled");
