...
function isCompatibleTopLevelRuntimeProjectionShape(params: {
  runtimeSnapshot: NodoAssistConfig;
...
export function projectConfigOntoRuntimeSourceSnapshot(config: NodoAssistConfig): NodoAssistConfig {
  ...
  return applyMergePatch(projectedSource, runtimePatch) as NodoAssistConfig;
}
