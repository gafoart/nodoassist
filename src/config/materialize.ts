...
export function asResolvedSourceConfig(config: NodoAssistConfig): ResolvedSourceConfig {
  return config as ResolvedSourceConfig;
}

export function asRuntimeConfig(config: NodoAssistConfig): RuntimeConfig {
