...
export type DiscordVoiceRealtimeConfig = {
  ...
  /** Whether bidi should force the NodoAssist agent brain for every substantive turn. */
  ...
  /** Debounce window before buffered transcripts are sent to the NodoAssist agent. */
  debounceMs?: number;
...
export type DiscordVoiceAgentSessionConfig = {
  /** Which NodoAssist conversation should receive voice turns. Default: "voice". */
  mode?: "voice" | "target";
...
export type DiscordVoiceConfig = {
  ...
  /** Route voice turns through an existing NodoAssist Discord conversation. */
