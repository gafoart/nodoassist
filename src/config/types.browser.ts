...
export type BrowserProfileConfig = {
  ...
  mcpArgs?: string[];
  /**
   * Profile driver (default: nodoassist). "extension" attaches to the user's
   * signed-in browser through the NodoAssist Chrome extension relay.
   */
  driver?: "nodoassist" | "clawd" | "existing-session" | "extension";
...
export type BrowserConfig = {
  ...
  /** Accent color for the nodoassist browser profile (hex). Default: #FF4500 */
  color?: string;
