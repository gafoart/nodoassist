...
function expectNodoAssistSchemaInvalidPreservesField(params: {
  config: unknown;
  ...
  const res = NodoAssistSchema.safeParse(params.config);
...
describe("legacy config detection", () => {
  ...
  it("rejects removed legacy provider sections", () => {
    expectNodoAssistSchemaInvalidPreservesField({
  ...
  it("preserves claude-cli auth profile mode during validation", () => {
    ...
    const res = NodoAssistSchema.safeParse(config);
