...
} from "@nodoassist/net-policy/redact-sensitive-url";
...
import type { ConfigFileSnapshot } from "./types.nodoassist.js";
 ...
 */
export const REDACTED_SENTINEL = "__NODOASSIST_REDACTED__";
