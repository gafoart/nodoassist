...
import type { ModelProviderConfig, NodoAssistConfig } from "./types.js";
...
vi.mock("./provider-policy.js", () => ({
  applyProviderConfigDefaultsForConfig: (params: { config: NodoAssistConfig }) => params.config,
      ...
      plugins: [
        {
          ...
          source: "test",
          manifestPath: "/tmp/custom-provider-plugin/nodoassist.plugin.json",
