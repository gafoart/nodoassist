...
describe("normalizePackageTagInput", () => {
  const packageNames = ["nodoassist", "@nodoassist/plugin"] as const;

  it.each([
    { input: undefined, expected: null },
    { input: "   ", expected: null },
    { input: "nodoassist@beta", expected: "beta" },
    { input: "@nodoassist/plugin@2026.2.24", expected: "2026.2.24" },
    { input: "nodoassist@   ", expected: null },
    { input: "nodoassist", expected: null },
    { input: " @nodoassist/plugin ", expected: null },
    { input: " latest ", expected: "latest" },
    { input: "@other/plugin@beta", expected: "@other/plugin@beta" },
    { input: "nodoassister@beta", expected: "nodoassister@beta" },
