...
describe("exec-command-resolution", () => {
  ...
  it("does not synthesize cwd-joined allowlist candidates from drive-less windows roots", () => {
    ...
    expect(
      resolveAllowlistCandidatePath(
        {
          rawExecutable: String.raw`:\Users\demo\AI\system\nodoassist`,
          executableName: "nodoassist",
        },
        String.raw`C:\Users\demo\AI\system\nodoassist`,
      ),
    ).toBeUndefined();
    expect(
      resolveAllowlistCandidatePath(
        {
          rawExecutable: String.raw`:/Users/demo/AI/system/nodoassist`,
          executableName: "nodoassist",
        },
        String.raw`C:\Users\demo\AI\system\nodoassist`,
      ),
