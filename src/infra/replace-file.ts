// Wraps fs-safe atomic replacement and move helpers for NodoAssist install flows.
...
/**
 * Moves a path using fs-safe's copy fallback, with an NodoAssist hardlink guard
