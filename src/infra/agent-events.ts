...
const AGENT_EVENT_STATE_KEY = Symbol.for("nodoassist.agentEvents.state");
const AGENT_EVENT_EXECUTION_CONTEXT_KEY = Symbol.for("nodoassist.agentEvents.executionContext");
