...
const BLOCKED_WORKSPACE_DOTENV_KEYS = new Set([
  ...
  "NODOASSIST_PINNED_PYTHON",
  "NODOASSIST_PINNED_WRITE_PYTHON",
  "NODOASSIST_PLUGIN_INSTALL_OVERRIDES",
  ...
  "NODOASSIST_TEST_TAILSCALE_BINARY",
  "PATH",
  "PI_CODING_AGENT_DIR",
...
const BLOCKED_WORKSPACE_DOTENV_PREFIXES = [
  ...
  "CLAWHUB_",
  "OPENAI_API_KEY_",
  // Workspace .env is untrusted; reserve the full NodoAssist runtime namespace
  // for shell/global config so new NODOASSIST_* controls are fail-closed by default.
  "NODOASSIST_",
  "NODOASSIST_CLAWHUB_",
  "NODOASSIST_DISABLE_",
  "NODOASSIST_SKIP_",
...
export function loadDotEnv(opts?: { quiet?: boolean }) {
  ...
  // Then load global fallback: ~/.nodoassist/.env (or NODOASSIST_STATE_DIR/.env),
