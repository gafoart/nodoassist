...
import { normalizeUniqueStringEntriesLower } from "@nodoassist/normalization-core/string-normalization";
import type { NodoAssistConfig } from "../config/types.nodoassist.js";

const DIAGNOSTICS_ENV = "NODOASSIST_DIAGNOSTICS";
...
/** Resolves enabled diagnostic flags from config plus `NODOASSIST_DIAGNOSTICS` overrides. */
