...
describe("unwrapKnownDispatchWrapperInvocation", () => {
  test.each([
    ...
    {
      argv: ["flock", "-n", "/tmp/nodoassist.lock", "bash", "-lc", "echo hi"],
      expected: { kind: "unwrapped", wrapper: "flock", argv: ["bash", "-lc", "echo hi"] },
    },
    {
      argv: ["flock", "-en", "/tmp/nodoassist.lock", "bash", "-lc", "echo hi"],
      expected: { kind: "unwrapped", wrapper: "flock", argv: ["bash", "-lc", "echo hi"] },
    },
    {
      argv: ["flock", "-E", "1", "/tmp/nodoassist.lock", "bash", "-lc", "echo hi"],
      expected: { kind: "unwrapped", wrapper: "flock", argv: ["bash", "-lc", "echo hi"] },
    },
    {
      argv: ["flock", "-F", "/tmp/nodoassist.lock", "bash", "-lc", "echo hi"],
      expected: { kind: "unwrapped", wrapper: "flock", argv: ["bash", "-lc", "echo hi"] },
    },
    {
      argv: ["flock", "-o", "/tmp/nodoassist.lock", "bash", "-lc", "echo hi"],
      expected: { kind: "unwrapped", wrapper: "flock", argv: ["bash", "-lc", "echo hi"] },
    },
    {
      argv: ["flock", "--nb", "/tmp/nodoassist.lock", "bash", "-lc", "echo hi"],
      expected: { kind: "unwrapped", wrapper: "flock", argv: ["bash", "-lc", "echo hi"] },
    },
    {
      argv: ["flock", "--wait", "1", "/tmp/nodoassist.lock", "bash", "-lc", "echo hi"],
      expected: { kind: "unwrapped", wrapper: "flock", argv: ["bash", "-lc", "echo hi"] },
    },
    {
    ...
    {
      argv: ["flock", "/tmp/nodoassist.lock", "-c", "echo hi"],
      expected: { kind: "blocked", wrapper: "flock" },
    },
    {
      argv: ["flock", "-un", "/tmp/nodoassist.lock", "bash", "-lc", "echo hi"],
      expected: { kind: "blocked", wrapper: "flock" },
    },
    {
      argv: ["flock", "-u", "9"],
...
describe("resolveDispatchWrapperTrustPlan", () => {
  ...
  test.each([
    ...
    {
      argv: ["flock", "--timeout=2", "/tmp/nodoassist.lock", "bash", "-lc", "echo hi"],
      wrapper: "flock",
      effectiveArgv: ["bash", "-lc", "echo hi"],
    },
    {
      argv: ["flock", "--close", "/tmp/nodoassist.lock", "bash", "-lc", "echo hi"],
      wrapper: "flock",
      effectiveArgv: ["bash", "-lc", "echo hi"],
    },
    {
      argv: ["flock", "--no-fork", "/tmp/nodoassist.lock", "bash", "-lc", "echo hi"],
      wrapper: "flock",
      effectiveArgv: ["bash", "-lc", "echo hi"],
    },
    {
