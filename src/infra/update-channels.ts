// Resolves NodoAssist update channels from config, tags, and versions.
...
/**
 * Env var carrying the *effective* update channel into `nodoassist update finalize`
 ...
 * channel split (`NODOASSIST_UPDATE_POST_CORE_CHANNEL` vs `…_REQUESTED_CHANNEL`).
 */
export const UPDATE_EFFECTIVE_CHANNEL_ENV = "NODOASSIST_UPDATE_EFFECTIVE_CHANNEL";
...
/** Maps an NodoAssist update channel to the npm dist-tag used for package lookups. */
