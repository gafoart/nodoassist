...
describe("post-install doctor result IPC", () => {
  ...
  it("rejects result paths outside the secure NodoAssist temp root", async () => {
    const tempRoot = resolvePreferredNodoAssistTmpDir();
    const resultPath = path.join(
      `${tempRoot}-outside`,
      `nodoassist-update-doctor-${process.pid}-00000000-0000-4000-8000-000000000000.json`,
    );
