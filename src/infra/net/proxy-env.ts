...
// adding NodoAssist NO_PROXY CIDR/wildcard bypass checks.
 ...
 * - NodoAssist extension: IPv4 CIDR and octet-wildcard entries
 ...
 * in provider HTTP helpers; see nodoassist#64974 review thread on NO_PROXY
 * SSRF bypass.
 */
