...
// NodoAssist HTTP/1, timeout, proxy TLS, and IP-safe proxy policies.
import { createRequire } from "node:module";
import net from "node:net";
import { isRecord as isObjectRecord } from "@nodoassist/normalization-core/record-coerce";
...
export const TEST_UNDICI_RUNTIME_DEPS_KEY = "__NODOASSIST_TEST_UNDICI_RUNTIME_DEPS__";
...
/** Creates a direct undici Agent with NodoAssist's HTTP/1-only dispatcher policy. */
...
/**
 * Creates an EnvHttpProxyAgent with NodoAssist proxy TLS, IP-safe proxy pools,
