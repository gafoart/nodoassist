...
import { normalizeOptionalString as asString } from "@nodoassist/normalization-core/string-coerce";
...
export function buildCommitmentExtractionPrompt(params: {
  ...
  return `You are NodoAssist's internal commitment extractor. This is a hidden background classification run. Do not address the user.
