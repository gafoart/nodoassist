...
export function resolveCommitmentsConfig(cfg?: NodoAssistConfig): ResolvedCommitmentsConfig {
...
export function resolveCommitmentTimezone(cfg?: NodoAssistConfig): string {
