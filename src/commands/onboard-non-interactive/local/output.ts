...
function recoveryHintForGatewayHealthFailure(
  ...
  switch (classification) {
    case "auth-mismatch":
      return "Fix: run `nodoassist doctor --fix`.";
    case "module-missing":
      return "Fix: run `nodoassist doctor --fix`.";
    case "service-missing":
      return "Fix: run `nodoassist gateway install --force`.";
    case "service-stopped":
      return "Fix: run `nodoassist gateway restart`.";
    case "startup-blocked":
      return "Fix: run `nodoassist gateway status --deep`.";
    case "not-listening":
      return "Fix: start `nodoassist gateway run`, or run `nodoassist gateway restart` for a managed gateway.";
    default:
      return undefined;
  }
}
