...
import { normalizeSortedUniqueStringEntries } from "@nodoassist/normalization-core/string-normalization";
...
function resolveDefaultAccountId(cfg: NodoAssistConfig, provider: ChannelId): string {
...
function listManifestChannelIds(config: NodoAssistConfig): Set<string> {
  return new Set(
