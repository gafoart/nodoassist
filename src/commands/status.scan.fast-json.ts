// Fast `nodoassist status --json` scan policy.
...
type StatusJsonScanPolicy = {
  ...
  gatewayProbeTimeoutMs?: number | ((cfg: NodoAssistConfig) => number | undefined);
...
function hasExplicitStatusJsonChannelConfig(cfg: NodoAssistConfig): boolean {
...
function hasPotentialConfiguredChannelsForStatusJson(cfg: NodoAssistConfig): boolean {
