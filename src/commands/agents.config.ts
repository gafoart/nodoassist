// Agent config mutation and summary builders used by `nodoassist agents` commands.
import {
...
function resolveAgentModel(cfg: NodoAssistConfig, agentId: string) {
...
export function buildAgentSummaries(cfg: NodoAssistConfig): AgentSummary[] {
