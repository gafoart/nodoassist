...
export const DISABLE_PLUGIN_REGISTRY_MIGRATION_ENV = "NODOASSIST_DISABLE_PLUGIN_REGISTRY_MIGRATION";
export const FORCE_PLUGIN_REGISTRY_MIGRATION_ENV = "NODOASSIST_FORCE_PLUGIN_REGISTRY_MIGRATION";
...
export type PluginRegistryInstallMigrationParams = LoadInstalledPluginIndexParams &
  InstalledPluginIndexStoreOptions & {
    ...
    readConfig?: () => Promise<NodoAssistConfig> | NodoAssistConfig;
  };
...
function listConfiguredChannelIds(config: NodoAssistConfig): Set<string> {
...
function listConfiguredModelProviderIds(config: NodoAssistConfig): Set<string> {
...
export async function migratePluginRegistryForInstall(
  ...
  const config = stripShippedPluginInstallConfigRecords(rawConfig) as NodoAssistConfig;
