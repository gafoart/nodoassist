...
function collectToolAllowlistSources(cfg: NodoAssistConfig): ToolAllowlistSource[] {
...
function collectConfiguredMcpServerNames(cfg: NodoAssistConfig): string[] {
...
function collectSandboxMcpAllowlistWarnings(cfg: NodoAssistConfig): string[] {
