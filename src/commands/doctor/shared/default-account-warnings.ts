...
export function collectMissingDefaultAccountBindingWarnings(cfg: NodoAssistConfig): string[] {
...
export function collectMissingExplicitDefaultAccountWarnings(cfg: NodoAssistConfig): string[] {
  const warnings: string[] = [];
