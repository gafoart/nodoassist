...
export const UPDATE_IN_PROGRESS_ENV = "NODOASSIST_UPDATE_IN_PROGRESS";
export const UPDATE_POST_CORE_CONVERGENCE_ENV = "NODOASSIST_UPDATE_POST_CORE_CONVERGENCE";
 ...
 * `NODOASSIST_UPDATE_IN_PROGRESS` directly (`commands/doctor-update.ts`,
 ...
 * `NODOASSIST_UPDATE_IN_PROGRESS`, so configured plugin repair must happen now.
 */
