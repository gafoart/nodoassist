...
export function scanLegacyToolsBySenderKeys(cfg: NodoAssistConfig): LegacyToolsBySenderKeyHit[] {
...
export function maybeRepairLegacyToolsBySenderKeys(cfg: NodoAssistConfig): {
