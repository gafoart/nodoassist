...
function collectExecSafeBinScopes(cfg: NodoAssistConfig): ExecSafeBinScopeRef[] {
...
export function scanExecSafeBinCoverage(cfg: NodoAssistConfig): ExecSafeBinCoverageHit[] {
...
export function maybeRepairExecSafeBinProfiles(cfg: NodoAssistConfig): {
