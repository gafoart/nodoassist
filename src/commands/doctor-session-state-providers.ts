...
import { normalizeStringEntriesLower } from "@nodoassist/normalization-core/string-normalization";
...
function resolveSessionAgentId(cfg: NodoAssistConfig, sessionKey: string): string {
