...
function hasExplicitMemorySearchConfig(cfg: NodoAssistConfig, agentId: string): boolean {
...
export function resolveMemoryPluginStatus(cfg: NodoAssistConfig): MemoryPluginStatus {
