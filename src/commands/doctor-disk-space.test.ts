...
describe("buildDiskSpaceWarnings", () => {
  ...
  it("returns warning lines when space is low (below 500 MB)", () => {
    ...
    expect(warnings[0]).toContain("~/.nodoassist");
  });
  ...
  it("returns a low-space warning finding", () => {
    ...
    expect(findings).toEqual([
      expect.objectContaining({
        ...
        severity: "warning",
        message: "Low disk space: 300 MB free on the partition containing /home/test/.nodoassist.",
  ...
  it("returns a critical-space warning finding", () => {
    ...
    expect(findings).toEqual([
      expect.objectContaining({
        checkId: "core/doctor/disk-space",
        severity: "warning",
        message: "CRITICAL: only 50 MB free on the partition containing /home/test/.nodoassist.",
        path: "/home/test/.nodoassist",
        target: "50 MB",
