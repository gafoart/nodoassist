...
import type { NodoAssistConfig, ConfigFileSnapshot } from "../../config/types.js";
...
/** Extracts the config fields displayed by `nodoassist gateway status --deep`. */
...
export function buildNetworkHints(cfg: NodoAssistConfig, localPortOverride?: number) {
