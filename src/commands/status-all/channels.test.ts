      ...
      rows: [
        {
          ...
          state: "warn",
          detail:
            "plugin not installed - run nodoassist plugins install @nodoassist/feishu or nodoassist doctor --fix",
        },
      ],
      details: [],
    });
      ...
      rows: [
        {
          ...
          enabled: true,
          state: "warn",
          detail: "plugin load failed: dependency tree corrupted; run nodoassist doctor --fix",
        },
      ],
      details: [],
    });
