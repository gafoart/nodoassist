...
function resolveConfiguredCommandOwners(cfg: NodoAssistConfig): string[] {
...
export function hasConfiguredCommandOwners(cfg: NodoAssistConfig): boolean {
...
export function noteCommandOwnerHealth(cfg: NodoAssistConfig): void {
  ...
  note(
    [
      ...
      `Fix: set commands.ownerAllowFrom to your channel user id, for example ${formatCliCommand("nodoassist config set commands.ownerAllowFrom '[\"telegram:123456789\"]'")}`,
