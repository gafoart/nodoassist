...
type CapabilityProviderCandidate = {
  ...
  isConfigured?: (ctx: { cfg?: NodoAssistConfig; agentDir?: string }) => boolean;
};
...
function resolveCurrentDefaultProviderId(cfg?: NodoAssistConfig): string {
...
function resolveAutoCapabilityFallbackRefs(params: {
  cfg: NodoAssistConfig;
  agentDir?: string;
  listProviders: (cfg?: NodoAssistConfig) => CapabilityProviderCandidate[];
}): string[] {
