...
function makeContext(sourceConfig: NodoAssistConfig): ResolverContext {
...
function collectAcpxConfigAssignments(config: NodoAssistConfig): ResolverContext {
...
function expectInactiveAcpxConfig(config: NodoAssistConfig): void {
