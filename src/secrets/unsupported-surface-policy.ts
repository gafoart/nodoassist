...
// Candidate scanning only sees nodoassist.json; auth-profile-only surfaces are audited elsewhere.
...
/**
 * Concrete unsupported config value discovered from an nodoassist.json-like object.
 */
...
/**
 * Finds configured nodoassist.json values whose surfaces currently reject SecretRef objects.
 */
