...
function hasConfiguredPluginEntries(config: NodoAssistConfig): boolean {
...
function hasConfiguredChannelEntries(config: NodoAssistConfig): boolean {
...
function hasConfiguredPluginIntegrationSecretProviders(config: NodoAssistConfig): boolean {
...
function shouldLoadPluginMetadataForSecrets(config: NodoAssistConfig): boolean {
  return (
