...
export type SecretTargetConfigFile = "nodoassist.json" | "auth-profiles.json"; // pragma: allowlist secret
...
export type SecretTargetRegistryEntry = {
  ...
  /** Enables `nodoassist secrets apply` targeting for this entry. */
