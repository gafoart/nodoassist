...
function toCandidate(
  ...
  defaults: NonNullable<NodoAssistConfig["secrets"]>["defaults"] | undefined,
 ...
 */
export function migrateLegacySecretRefEnvMarkers(config: NodoAssistConfig): {
  config: NodoAssistConfig;
  changes: string[];
} {
  ...
  const next = structuredClone(config) as NodoAssistConfig & Record<string, unknown>;
