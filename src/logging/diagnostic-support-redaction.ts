...
import { isSensitiveUrlQueryParamName } from "@nodoassist/net-policy/redact-sensitive-url";
...
function pathRedactionPrefixes(options: SupportRedactionContext): PathRedactionPrefix[] {
  ...
  addPathPrefixVariants(prefixes, options.stateDir, "$NODOASSIST_STATE_DIR");
