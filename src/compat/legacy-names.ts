// Product/package naming constants that bridge current NodoAssist manifests with
// legacy Clawdbot keys still seen in older configs and packages.
export const PROJECT_NAME = "nodoassist" as const;
...
export const MACOS_APP_SOURCES_DIR = "apps/macos/Sources/NodoAssist" as const;
