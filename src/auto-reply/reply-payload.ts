...
const PAIRING_QR_REPLY_CHANNEL_DATA_KEY = "nodoassistPairingQr";
...
export function isFastModeAutoProgressPayload(payload: Pick<ReplyPayload, "channelData">): boolean {
  return payload.channelData?.nodoassistProgressKind === FAST_MODE_AUTO_PROGRESS_KIND;
}
...
export type ReplyPayloadMetadata = {
  ...
  /**
   * Internal NodoAssist notices generated after a runtime/provider failure are
