// Projects ACP runtime events into NodoAssist-visible session update records.
import type { AcpRuntimeEvent, AcpSessionUpdateTag } from "@nodoassist/acp-core/runtime/types";
import {
