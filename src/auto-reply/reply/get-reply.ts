...
import { type NodoAssistConfig, getRuntimeConfig } from "../../config/config.js";
...
function resolveHeartbeatAckMaxChars(cfg: NodoAssistConfig, agentId: string): number {
...
export async function getReplyFromConfig(
  ...
  const isFastTestEnv = process.env.NODOASSIST_TEST_FAST === "1";
