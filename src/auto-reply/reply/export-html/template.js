...
(function () {
  ...
  const injectedParams = document.querySelector('meta[name="nodoassist-url-params"]');
  ...
  function buildShareUrl(entryId) {
    ...
    const baseUrlMeta = document.querySelector('meta[name="nodoassist-share-base-url"]');
