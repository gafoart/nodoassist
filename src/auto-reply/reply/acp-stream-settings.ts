...
import type { AcpSessionUpdateTag } from "@nodoassist/acp-core/runtime/types";
...
function resolveAcpStreamCoalesceIdleMs(cfg: NodoAssistConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: NodoAssistConfig): number {
...
export function resolveAcpProjectionSettings(cfg: NodoAssistConfig): AcpProjectionSettings {
