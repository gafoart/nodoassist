...
function getDiscordExecApprovalApproversForTests(params: { cfg: NodoAssistConfig }): string[] {
...
function listConfiguredTelegramAccountIds(cfg: NodoAssistConfig): string[] {
