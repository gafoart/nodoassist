...
import { parseStrictPositiveInteger } from "@nodoassist/normalization-core/number-coercion";
import {
...
function buildRuntimeChoice(params: {
  ...
  return {
    ...
    description:
      id === "nodoassist"
        ? "Use the built-in NodoAssist runtime."
        : params.cli
...
export async function buildModelsProviderData(
  ...
  for (const binding of runtimeBindings) {
    ...
    addRuntimeChoice(choices, buildRuntimeChoice({ cfg, provider, runtime: "nodoassist" }));
    addRuntimeChoice(
      choices,
      buildRuntimeChoice({
        cfg,
