...
const suiteTempDirs = createSuiteTempRootTracker({ prefix: "nodoassist-abort-" });
...
describe("abort detection", () => {
  ...
  it("isAbortRequestText aligns abort command semantics", () => {
    ...
    expect(isAbortRequestText("stop nodoassist!!!")).toBe(true);
    ...
    expect(isAbortRequestText("/stop@nodoassist_bot", { botUsername: "nodoassist_bot" })).toBe(
      true,
    );
    expect(isAbortRequestText("/Stop@nodoassist_bot", { botUsername: "nodoassist_bot" })).toBe(
      true,
