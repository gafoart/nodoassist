// Bridges ACP transcript events into persisted NodoAssist session transcripts.
import { resolveAcpSessionCwd } from "@nodoassist/acp-core/runtime/session-identifiers";
