...
import { normalizeOptionalString as readString } from "@nodoassist/normalization-core/string-coerce";
...
const HEARTBEAT_RESPONSE_CHANNEL_DATA_KEY = "nodoassistHeartbeatResponse";
