...
let webFetchProviderCache = new WeakMap<NodoAssistConfig, WebFetchProviderCacheEntry>();
...
function resolveFetchConfig(config: NodoAssistConfig | undefined): WebFetchConfig | undefined {
...
function createWebFetchProviderConfigFingerprint(config: NodoAssistConfig): string {
