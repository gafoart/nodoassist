...
function summarizeGroupPolicy(cfg: NodoAssistConfig): {
  open: number;
  allowlist: number;
  other: number;
} {
...
function hasWebSearchKey(cfg: NodoAssistConfig, env: NodeJS.ProcessEnv): boolean {
...
function isWebSearchEnabled(cfg: NodoAssistConfig, env: NodeJS.ProcessEnv): boolean {
...
function isWebFetchEnabled(cfg: NodoAssistConfig): boolean {
...
function isBrowserEnabled(cfg: NodoAssistConfig): boolean {
...
export function collectAttackSurfaceSummaryFindings(cfg: NodoAssistConfig): SecurityAuditFinding[] {
