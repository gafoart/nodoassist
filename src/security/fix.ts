...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof NodoAssistConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: NodoAssistConfig; env: NodeJS.ProcessEnv }): {
  cfg: NodoAssistConfig;
  changes: string[];
} {
