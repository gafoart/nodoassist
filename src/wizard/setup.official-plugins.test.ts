  ...
  it("installs selected optional official plugins through the shared onboarding installer", async () => {
      ...
      expect.arrayContaining([
        {
          value: "acpx",
          label: "ACPX Runtime",
          hint: "NodoAssist ACP runtime backend",
        },
        {
          value: "diagnostics-otel",
          label: "Diagnostics OpenTelemetry",
          hint: "NodoAssist diagnostics OpenTelemetry exporter",
        },
        {
          value: "diagnostics-prometheus",
          label: "Diagnostics Prometheus",
          hint: "NodoAssist diagnostics Prometheus exporter",
        },
        {
          value: "tokenjuice",
          label: "Tokenjuice",
          hint: "NodoAssist tokenjuice exec output compaction plugin",
        },
      ]),
    );
    expect(ensureOnboardingPluginInstalled).toHaveBeenCalledExactlyOnceWith({
      ...
      entry: {
        ...
        label: "Diagnostics OpenTelemetry",
        description: "NodoAssist diagnostics OpenTelemetry exporter",
        install: {
          clawhubSpec: "clawhub:@nodoassist/diagnostics-otel",
          npmSpec: "@nodoassist/diagnostics-otel",
          defaultChoice: "npm",
