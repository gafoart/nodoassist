...
export const en = {
  ...
  wizard: {
    ...
    gateway: {
      ...
      plaintextPasswordHint: "Stores the password directly in NodoAssist config",
    ...
    migration: {
      ...
      complete: "Migration complete. Run `nodoassist doctor` next.",
    ...
    plugins: {
      ...
      sensitiveField:
        '"{label}" is sensitive. Set it via:\n  nodoassist config set plugins.entries.{plugin}.config.{field} <value>\nor use the Web UI Settings page.',
    ...
    remote: {
      ...
      insecureRemoteUrl:
        "Use wss:// for remote hosts, or ws://127.0.0.1/localhost via SSH tunnel. Break-glass: NODOASSIST_ALLOW_INSECURE_PRIVATE_WS=1 for trusted private networks.",
      ...
      plaintextPasswordHint: "Stores the password directly in NodoAssist config",
      plaintextPasswordLabel: "Enter password now",
      plaintextTokenHint: "Stores the token directly in NodoAssist config",
    ...
    security: {
      ...
      beta: "NodoAssist is a hobby project and still in beta. Expect sharp edges.",
      confirm:
        "I understand this is personal-by-default and shared/multi-user use requires lock-down. Continue?",
      hardeningRequired:
        "If you're not comfortable with security hardening and access control, don't run NodoAssist.",
      learnMore: "Learn more",
      notMultitenant: "NodoAssist is not a hostile multi-tenant boundary by default.",
      personalAgent: "By default, NodoAssist is a personal agent: one trusted operator boundary.",
    ...
    skills: {
      ...
      manualPrereqsDoctorHint:
        "Install those tools first, then run `nodoassist doctor` to review skills + requirements.",
    ...
    nextcloudTalk: {
      ...
      helpInstallCommand:
        '2) Run: ./occ talk:bot:install "NodoAssist" "<shared-secret>" "<webhook-url>" --feature webhook --feature response --feature reaction',
    ...
    whatsapp: {
      ...
      ownerNumberNote: "We need the sender/owner number so NodoAssist can allowlist you.",
      ...
      separatePhoneLabel: "Separate phone just for NodoAssist",
    ...
    irc: {
      ...
      nextStatusCommand: "Command: nodoassist channels status --probe",
    ...
    synologyChat: {
      ...
      incomingWebhookHelpReplies: "This is the URL NodoAssist uses to send replies back to Chat.",
    ...
    signal: {
      ...
      multipleEntries: "Multiple entries: comma-separated.",
      nextLinkDevice: 'Link device with: signal-cli link -n "NodoAssist"',
    ...
    twitch: {
      ...
      envPrompt: "Twitch env var NODOASSIST_TWITCH_ACCESS_TOKEN detected. Use env token?",
      ...
      helpEnvVars: "Env vars supported: NODOASSIST_TWITCH_ACCESS_TOKEN",
    ...
    channelsPrimer: {
      ...
      blurbs: {
        ...
        synologyChat: "Connect your Synology NAS Chat to NodoAssist with full agent capabilities.",
    ...
    search: {
      ...
      configured: "configured",
      configureLaterHint: "Configure later with nodoassist configure --section web",
      docsLine: "Docs: {url}",
    ...
    finalize: {
      ...
      dashboardCopyPaste: "Copy/paste this URL in a browser on this machine to control NodoAssist.",
      dashboardLinkWithToken: "Dashboard link (with token): {url}",
      dashboardOpened: "Opened in your browser. Keep that tab to control NodoAssist.",
      ...
      gatewayTokenStored:
        "Stored in: $NODOASSIST_CONFIG_PATH (default: ~/.nodoassist/nodoassist.json) under gateway.auth.token, or in NODOASSIST_GATEWAY_TOKEN.",
      ...
      outroDashboardOpened:
        "Onboarding complete. Dashboard opened; keep that tab to control NodoAssist.",
      outroSeeded:
      ...
      containerSystemdUnavailable:
        "Systemd user services are not available inside this container. NodoAssist is skipping only the background service install; run the Gateway in the foreground or use your container supervisor.",
      securityReminder:
