...
`precise.yml` is NodoAssist's shipped precise OpenGrep rulepack. Each rule is tied
...
Some NodoAssist paths are excluded by `.gitignore` for build reasons even though
