...
Set `OPENAI_API_KEY`, or configure it in the active NodoAssist config file (`$NODOASSIST_CONFIG_PATH`, default `~/.nodoassist/nodoassist.json`). Optionally set `OPENAI_BASE_URL`:
