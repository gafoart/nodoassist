...
metadata: { "nodoassist": { "emoji": "🪲", "requires": { "bins": ["node"] } } }
---
...
- NodoAssist CLI path: `node --inspect-brk nodoassist.mjs ...`
- NodoAssist test path: `NODOASSIST_VITEST_MAX_WORKERS=1 node --inspect-brk scripts/run-vitest.mjs <file>`
