---
name: healthcheck
description: "Audit/harden NodoAssist hosts: SSH, firewall, updates, exposure, backups, disk encryption, gateway security."
---

# NodoAssist host healthcheck
...
- Never claim NodoAssist manages OS firewall, SSH, or updates.
...
- NodoAssist gateway status, bind, auth.
- Backup status.
- Disk encryption.
...
- Add scheduled `nodoassist security audit --deep`.
