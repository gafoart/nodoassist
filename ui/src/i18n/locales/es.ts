...
export const es: TranslationMap = {
  ...
  nodes: {
    pairing: {
      ...
      qrAlt: "Código QR de vinculación de NodoAssist móvil",
      ...
      review: "Revisión",
      waiting:
        "Las apps móviles oficiales de NodoAssist se conectan automáticamente después de escanear.",
  ...
  worktrees: {
    ...
    subtitle: "Checkouts de repositorios aislados propiedad de NodoAssist.",
  ...
  subtitles: {
    ...
    config: "Editar ~/.nodoassist/nodoassist.json de forma segura.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "¿En el móvil? Copia la URL completa (incluyendo #token=...) desde nodoassist dashboard --no-open en tu escritorio.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc:
        "{providers} — vuelve a autenticarte con nodoassist models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste:
          "Pega el token de nodoassist dashboard --no-open o introduce la contraseña configurada.",
        stepGenerate:
          "Si no hay token configurado, ejecuta nodoassist doctor --generate-gateway-token en el host del Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "Ejecuta nodoassist dashboard --no-open y abre la URL nueva o pega su token.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Ejecuta nodoassist devices list en el host del Gateway.",
        stepApproveId: "Aprueba esta solicitud: nodoassist devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Vuelve a abrir el dashboard servido con nodoassist dashboard para que UI y Gateway provengan de la misma instalación.",
        stepDevUi:
          "Si usas pnpm ui:dev, reconstruye o reinicia la UI de desarrollo contra el checkout actual.",
        stepRestart:
          "Reinicia el Gateway después de actualizar NodoAssist para que sirva el protocolo actual.",
      },
      network: {
        ...
        stepGateway:
          "Confirma que el Gateway esté en ejecución con nodoassist status u nodoassist gateway run.",
        stepUrl:
          "Revisa la URL de WebSocket y usa wss:// cuando el Gateway esté detrás de HTTPS/Tailscale Serve.",
        stepDashboard:
          "Vuelve a abrir el dashboard con nodoassist dashboard --no-open para copiar la URL y los detalles de autenticación actuales.",
      },
    },
  },
  connection: {
