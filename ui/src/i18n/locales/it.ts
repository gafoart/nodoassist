...
export const it: TranslationMap = {
  ...
  nodes: {
    pairing: {
      ...
      qrAlt: "Codice QR di associazione di NodoAssist mobile",
      ...
      review: "Revisione",
      waiting:
        "Le app mobile ufficiali di NodoAssist si connettono automaticamente dopo la scansione.",
  ...
  worktrees: {
    ...
    subtitle: "Checkout di repository isolati di proprietà di NodoAssist.",
  ...
  subtitles: {
    ...
    config: "Modifica nodoassist.json.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Su mobile? Copia l'URL completo (incluso #token=...) da nodoassist dashboard --no-open sul desktop.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — riautenticati con nodoassist models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste:
          "Incolla il token da nodoassist dashboard --no-open oppure inserisci la password configurata.",
        stepGenerate:
          "Se non è configurato alcun token, esegui nodoassist doctor --generate-gateway-token sull’host Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "Esegui nodoassist dashboard --no-open e apri il nuovo URL oppure incolla il suo token.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Esegui nodoassist devices list sull’host Gateway.",
        stepApproveId: "Approva questa richiesta: nodoassist devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Riapri il dashboard servito con nodoassist dashboard in modo che UI e Gateway provengano dalla stessa installazione.",
        stepDevUi:
          "Se usi pnpm ui:dev, ricompila o riavvia la UI di sviluppo contro il checkout corrente.",
        stepRestart:
          "Riavvia il Gateway dopo aver aggiornato NodoAssist affinché serva il protocollo corrente.",
      },
      network: {
        ...
        stepGateway:
          "Conferma che il Gateway sia in esecuzione con nodoassist status o nodoassist gateway run.",
        stepUrl:
          "Controlla l’URL WebSocket e usa wss:// quando il Gateway è dietro HTTPS/Tailscale Serve.",
        stepDashboard:
          "Riapri il dashboard con nodoassist dashboard --no-open per ricopiare l’URL corrente e i dettagli auth.",
      },
    },
  },
  connection: {
