...
const SENDER_METADATA_BLOCK =
  'Sender (untrusted metadata):\n```json\n{"label":"nodoassist-control-ui","id":"nodoassist-control-ui"}\n```';
...
describe("buildChatItems", () => {
          ...
          content: [
            {
              ...
              id: "call-shell",
              name: "bash",
              input: { command: "run nodoassist doctor" },
            },
          ],
          timestamp: 1000,
        },
  ...
  it("deduplicates relay-labeled assistant copies by NodoAssist transcript metadata id", () => {
    const groups = messageGroups({
      messages: [
        {
          __nodoassist: { id: "reply-3" },
          role: "assistant",
  ...
  it("deduplicates relay-labeled assistant copies by NodoAssist metadata before surface ids", () => {
    const groups = messageGroups({
      messages: [
        {
          id: "relay-surface-copy",
          __nodoassist: { id: "reply-4" },
          role: "assistant",
  ...
  it("keeps formatting-only assistant updates separate for the same source message", () => {
    const groups = messageGroups({
      messages: [
        {
          __nodoassist: { id: "reply-formatted" },
          role: "assistant",
  ...
  it("keeps differently cased sender text separate for the same source message", () => {
    const groups = messageGroups({
      messages: [
        {
          __nodoassist: { id: "reply-case-change" },
          role: "assistant",
      ...
      messages: [
        {
          ...
          senderLabel: "nodoassist-control-ui",
          timestamp: 1,
        },
      ],
    });
      ...
      toolMessages: [
        {
          ...
          content: JSON.stringify({
            ...
            view: {
              backend: "canvas",
              id: "cv_nearest_turn",
              url: "/__nodoassist__/canvas/documents/cv_nearest_turn/index.html",
      ...
      toolMessages: [
        {
          ...
          content: JSON.stringify({
            ...
            view: {
              backend: "canvas",
              id: "cv_empty_anchor",
              url: "/__nodoassist__/canvas/documents/cv_empty_anchor/index.html",
          ...
          content: JSON.stringify({
            selected_item: {
              ...
              view: {
                ...
                url: "/__nodoassist__/canvas/documents/cv_generic_inline/index.html",
            ...
            },
            {
              ...
              text: JSON.stringify({
                ...
                view: {
                  ...
                  url: "/__nodoassist__/canvas/documents/cv_streamed_artifact/index.html",
                  title: "Streamed demo",
                  preferred_height: 320,
                },
                presentation: {
...
function createAssistantCanvasBlock(params: { suffix: string }) {
  ...
  return {
    ...
    preview: {
      ...
      viewId,
      title: "Inline demo",
      url: `/__nodoassist__/canvas/documents/${viewId}/index.html`,
      preferredHeight: 360,
    },
  };
}
