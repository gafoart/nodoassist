              ...
              <div class="usage-export-popover">
                <div class="usage-export-list">
                  <button
                    ...
                    @click=${() =>
                      downloadTextFile(
                        `nodoassist-usage-sessions-${exportStamp}.csv`,
                  ...
                  <button
                    ...
                    @click=${() =>
                      downloadTextFile(
                        `nodoassist-usage-daily-${exportStamp}.csv`,
                  ...
                  <button
                    ...
                    @click=${() =>
                      downloadTextFile(
                        `nodoassist-usage-${exportStamp}.json`,
                        JSON.stringify(
                          {
                  ...
                  ${queryTerms.map((term) => {
                    ...
                    return html`
                      <span class="usage-query-chip">
                        ${label}
                        <nodoassist-tooltip .content=${t("usage.filters.remove")}>
                          <button
