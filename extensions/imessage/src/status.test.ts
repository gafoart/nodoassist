...
import * as processRuntime from "nodoassist/plugin-sdk/process-runtime";
import * as setupRuntime from "nodoassist/plugin-sdk/setup";
...
vi.mock("nodoassist/plugin-sdk/setup-tools", async (importOriginal) => ({
  ...(await importOriginal<typeof import("nodoassist/plugin-sdk/setup-tools")>()),
  ...setupToolsMocks,
}));
