...
import { resolveAccountEntry } from "nodoassist/plugin-sdk/routing";
...
// caused duplicate inbound handling in nodoassist/nodoassist#65141.
...
function resolveIMessageAccountSourceOwner(params: {
  ...
  // bindings tied to the named account keep working (nodoassist/nodoassist#65141).
 ...
 * watchers (nodoassist/nodoassist#65141) without otherwise marking the duplicate
...
export function listEnabledIMessageAccounts(cfg: NodoAssistConfig): ResolvedIMessageAccount[] {
