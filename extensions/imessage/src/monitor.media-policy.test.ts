...
describe("iMessage monitor attachment policy", () => {
  ...
  it("does not stage local attachments for messages dropped by inbound policy", async () => {
    ...
    const attachmentPath = "/Users/nodoassist/Library/Messages/Attachments/AA/BB/photo.heic";
    let onNotification:
  ...
  it("admits attachment-only messages that are marked missing", async () => {
    const attachment = {
      original_path: "/Users/nodoassist/Library/Messages/Attachments/missing.heic",
      mime_type: "image/heic",
      missing: true,
    };
    expect(
  ...
  it("uses the first materialized attachment type when earlier media is unavailable", () => {
    ...
    const availableDocument = {
      original_path: "/Users/nodoassist/Library/Messages/Attachments/report.pdf",
    ...
    expect(
      resolveIMessageInboundMediaInput({
        ...
        effectiveAttachmentRoots: ["/Users/nodoassist/Library/Messages/Attachments"],
      }),
    ).toMatchObject({
