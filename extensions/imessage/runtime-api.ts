...
import type { NodoAssistConfig as RuntimeApiNodoAssistConfig } from "nodoassist/plugin-sdk/config-contracts";
...
export type IMessageAccountConfig = Omit<
  NonNullable<NonNullable<RuntimeApiNodoAssistConfig["channels"]>["imessage"]>,
