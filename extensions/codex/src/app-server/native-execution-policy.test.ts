...
import type { getSessionEntry as getSessionEntryType } from "nodoassist/plugin-sdk/session-store-runtime";
...
vi.mock("nodoassist/plugin-sdk/session-store-runtime", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("nodoassist/plugin-sdk/session-store-runtime")>();
  return {
    ...actual,
