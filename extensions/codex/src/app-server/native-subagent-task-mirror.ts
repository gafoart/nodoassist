/**
 * Mirrors Codex native subagent thread lifecycle events into NodoAssist task
 * runtime rows so parent sessions can observe child progress.
 */
import type { AgentHarnessTaskRuntime } from "nodoassist/plugin-sdk/agent-harness-task-runtime";
...
/** Converts a Codex child thread id into the NodoAssist task-runtime run id. */
