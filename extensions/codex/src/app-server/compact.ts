/**
 * Native Codex app-server compaction bridge for bound NodoAssist sessions.
 */
import {
  embeddedAgentLog,
...
export async function maybeCompactCodexAppServerSession(
  ...
  warnIfIgnoringNodoAssistCompactionOverrides(params);
...
function warnIfIgnoringNodoAssistCompactionOverrides(
  params: CompactEmbeddedAgentSessionParams,
): void {
