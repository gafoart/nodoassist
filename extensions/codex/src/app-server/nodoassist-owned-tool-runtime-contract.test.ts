// Codex tests cover nodoassist owned tool runtime contract plugin behavior.
import type { AnyAgentTool } from "nodoassist/plugin-sdk/agent-harness";
import { wrapToolWithBeforeToolCallHook } from "nodoassist/plugin-sdk/agent-harness-runtime";
import {
...
describe("NodoAssist-owned tool runtime contract — Codex app-server adapter", () => {
  afterEach(() => {
    resetNodoAssistOwnedToolHooks();
  });
