 ...
 * into NodoAssist task runtime records for parent sessions.
 */
import { createHash } from "node:crypto";
import fs from "node:fs/promises";
import path from "node:path";
import { embeddedAgentLog, formatErrorMessage } from "nodoassist/plugin-sdk/agent-harness-runtime";
import {
...
} from "nodoassist/plugin-sdk/agent-harness-task-runtime";
import {
  asFiniteNumber,
