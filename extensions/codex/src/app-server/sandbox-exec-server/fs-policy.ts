/**
 * Resolves Codex filesystem sandbox policy payloads into NodoAssist path/glob
...
function readFsSandboxCwd(execServer: NodoAssistExecServer, sandbox: JsonObject): string {
