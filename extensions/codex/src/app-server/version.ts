 ...
 */
// The floor tracks the managed package train. Every protocol shape NodoAssist
...
/** Minimum Codex app-server version supported by the NodoAssist Codex bridge. */
...
/** Managed Codex app-server package version installed by NodoAssist. */
