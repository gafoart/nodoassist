...
import { clearRuntimeAuthProfileStoreSnapshots } from "nodoassist/plugin-sdk/agent-runtime";
...
describe("codex conversation controls", () => {
  beforeEach(async () => {
    resetCodexTestBindingStore();
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "nodoassist-codex-control-"));
