...
describe("codex conversation turn input", () => {
  ...
  it("uses staged remote-cache paths for remote iMessage image attachments", () => {
    ...
    const stagedPath = "/tmp/nodoassist-proof/.nodoassist/media/remote-cache/imessage/photo.jpg";
    ...
    expect(
      buildCodexConversationTurnInput({
        ...
        event: {
          ...
          isGroup: false,
          metadata: {
            mediaPath: "file:///tmp/NodoAssist%20QA/photo.png",
            mediaType: "image/png",
          },
        },
      }),
      ...
      { type: "text", text: "look", text_elements: [] },
      { type: "localImage", path: "/tmp/NodoAssist QA/photo.png" },
    ]);
  });
    ...
    expect(
      buildCodexConversationTurnInput({
        ...
        event: {
          ...
          isGroup: false,
          metadata: {
            mediaUrls: ["/tmp/staged-photo.png", "file:///tmp/NodoAssist%20QA/second.jpg"],
      ...
      { type: "localImage", path: "/tmp/NodoAssist QA/second.jpg" },
    ]);
  });
    ...
    expect(
      buildCodexConversationTurnInput({
        ...
        event: {
          ...
          isGroup: false,
          metadata: {
            mediaUrl: "C:\\NodoAssist QA\\photo.png",
            mediaType: "image/png",
          },
        },
      }),
      ...
      { type: "text", text: "look", text_elements: [] },
      { type: "localImage", path: "C:\\NodoAssist QA\\photo.png" },
    ]);
  });
});
