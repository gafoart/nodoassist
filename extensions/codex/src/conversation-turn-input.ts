...
import type { PluginHookInboundClaimEvent } from "nodoassist/plugin-sdk/plugin-entry";
import { normalizeSingleOrTrimmedStringList } from "nodoassist/plugin-sdk/string-coerce-runtime";
...
function extractInboundMedia(event: PluginHookInboundClaimEvent): InboundMedia[] {
  ...
  // NodoAssist channels expose either local staged files or remote URLs. Keep
