...
function makeRestrictedCfg(approvers: string[]): NodoAssistConfig {
  return {
    channels: {
      qqbot: {
        appId: "app",
...
function makeCommandAuthorizedFallbackCfg(): NodoAssistConfig {
  return {
    channels: {
      qqbot: {
        appId: "app",
...
describe("createInteractionHandler approval buttons", () => {
  ...
  ] satisfies Array<[string, NodoAssistConfig]>)(
