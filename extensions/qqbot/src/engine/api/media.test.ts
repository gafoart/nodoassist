...
vi.mock("nodoassist/plugin-sdk/response-limit-runtime", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("nodoassist/plugin-sdk/response-limit-runtime")>();
  return {
    ...actual,
