...
function registerCommands(): NodoAssistPluginCommandDefinition[] {
  ensurePlatformAdapter();
  const commands: NodoAssistPluginCommandDefinition[] = [];
  const api = {
    logger: {},
    registerCommand: (command: NodoAssistPluginCommandDefinition) => {
...
function findCommand(
  commands: NodoAssistPluginCommandDefinition[],
  name: string,
): NodoAssistPluginCommandDefinition {
