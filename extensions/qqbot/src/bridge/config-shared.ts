...
export const qqbotConfigAdapter = {
  listAccountIds: (cfg: NodoAssistConfig) => listQQBotAccountIds(cfg),
  resolveAccount: (cfg: NodoAssistConfig, accountId?: string | null) =>
    resolveQQBotAccount(cfg, accountId, { allowUnresolvedSecretRef: true }),
  defaultAccountId: (cfg: NodoAssistConfig) => resolveDefaultQQBotAccountId(cfg),
  setAccountEnabled: ({
    cfg,
    accountId,
    enabled,
  ...
  deleteAccount: ({ cfg, accountId }: { cfg: NodoAssistConfig; accountId: string }) =>
    deleteAccountFromConfigSection({
      cfg,
      sectionKey: "qqbot",
      accountId,
...
export const qqbotSetupAdapterShared = {
  resolveAccountId: ({ cfg, accountId }: { cfg: NodoAssistConfig; accountId?: string | null }) =>
