...
vi.mock("nodoassist/plugin-sdk/provider-web-search", () => ({
...
describe("tavily client X-Client-Source header", () => {
  ...
  it("runTavilySearch sends X-Client-Source: nodoassist", async () => {
    ...
    expect(params.extraHeaders).toEqual({ "X-Client-Source": "nodoassist" });
  });
  ...
  it("runTavilyExtract sends X-Client-Source: nodoassist", async () => {
