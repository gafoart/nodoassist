...
import { resolveStateDir } from "nodoassist/plugin-sdk/memory-core-host-runtime-core";
import { getRuntimeConfig } from "nodoassist/plugin-sdk/runtime-config-snapshot";
import { cleanupSessionLifecycleArtifacts } from "nodoassist/plugin-sdk/session-store-runtime";
...
const DIARY_START_MARKER = "<!-- nodoassist:dreaming:diary:start -->";
const DIARY_END_MARKER = "<!-- nodoassist:dreaming:diary:end -->";
const BACKFILL_ENTRY_MARKER = "nodoassist:dreaming:backfill-entry";
