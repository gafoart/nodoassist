...
import { createAsyncLock } from "nodoassist/plugin-sdk/async-lock-runtime";
import { extractErrorCode } from "nodoassist/plugin-sdk/error-runtime";
import { resolveGlobalMap } from "nodoassist/plugin-sdk/global-singleton";
import { replaceManagedMarkdownBlock } from "nodoassist/plugin-sdk/memory-host-markdown";
import { readRegularFile, replaceFileAtomic } from "nodoassist/plugin-sdk/security-runtime";

const DREAMS_FILENAMES = ["DREAMS.md", "dreams.md"] as const;
const DEEP_START_MARKER = "<!-- nodoassist:dreaming:deep:start -->";
const DEEP_END_MARKER = "<!-- nodoassist:dreaming:deep:end -->";
