...
const installedSymbol = Symbol.for("nodoassist.lobster.ajv-compile-cache.installed");
const cacheSymbol = Symbol.for("nodoassist.lobster.ajv-compile-cache.entries");
