...
} from "nodoassist/plugin-sdk/provider-transport-runtime";
import {
...
type GoogleTransportApi = CanonicalGoogleTransportApi | "nodoassist-google-generative-ai-transport";
...
const GOOGLE_GEMINI3_FIRST_RESPONSE_RETRY_ENV = "NODOASSIST_GOOGLE_GEMINI_FIRST_RESPONSE_RETRY_MS";
...
function normalizeGoogleTransportRouteApi(
  ...
  switch (api) {
    ...
    case "nodoassist-google-generative-ai-transport":
