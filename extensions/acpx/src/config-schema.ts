...
/** Zod schema for validating raw ACPX plugin config from NodoAssist config. */
export const AcpxPluginConfigSchema = z.strictObject({
  ...
  nodoAssistToolsMcpBridge: z
    .boolean({ error: "nodoAssistToolsMcpBridge must be a boolean" })
    .optional(),
