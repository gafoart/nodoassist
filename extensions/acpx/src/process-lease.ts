/**
 * Persistent lease store for ACPX wrapper processes. Leases let NodoAssist attach
...
export const NODOASSIST_ACPX_LEASE_ID_ENV = "NODOASSIST_ACPX_LEASE_ID";
/** Environment variable carrying the owning gateway instance id. */
export const NODOASSIST_GATEWAY_INSTANCE_ID_ENV = "NODOASSIST_GATEWAY_INSTANCE_ID";
/** CLI argument carrying the ACPX process lease id for platforms without env wrapping. */
export const NODOASSIST_ACPX_LEASE_ID_ARG = "--nodoassist-acpx-lease-id";
/** CLI argument carrying the owning gateway instance id. */
export const NODOASSIST_GATEWAY_INSTANCE_ID_ARG = "--nodoassist-gateway-instance-id";
...
export function withAcpxLeaseEnvironment(params: {
  ...
  return [
    "env",
    `${NODOASSIST_ACPX_LEASE_ID_ENV}=${quoteEnvValue(params.leaseId)}`,
    `${NODOASSIST_GATEWAY_INSTANCE_ID_ENV}=${quoteEnvValue(params.gatewayInstanceId)}`,
