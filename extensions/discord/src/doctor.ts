...
import { collectProviderDangerousNameMatchingScopes } from "nodoassist/plugin-sdk/runtime-doctor";
...
export function scanDiscordNumericIdEntries(cfg: NodoAssistConfig): DiscordNumericIdHit[] {
...
export function maybeRepairDiscordNumericIds(
  cfg: NodoAssistConfig,
  doctorFixCommand: string,
): { config: NodoAssistConfig; changes: string[]; warnings?: string[] } {
...
function collectDiscordMutableAllowlistWarnings(cfg: NodoAssistConfig): string[] {
