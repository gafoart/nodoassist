...
import { buildMessagingTarget, type MessagingTarget } from "nodoassist/plugin-sdk/channel-targets";
import type { DirectoryConfigParams } from "nodoassist/plugin-sdk/directory-runtime";
