...
import { buildOutboundMediaLoadOptions } from "nodoassist/plugin-sdk/media-runtime";
import { extensionForMime } from "nodoassist/plugin-sdk/media-runtime";
import {
...
import type { ChunkMode } from "nodoassist/plugin-sdk/reply-chunking";
...
async function resolveDiscordTargetChannelId(
  raw: string,
  opts: DiscordClientOpts & { cfg: NodoAssistConfig },
): Promise<{ channelId: string; dm?: boolean }> {
