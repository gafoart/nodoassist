...
import type { DiscordActionConfig } from "nodoassist/plugin-sdk/config-contracts";
...
function discordAllowlistCfg(guilds: Record<string, unknown>): NodoAssistConfig {
  return {
    channels: {
      discord: {
        token: "token",
...
function handleMessagingAction(
  ...
  cfg: NodoAssistConfig = DISCORD_TEST_CFG,
  options?: {
    mediaAccess?: {
