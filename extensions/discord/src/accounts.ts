...
import type { DiscordAccountConfig, DiscordActionConfig, NodoAssistConfig } from "./runtime-api.js";
...
export function listEnabledDiscordAccounts(cfg: NodoAssistConfig): ResolvedDiscordAccount[] {
