...
function createCfg(): NodoAssistConfig {
  return {
    channels: {
      discord: {
        enabled: true,
...
function resolveAccount(cfg: NodoAssistConfig, accountId = "default"): ResolvedDiscordAccount {
  return discordPlugin.config.resolveAccount(cfg, accountId);
}

function startDiscordAccount(cfg: NodoAssistConfig, accountId = "default") {
