...
import type { ChannelOutboundPayloadHint } from "nodoassist/plugin-sdk/channel-contract";
import type { NodoAssistConfig } from "nodoassist/plugin-sdk/config-contracts";
import type { DiscordExecApprovalConfig } from "nodoassist/plugin-sdk/config-contracts";
...
function resolveDiscordOwnerApprovers(cfg: NodoAssistConfig): string[] {
