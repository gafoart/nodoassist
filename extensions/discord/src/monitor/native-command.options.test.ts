...
let listNativeCommandSpecs: typeof import("nodoassist/plugin-sdk/command-auth-native").listNativeCommandSpecs;
...
function createNativeCommand(
  ...
  opts?: {
    ...
    discordConfig?: NonNullable<NodoAssistConfig["channels"]>["discord"];
  },
  ...
  const baseCfg: NodoAssistConfig = opts?.cfg ?? {};
  const discordConfig: NonNullable<NodoAssistConfig["channels"]>["discord"] =
...
function createAllowedGuildAutocompleteConfig(
  commands: NonNullable<NodoAssistConfig["commands"]>,
): NodoAssistConfig {
  return {
    commands,
    channels: {
...
describe("createDiscordNativeCommand option wiring", () => {
  beforeAll(async () => {
    ({ listNativeCommandSpecs } = await import("nodoassist/plugin-sdk/command-auth-native"));
  ...
  it("returns no autocomplete choices for group DMs outside dm.groupChannels", async () => {
    ...
    } satisfies NonNullable<NodoAssistConfig["channels"]>["discord"];
    const command = createNativeCommand("think", {
      cfg: {
        commands: {
          allowFrom: {
  ...
  it("truncates Discord command and option descriptions on a UTF-16 boundary", () => {
    ...
    const discordConfig = {} as NonNullable<NodoAssistConfig["channels"]>["discord"];
    const command = createDiscordNativeCommand({
      command: {
        name: "longdesc",
