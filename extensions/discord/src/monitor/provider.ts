...
import { createConnectedChannelStatusPatch } from "nodoassist/plugin-sdk/gateway-runtime";
import {
...
import { isVerbose, logVerbose, shouldLogVerbose, warn } from "nodoassist/plugin-sdk/runtime-env";
...
export async function monitorDiscordProvider(opts: MonitorDiscordOpts = {}) {
  ...
  try {
    ...
    const guildHistories = new Map<
      string,
      import("nodoassist/plugin-sdk/reply-history").HistoryEntry[]
    >();
