...
import { danger, warn, type RuntimeEnv } from "nodoassist/plugin-sdk/runtime-env";
import {
...
export type GetPluginCommandSpecs =
  typeof import("nodoassist/plugin-sdk/plugin-runtime").getPluginCommandSpecs;

let pluginRuntimePromise:
  | Promise<typeof import("nodoassist/plugin-sdk/plugin-runtime")>
  | undefined;

async function loadPluginRuntime() {
  const promise = pluginRuntimePromise ?? import("nodoassist/plugin-sdk/plugin-runtime");
