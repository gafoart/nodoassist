...
import * as pluginCommandsModule from "nodoassist/plugin-sdk/plugin-runtime";
import * as dispatcherModule from "nodoassist/plugin-sdk/reply-dispatch-runtime";
...
function createCommand(cfg: NodoAssistConfig, discordConfig?: DiscordAccountConfig) {
...
async function runGuildSlashCommand(params?: {
  userId?: string;
  mutateConfig?: (cfg: NodoAssistConfig) => void;
