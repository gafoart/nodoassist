...
vi.mock("nodoassist/plugin-sdk/approval-gateway-runtime", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("nodoassist/plugin-sdk/approval-gateway-runtime")>();
  return {
    ...actual,
