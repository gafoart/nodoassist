  ...
  it("renames created thread when generated mode is enabled", async () => {
    ...
    const result = await maybeCreateDiscordAutoThread(
      createBaseParams({
        ...
        channelName: "nodoassist",
        channelDescription: "NodoAssist development coordination and release planning",
    ...
    expectGeneratedTitleField("channelName", "nodoassist");
    expectGeneratedTitleField(
      "channelDescription",
      "NodoAssist development coordination and release planning",
    );
