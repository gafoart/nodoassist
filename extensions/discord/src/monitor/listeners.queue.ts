...
import { createSubsystemLogger, formatDurationSeconds } from "nodoassist/plugin-sdk/runtime-env";

export type DiscordListenerLogger = ReturnType<
  typeof import("nodoassist/plugin-sdk/runtime-env").createSubsystemLogger
>;
