...
// Deprecated compatibility surface for existing @nodoassist/discord/api.js consumers.
...
export { resolveOpenProviderRuntimeGroupPolicy as resolveDiscordRuntimeGroupPolicy } from "nodoassist/plugin-sdk/runtime-group-policy";
