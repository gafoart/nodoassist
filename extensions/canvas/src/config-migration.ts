...
import { asOptionalRecord as readRecord } from "nodoassist/plugin-sdk/string-coerce-runtime";
...
export function migrateLegacyCanvasHostConfig(config: NodoAssistConfig): {
  ...
  const next = { ...config, plugins } as NodoAssistConfig & { canvasHost?: unknown };
