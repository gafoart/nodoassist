...
import { resolvePreferredNodoAssistTmpDir } from "nodoassist/plugin-sdk/security-runtime";
import { asRecord, readStringValue } from "nodoassist/plugin-sdk/string-coerce-runtime";
...
function resolveTempPathParts(opts: { ext: string; tmpDir?: string; id?: string }) {
  const tmpDir = opts.tmpDir ?? resolvePreferredNodoAssistTmpDir();
  if (!opts.tmpDir) {
