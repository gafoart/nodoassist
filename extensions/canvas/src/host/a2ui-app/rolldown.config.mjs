...
const outputFile = process.env.NODOASSIST_A2UI_BUNDLE_OUT
  ? path.resolve(process.env.NODOASSIST_A2UI_BUNDLE_OUT)
...
export default {
  ...
  resolve: {
    alias: {
      ...
      "@nodoassist/a2ui-theme-context": a2uiThemeContext,
