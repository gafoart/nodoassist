...
import { runCommandWithRuntime, theme } from "nodoassist/plugin-sdk/cli-runtime";
...
import { defaultRuntime } from "nodoassist/plugin-sdk/runtime";
import {
  normalizeLowercaseStringOrEmpty,
  normalizeOptionalString,
} from "nodoassist/plugin-sdk/string-coerce-runtime";
import { shortenHomePath } from "nodoassist/plugin-sdk/text-utility-runtime";
...
/** Creates the default Canvas CLI dependency bundle backed by the NodoAssist gateway CLI. */
    ...
    a2ui
      ...
      .action(async (opts: CanvasNodesRpcOpts) => {
        await deps.runNodesCommand("canvas a2ui push", async () => {
          ...
          if (version === "v0.9") {
            throw new Error(
              "Detected A2UI v0.9 JSONL (createSurface). NodoAssist currently supports v0.8 only.",
            );
          }
