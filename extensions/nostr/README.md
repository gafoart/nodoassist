...
Nostr DM channel plugin for NodoAssist using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to NodoAssist. It enables your bot to:
...
# Configure nodoassist to use local relay
