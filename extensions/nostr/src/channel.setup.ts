...
function getNostrConfig(cfg: NodoAssistConfig): NostrAccountConfig | undefined {
  return (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
}

function listSetupNostrAccountIds(cfg: NodoAssistConfig): string[] {
...
function resolveDefaultSetupNostrAccountId(cfg: NodoAssistConfig): string {
