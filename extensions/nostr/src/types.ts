...
import { normalizeSecretInputString, type SecretInput } from "nodoassist/plugin-sdk/secret-input";
...
function resolveConfiguredDefaultNostrAccountId(cfg: NodoAssistConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: NodoAssistConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: NodoAssistConfig): string {
