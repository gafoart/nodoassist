// Nostr plugin entrypoint registers its NodoAssist integration.
import {
  defineBundledChannelEntry,
  loadBundledEntryExportSync,
} from "nodoassist/plugin-sdk/channel-entry-contract";
import type { NodoAssistConfig, PluginRuntime, ResolvedNostrAccount } from "./api.js";
  ...
  registerFull(api) {
    const httpHandler = createNostrProfileHttpHandler()({
      getConfigProfile: (accountId: string) => {
        ...
        const cfg = runtime.config.current() as NodoAssistConfig;
