// Diagnostics Prometheus plugin entrypoint registers its NodoAssist integration.
...
export default definePluginEntry({
  ...
  description: "Expose NodoAssist diagnostics metrics in Prometheus text format",
  register(api) {
