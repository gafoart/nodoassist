 ...
 */
import { resolveAwsSdkEnvVarName } from "nodoassist/plugin-sdk/provider-auth-runtime";
import type { ModelProviderConfig } from "nodoassist/plugin-sdk/provider-model-shared";

/** Resolve the config auth marker that tells NodoAssist to use AWS SDK credentials. */
