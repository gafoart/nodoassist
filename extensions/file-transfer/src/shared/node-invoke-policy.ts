...
type PreflightResult =
  ...
  | {
      ok: false;
      result: NodoAssistPluginNodeInvokePolicyResult;
    };
...
async function handleFileTransferInvoke(
  ctx: NodoAssistPluginNodeInvokePolicyContext,
): Promise<NodoAssistPluginNodeInvokePolicyResult> {
...
export function createFileTransferNodeInvokePolicy(): NodoAssistPluginNodeInvokePolicy {
  return {
