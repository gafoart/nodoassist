...
// without touching ~/.nodoassist/nodoassist.json.
...
vi.mock("nodoassist/plugin-sdk/config-mutation", () => ({
...
afterAll(() => {
  vi.doUnmock("nodoassist/plugin-sdk/runtime-config-snapshot");
  vi.doUnmock("nodoassist/plugin-sdk/config-mutation");
  vi.resetModules();
});
