// File Transfer plugin entrypoint registers its NodoAssist integration.
import {
  definePluginEntry,
  type AnyAgentTool,
  type NodoAssistPluginNodeHostCommand,
...
const fileTransferNodeHostCommands: NodoAssistPluginNodeHostCommand[] = [
  {
    command: "file.fetch",
    cap: "file",
    dangerous: true,
