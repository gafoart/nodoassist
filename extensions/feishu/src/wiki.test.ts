...
import type { NodoAssistPluginApi, PluginRuntime } from "../runtime-api.js";
...
function createWikiToolApi(registerTool: NodoAssistPluginApi["registerTool"]): NodoAssistPluginApi {
