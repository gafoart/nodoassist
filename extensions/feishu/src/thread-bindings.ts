...
import { normalizeAccountId, resolveAgentIdFromSessionKey } from "nodoassist/plugin-sdk/routing";
...
const FEISHU_THREAD_BINDINGS_STATE_KEY = Symbol.for("nodoassist.feishuThreadBindingsState");
