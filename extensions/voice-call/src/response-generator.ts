/**
 * Voice call response generator - uses the embedded NodoAssist agent for tool support.
...
/**
 * Generate a voice response using the embedded NodoAssist agent with full tool support.
