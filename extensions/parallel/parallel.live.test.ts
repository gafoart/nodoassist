  ...
  it(
    ...
    async () => {
      ...
      const result = (await tool.execute({
        objective:
          "Find the NodoAssist GitHub repository and recent project activity for a quick smoke test.",
        search_queries: ["nodoassist github repository", "nodoassist release notes"],
        count: 3,
