// Webhooks plugin entrypoint registers its NodoAssist integration.
...
function registerWebhookRoutes(api: NodoAssistPluginApi): void {
...
export default definePluginEntry({
  ...
  name: "Webhooks",
  description:
    "Authenticated inbound webhooks that bind external automation to NodoAssist TaskFlows.",
