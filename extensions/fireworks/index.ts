// Fireworks plugin entrypoint registers its NodoAssist integration.
import type { ProviderResolveDynamicModelContext } from "nodoassist/plugin-sdk/plugin-entry";
