...
import type { NodoAssistPluginApi, ProviderRuntimeModel } from "nodoassist/plugin-sdk/plugin-entry";
import { resolveClaudeSonnet5ModelIdentity } from "nodoassist/plugin-sdk/provider-model-shared";
import {
...
/** Register the Amazon Bedrock Mantle provider with NodoAssist. */
export function registerBedrockMantlePlugin(api: NodoAssistPluginApi): void {
