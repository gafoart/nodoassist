...
import { extractNonEmptyAssistantText, isLiveTestEnabled } from "nodoassist/plugin-sdk/test-env";
...
const LIVE_MODEL_ID =
  process.env.NODOASSIST_LIVE_OPENCODE_DEEPSEEK_MODEL?.trim() || "deepseek-v4-flash-free";
