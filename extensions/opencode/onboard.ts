...
export function applyOpencodeZenProviderConfig(cfg: NodoAssistConfig): NodoAssistConfig {
  return {
    ...cfg,
    agents: {
      ...cfg.agents,
...
export function applyOpencodeZenConfig(cfg: NodoAssistConfig): NodoAssistConfig {
