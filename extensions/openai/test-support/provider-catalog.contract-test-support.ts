...
import type { ProviderPlugin } from "nodoassist/plugin-sdk/provider-test-contracts";
...
vi.mock("nodoassist/plugin-sdk/provider-catalog-runtime", async () => {
  const actual = await vi.importActual<
    typeof import("nodoassist/plugin-sdk/provider-catalog-runtime")
  >("nodoassist/plugin-sdk/provider-catalog-runtime");
