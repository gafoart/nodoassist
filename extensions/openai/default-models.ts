...
import { ensureModelAllowlistEntry } from "nodoassist/plugin-sdk/provider-onboard";
import {
...
export function applyOpenAIProviderConfig(cfg: NodoAssistConfig): NodoAssistConfig {
...
export function applyOpenAIConfig(cfg: NodoAssistConfig): NodoAssistConfig {
