...
describe("qa tool coverage report", () => {
  ...
  it("keeps searchable NodoAssist dynamic tool rows report-only by default", () => {
    const report = buildQaToolCoverageReport({
      scenarios: [
        makeScenario("tool-searchable-web-search", "web-search", {
          toolName: "web_search",
          toolCoverage: {
            bucket: "nodoassist-dynamic-integration",
            expectedLayer: "nodoassist-dynamic",
            capabilityLayer: "nodoassist-dynamic-searchable",
          },
        }),
      ],
      summary: {
  ...
  it("passes required NodoAssist dynamic tool coverage when both runtimes exercise the tool", () => {
    const report = buildQaToolCoverageReport({
      scenarios: [
        makeScenario("tool-web-search", "web-search", {
          ...
          toolCoverage: {
            bucket: "nodoassist-dynamic-integration",
            expectedLayer: "nodoassist-dynamic",
            capabilityLayer: "nodoassist-dynamic-direct",
            required: true,
          },
        }),
      ],
  ...
  it("passes required NodoAssist dynamic tool coverage when Codex reports a soft tool error", () => {
    const report = buildQaToolCoverageReport({
      scenarios: [
        makeScenario("tool-web-search", "web-search", {
          toolName: "web_search",
  ...
  it("fails required NodoAssist dynamic tool coverage when a runtime skips the tool", () => {
    const report = buildQaToolCoverageReport({
      scenarios: [
        makeScenario("tool-web-search", "web-search", {
          toolName: "web_search",
  ...
  it("fails required NodoAssist dynamic tool coverage when the fixture failure mode is preserved", () => {
    const report = buildQaToolCoverageReport({
      scenarios: [
        makeScenario("tool-web-search", "web-search", {
          toolName: "web_search",
