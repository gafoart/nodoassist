...
vi.mock("nodoassist/plugin-sdk/qa-runner-runtime", () => ({ listQaRunnerCliContributions }));
...
describe("live transport QA contributions", () => {
  ...
  it.each([
    ...
    await qa.parseAsync(["node", "nodoassist", commandName, "--scenario", `${commandName}-canary`]);
