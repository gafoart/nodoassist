...
\`\`\``;
  ...
  const prompt = `You are grading NodoAssist natural character conversation transcripts for naturalness, vibes, and funniness.
...
function renderCharacterEvalReport(params: {
  ...
  const lines = [
    "# NodoAssist Character Eval Report",
    "",
