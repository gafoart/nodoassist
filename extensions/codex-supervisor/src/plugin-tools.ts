/**
 * NodoAssist agent-tool definitions for Codex Supervisor endpoint and session
 * controls.
 */
import { jsonResult, readStringParam, type AnyAgentTool } from "nodoassist/plugin-sdk/core";
...
/** Dependencies needed to build NodoAssist agent tools. */
...
/**
 * Creates the NodoAssist tools that expose Codex endpoint health and session
 * controls.
 */
export function createCodexSupervisorTools({
  ...
  return [
    ...
    },
    {
      ...
      description: "List Codex sessions visible to the NodoAssist supervisor.",
