// Xiaomi plugin entrypoint registers its NodoAssist integration.
...
import {
  ...
  validateApiKeyInput,
} from "nodoassist/plugin-sdk/provider-auth-api-key";
import {
  applyModelCompatPatch,
  buildProviderReplayFamilyHooks,
} from "nodoassist/plugin-sdk/provider-model-shared";
import { PROVIDER_LABELS } from "nodoassist/plugin-sdk/provider-usage";
import {
  applyXiaomiConfig,
