...
import { resolveDangerousNameMatchingEnabled } from "nodoassist/plugin-sdk/dangerous-name-runtime";
...
/** Extract the channel config from the full NodoAssist config object. */
function getChannelConfig(cfg: NodoAssistConfig): SynologyChatChannelConfig | undefined {
 ...
 */
export function listAccountIds(cfg: NodoAssistConfig): string[] {
...
export function resolveAccount(
  ...
  const envBotName = process.env.NODOASSIST_BOT_NAME ?? "NodoAssist";
