...
export const legacyConfigRules: LegacyConfigRule[] = [
  {
    ...
    message:
      'models.providers.ollama-cloud.baseUrl="https://ai.ollama.com" is retired; use "https://ollama.com". Run "nodoassist doctor --fix".',
    match: (value) => findRetiredOllamaCloudBaseUrl(value) !== null,
  },
];

function migrateOllamaCloudRetiredBaseUrl(config: NodoAssistConfig): {
  ...
  nextConfig.models = nextModels as NodoAssistConfig["models"];
