...
import { clearLiveCatalogCacheForTests } from "nodoassist/plugin-sdk/provider-catalog-shared";
import type { ModelDefinitionConfig } from "nodoassist/plugin-sdk/provider-onboard";
...
describe("Ollama provider", () => {
  const createAgentDir = () => mkdtempSync(join(tmpdir(), "nodoassist-test-"));
