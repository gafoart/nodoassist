...
function applyVercelAiGatewayProviderConfig(cfg: NodoAssistConfig): NodoAssistConfig {
...
export function applyVercelAiGatewayConfig(cfg: NodoAssistConfig): NodoAssistConfig {
