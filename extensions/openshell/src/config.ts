...
import { MAX_TIMER_TIMEOUT_SECONDS } from "nodoassist/plugin-sdk/number-runtime";
import { z } from "zod";
...
const DEFAULT_SOURCE = "nodoassist";
...
export function createOpenShellPluginConfigSchema(): NodoAssistPluginConfigSchema {
