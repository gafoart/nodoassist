...
import { root as fsRoot } from "nodoassist/plugin-sdk/file-access-runtime";
import type {
  SandboxFsBridge,
  SandboxFsStat,
  SandboxResolvedPath,
} from "nodoassist/plugin-sdk/sandbox";
import { createWritableRenameTargetResolver } from "nodoassist/plugin-sdk/sandbox";
import { FsSafeError, isPathInside } from "nodoassist/plugin-sdk/security-runtime";
...
const MATERIALIZED_SKILLS_CONTAINER_PARTS = [".nodoassist", "sandbox-skills", "skills"] as const;
