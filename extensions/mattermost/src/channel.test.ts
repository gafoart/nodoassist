...
vi.mock("nodoassist/plugin-sdk/ssrf-runtime", async () => {
  const original = (await vi.importActual("nodoassist/plugin-sdk/ssrf-runtime")) as Record<
    string,
    unknown
  >;
...
function getDescribedActions(cfg: NodoAssistConfig, accountId?: string): string[] {
