 ...
 */
const ACCOUNT_STATES_KEY = Symbol.for("nodoassist.mattermost.slash-account-states");
...
export function activateSlashCommands(params: {
  ...
  triggerMap?: Map<string, string>;
  api: {
    cfg: import("./runtime-api.js").NodoAssistConfig;
 ...
 */
export function registerSlashCommandRoute(api: NodoAssistPluginApi) {
