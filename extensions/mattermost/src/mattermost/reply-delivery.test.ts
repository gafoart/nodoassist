...
import type { ChunkMode } from "nodoassist/plugin-sdk/reply-runtime";
...
describe("deliverMattermostReplyPayload", () => {
  it("suppresses payloads flagged as reasoning", async () => {
    ...
    const cfg = {} satisfies NodoAssistConfig;
  ...
  it("passes agent-scoped mediaLocalRoots when sending media paths", async () => {
    ...
    const stateDir = await fs.mkdtemp(path.join(os.tmpdir(), "nodoassist-mm-state-"));
