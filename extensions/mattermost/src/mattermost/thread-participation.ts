...
import { createPersistentDedupeCache } from "nodoassist/plugin-sdk/dedupe-runtime";
 ...
 */
const MATTERMOST_THREAD_PARTICIPATION_KEY = Symbol.for("nodoassist.mattermostThreadParticipation");
