...
import { resolveMergedAccountConfig } from "nodoassist/plugin-sdk/account-resolution";
import {
...
export function listMattermostAccountIds(cfg: NodoAssistConfig): string[] {
  return mattermostAccountHelpers.listAccountIds(cfg);
}

export function resolveDefaultMattermostAccountId(cfg: NodoAssistConfig): string {
