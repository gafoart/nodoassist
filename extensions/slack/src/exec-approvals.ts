...
import { doesApprovalRequestMatchChannelAccount } from "nodoassist/plugin-sdk/approval-native-runtime";
import type { NodoAssistConfig } from "nodoassist/plugin-sdk/config-contracts";
import { normalizeStringifiedOptionalString } from "nodoassist/plugin-sdk/string-coerce-runtime";
...
function resolveSlackOwnerApprovers(cfg: NodoAssistConfig): string[] {
