...
import { buildApprovalPresentationFromActionDescriptors } from "nodoassist/plugin-sdk/approval-reply-runtime";
import type { NodoAssistConfig } from "nodoassist/plugin-sdk/config-contracts";
import { logError } from "nodoassist/plugin-sdk/logging-core";
...
type SlackExecApprovalConfig = NonNullable<
  NonNullable<NonNullable<NodoAssistConfig["channels"]>["slack"]>["execApprovals"]
>;
