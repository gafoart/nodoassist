...
function buildConfig(
  overrides?: Partial<NonNullable<NonNullable<NodoAssistConfig["channels"]>["slack"]>>,
): NodoAssistConfig {
  return {
    channels: {
      slack: {
...
const STORE_PATH = path.join(os.tmpdir(), "nodoassist-slack-approval-native-test.json");
