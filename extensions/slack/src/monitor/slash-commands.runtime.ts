...
type BuildCommandTextFromArgs =
  typeof import("nodoassist/plugin-sdk/command-auth-native").buildCommandTextFromArgs;
type FindCommandByNativeName =
  typeof import("nodoassist/plugin-sdk/command-auth-native").findCommandByNativeName;
type ListNativeCommandSpecsForConfig =
  typeof import("nodoassist/plugin-sdk/command-auth-native").listNativeCommandSpecsForConfig;
type ParseCommandArgs = typeof import("nodoassist/plugin-sdk/command-auth-native").parseCommandArgs;
