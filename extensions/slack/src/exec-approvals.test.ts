...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<NodoAssistConfig["channels"]>["slack"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<NodoAssistConfig["channels"]>["slack"]>>,
): NodoAssistConfig {
  return {
    channels: {
      slack: {
