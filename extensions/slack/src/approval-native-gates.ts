...
} from "nodoassist/plugin-sdk/channel-route";
...
type ApprovalForwardingConfig = NonNullable<NonNullable<NodoAssistConfig["approvals"]>["plugin"]>;
...
function resolvePluginApprovalForwardingConfig(cfg: NodoAssistConfig) {
