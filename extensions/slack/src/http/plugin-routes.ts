...
import type { NodoAssistPluginApi } from "nodoassist/plugin-sdk/channel-plugin-common";
...
function resolveSlackWebhookPaths(config: NodoAssistPluginApi["config"]): string[] {
...
export function registerSlackPluginHttpRoutes(api: NodoAssistPluginApi): void {
