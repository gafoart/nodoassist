...
import { clamp } from "nodoassist/plugin-sdk/text-utility-runtime";
...
export function resolveHeartbeatSeconds(cfg: NodoAssistConfig, overrideSeconds?: number): number {
