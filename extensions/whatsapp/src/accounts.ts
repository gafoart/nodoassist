...
import type { DmPolicy, GroupPolicy, ReplyToMode } from "nodoassist/plugin-sdk/config-contracts";
...
export function listWhatsAppAuthDirs(cfg: NodoAssistConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: NodoAssistConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: NodoAssistConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: NodoAssistConfig): ResolvedWhatsAppAccount[] {
