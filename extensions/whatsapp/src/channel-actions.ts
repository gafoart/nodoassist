...
function areWhatsAppAgentReactionsEnabled(params: { cfg: NodoAssistConfig; accountId?: string }) {
...
function hasAnyWhatsAppAccountWithAgentReactionsEnabled(cfg: NodoAssistConfig) {
