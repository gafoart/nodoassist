...
import type { ConfiguredBindingRouteResult } from "nodoassist/plugin-sdk/conversation-binding-runtime";
...
vi.mock("nodoassist/plugin-sdk/conversation-binding-runtime", () => ({
...
vi.mock("nodoassist/plugin-sdk/routing", async (importOriginal) => {
  const actual = await importOriginal<typeof import("nodoassist/plugin-sdk/routing")>();
  return {
    ...actual,
