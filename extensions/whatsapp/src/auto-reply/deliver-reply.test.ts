...
import { sleep } from "nodoassist/plugin-sdk/text-utility-runtime";
...
vi.mock("nodoassist/plugin-sdk/text-utility-runtime", async () => {
  const actual = await vi.importActual<typeof import("nodoassist/plugin-sdk/text-utility-runtime")>(
    "nodoassist/plugin-sdk/text-utility-runtime",
  );
  return {
    ...actual,
    sleep: vi.fn(async () => {}),
