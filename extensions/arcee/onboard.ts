...
export function applyArceeConfig(cfg: NodoAssistConfig): NodoAssistConfig {
  return arceePresetAppliers.applyConfig(cfg);
}

/** Apply OpenRouter-backed Arcee provider defaults to config. */
export function applyArceeOpenRouterConfig(cfg: NodoAssistConfig): NodoAssistConfig {
