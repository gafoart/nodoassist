...
import { createConditionalWarningCollector } from "nodoassist/plugin-sdk/channel-policy";
...
const resolveSmsDmPolicy = createScopedDmSecurityResolver<ResolvedSmsAccount>({
  ...
  approveHint: "nodoassist pairing approve sms <code>",
...
export const smsPlugin: ChannelPlugin<ResolvedSmsAccount, SmsProbe> = createChatChannelPlugin({
  ...
  pairing: {
    text: {
      idLabel: "phoneNumber",
      message: "NodoAssist: your SMS access has been approved.",
