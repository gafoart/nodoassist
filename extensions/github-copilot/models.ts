...
import { readProviderJsonArrayFieldResponse } from "nodoassist/plugin-sdk/provider-http";
...
export function resolveCopilotForwardCompatModel(
  ...
  // by simply adding them to agents.defaults.models in nodoassist.json — no
