...
import { stylePromptTitle } from "nodoassist/plugin-sdk/cli-runtime";
import type { NodoAssistConfig } from "nodoassist/plugin-sdk/config-contracts";
import { logConfigUpdated, updateConfig } from "nodoassist/plugin-sdk/config-mutation";
import {
...
export function withGithubCopilotDomainConfig(
  ...
  const models: NonNullable<NodoAssistConfig["models"]> = cfg.models ?? {};
