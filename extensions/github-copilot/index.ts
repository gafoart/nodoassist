// Github Copilot plugin entrypoint registers its NodoAssist integration.
...
function applyCopilotDefaultModel(cfg: NodoAssistConfig): NodoAssistConfig {
...
function buildGithubCopilotDomainConfigPatch(domain: string): Partial<NodoAssistConfig> {
  ...
  } as unknown as Partial<NodoAssistConfig>;
}
...
function clearGithubCopilotDomainConfigPatch(): Partial<NodoAssistConfig> {
  return {
    models: {
      providers: {
...
export default definePluginEntry({
  ...
  register(api) {
    ...
    function resolveCurrentPluginConfig(config?: NodoAssistConfig): GithubCopilotPluginConfig {
