...
import { normalizeGithubCopilotDomain } from "nodoassist/plugin-sdk/provider-auth";
...
function readConfiguredGithubCopilotDomain(config?: NodoAssistConfig): string | undefined {
