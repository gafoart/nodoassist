...
import { expectExplicitMusicGenerationCapabilities } from "nodoassist/plugin-sdk/provider-test-contracts";
...
vi.mock("nodoassist/plugin-sdk/provider-http", async (importOriginal) => {
  const original = await importOriginal<typeof import("nodoassist/plugin-sdk/provider-http")>();
  return {
    ...original,
