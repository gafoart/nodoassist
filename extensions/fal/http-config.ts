...
import type { AuthProfileStore, NodoAssistConfig } from "nodoassist/plugin-sdk/provider-auth";
...
function resolveFalConfiguredBaseUrl(cfg?: NodoAssistConfig): string | undefined {
