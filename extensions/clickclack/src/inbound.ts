/**
 * Converts authorized ClickClack messages into NodoAssist agent/model replies and
...
export async function handleClickClackInbound(params: {
  ...
  const body = runtime.channel.reply.formatAgentEnvelope({
    ...
    previousTimestamp,
    envelope: runtime.channel.reply.resolveEnvelopeFormatOptions(params.config as NodoAssistConfig),
    body: message.body,
  });
