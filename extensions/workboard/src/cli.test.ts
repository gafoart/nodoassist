...
vi.mock("nodoassist/plugin-sdk/gateway-runtime", async () => {
  const actual = await vi.importActual<typeof import("nodoassist/plugin-sdk/gateway-runtime")>(
    "nodoassist/plugin-sdk/gateway-runtime",
  );
  return {
    ...actual,
...
vi.mock("nodoassist/plugin-sdk/runtime-config-snapshot", () => ({
