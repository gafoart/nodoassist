...
function ensureZalouserPluginEnabled(cfg: NodoAssistConfig): NodoAssistConfig {
      ...
      await prompter.note(
        [
          ...
          t("wizard.zalouser.peersLookupTip", {
            command: formatCliCommand("nodoassist directory peers list --channel zalouser"),
          }),
        ].join("\n"),
        ...
        await prompter.note(
          [
            ...
            t("wizard.zalouser.groupsLookupTip", {
              command: formatCliCommand("nodoassist directory groups list --channel zalouser"),
            }),
