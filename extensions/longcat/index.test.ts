...
import { buildOpenAICompletionsParams } from "nodoassist/plugin-sdk/provider-transport-runtime";
...
function readManifest() {
  return JSON.parse(readFileSync(new URL("./nodoassist.plugin.json", import.meta.url), "utf8")) as {
