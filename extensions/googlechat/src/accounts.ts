...
import { isSecretRef } from "nodoassist/plugin-sdk/secret-input";
...
export function listEnabledGoogleChatAccounts(cfg: NodoAssistConfig): ResolvedGoogleChatAccount[] {
