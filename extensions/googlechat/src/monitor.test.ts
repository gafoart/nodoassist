...
import { recordChannelBotPairLoopAndCheckSuppression } from "nodoassist/plugin-sdk/channel-inbound";
...
function createInboundClassificationHarness() {
  ...
  const core = {
    ...
    channel: {
      ...
      session: {
        resolveStorePath: () => "/tmp/nodoassist-googlechat-test",
