...
import type { OutputRuntimeEnv } from "nodoassist/plugin-sdk/runtime";
import type { ChannelSetupWizardAdapter } from "nodoassist/plugin-sdk/setup";
...
export function createMatrixUpdateKeepCredentialsPrompter(params?: {
  ...
  return createMatrixWizardPrompter({
    ...
    text: {
      ...
      "Matrix device name (optional)": params?.deviceName ?? "NodoAssist Gateway",
    },
    confirm: {
