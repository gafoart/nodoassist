...
describe("createMatrixClient", () => {
  const storagePaths = {
    rootDir: "/tmp/nodoassist-matrix-create-client-test",
    storagePath: "/tmp/nodoassist-matrix-create-client-test/storage.json",
    recoveryKeyPath: "/tmp/nodoassist-matrix-create-client-test/recovery.key",
    idbSnapshotPath: "/tmp/nodoassist-matrix-create-client-test/idb.snapshot",
    accountKey: "default",
  ...
  it("persists storage metadata by default", async () => {
    ...
    expect(MatrixClientMock).toHaveBeenCalledWith("https://matrix.example.org", "tok", {
      ...
      cryptoDatabasePrefix: "nodoassist-matrix-default-token-hash",
