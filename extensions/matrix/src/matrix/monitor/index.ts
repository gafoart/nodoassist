// Matrix plugin entrypoint registers its NodoAssist integration.
...
import { resolveOptionalIntegerOption } from "nodoassist/plugin-sdk/number-runtime";
import {
...
type MonitorMatrixOpts = {
  ...
  setStatus?: (
    next: import("nodoassist/plugin-sdk/channel-contract").ChannelAccountSnapshot,
  ) => void;
};
