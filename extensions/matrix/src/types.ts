...
export type MatrixStreamingConfig = {
  ...
  progress?: import("nodoassist/plugin-sdk/channel-outbound").ChannelStreamingProgressConfig;
  preview?: {
...
export type CoreConfig = {
  ...
  session?: {
    store?: string;
    dmScope?: NonNullable<NodoAssistConfig["session"]>["dmScope"];
  };
  messages?: {
    ackReaction?: string;
    ackReactionScope?: "group-mentions" | "group-all" | "direct" | "all" | "none" | "off";
  };
  secrets?: NodoAssistConfig["secrets"];
  [key: string]: unknown;
};
