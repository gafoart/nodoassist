...
/** Mocks a launched NodoAssist Chrome process with the supplied pid. */
export function mockLaunchedChrome(
  launchNodoAssistChrome: { mockResolvedValue: (value: RunningChrome) => unknown },
  pid: number,
) {
  const proc = new EventEmitter() as unknown as ChildProcessWithoutNullStreams;
  launchNodoAssistChrome.mockResolvedValue({
    pid,
