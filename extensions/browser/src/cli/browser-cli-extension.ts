/**
 * `nodoassist browser extension` CLI: locate the unpacked Chrome extension and
...
/** Register `nodoassist browser extension {path,pair}`. */
export function registerBrowserExtensionCommands(
  ...
  extension
    .command("pair")
    .description("Print the pairing string to paste into the NodoAssist extension popup")
        ...
        async () => {
          ...
          defaultRuntime.log(
            [
              ...
              info("2. Open the NodoAssist popup and paste this pairing string:"),
              "",
