...
const STATE_LABEL = {
  on: "Connected to NodoAssist",
  connecting: "Connecting…",
  error: "Relay unreachable — is the NodoAssist gateway running?",
  off: "Not connected",
};
...
async function refresh() {
  ...
  shareButton.textContent = shared ? "Stop sharing this tab" : "Share this tab with NodoAssist";
