...
>({
  ...
  resolveParams: (_cfg: NodoAssistConfig, api) => ({
    providerId: "xai",
    api,
...
function pruneRetiredXaiBuiltinModels(cfg: NodoAssistConfig): NodoAssistConfig {
...
export function applyXaiProviderConfig(cfg: NodoAssistConfig): NodoAssistConfig {
...
export function applyXaiConfig(cfg: NodoAssistConfig): NodoAssistConfig {
