...
function resolveLegacyXSearchConfig(config?: NodoAssistConfig): JsonRecord | undefined {
...
function resolvePluginXSearchConfig(config?: NodoAssistConfig): JsonRecord | undefined {
...
function resolveLegacyGrokWebSearchConfig(config?: NodoAssistConfig): JsonRecord | undefined {
  const web = config?.tools?.web as Record<string, unknown> | undefined;
...
function resolvePluginWebSearchConfig(config?: NodoAssistConfig): JsonRecord | undefined {
  const pluginConfig = config?.plugins?.entries?.xai?.config;
...
export function resolveEffectiveXSearchConfig(config?: NodoAssistConfig): JsonRecord | undefined {
