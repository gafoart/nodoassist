...
export function applySyntheticProviderConfig(cfg: NodoAssistConfig): NodoAssistConfig {
  return syntheticPresetAppliers.applyProviderConfig(cfg);
}

export function applySyntheticConfig(cfg: NodoAssistConfig): NodoAssistConfig {
