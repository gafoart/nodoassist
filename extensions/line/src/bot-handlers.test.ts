...
vi.mock("nodoassist/plugin-sdk/channel-inbound", () => ({
  buildMentionRegexes: () => [],
  matchesMentionPatterns: () => false,
}));
vi.mock("nodoassist/plugin-sdk/channel-pairing", () => ({
...
vi.mock("nodoassist/plugin-sdk/command-auth-native", () => ({
...
vi.mock("nodoassist/plugin-sdk/runtime-group-policy", () => ({
...
vi.mock("nodoassist/plugin-sdk/routing", () => ({
...
describe("handleLineWebhookEvents", () => {
  ...
  afterAll(() => {
    vi.doUnmock("nodoassist/plugin-sdk/channel-inbound");
    vi.doUnmock("nodoassist/plugin-sdk/channel-pairing");
    vi.doUnmock("nodoassist/plugin-sdk/command-auth-native");
    vi.doUnmock("nodoassist/plugin-sdk/runtime-group-policy");
    vi.doUnmock("nodoassist/plugin-sdk/runtime-env");
    vi.doUnmock("nodoassist/plugin-sdk/reply-history");
    vi.doUnmock("nodoassist/plugin-sdk/routing");
    vi.doUnmock("nodoassist/plugin-sdk/conversation-runtime");
