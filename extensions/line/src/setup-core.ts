...
import type { ChannelSetupAdapter, NodoAssistConfig } from "nodoassist/plugin-sdk/setup";
import { createSetupInputPresenceValidator } from "nodoassist/plugin-sdk/setup";
...
export function isLineConfigured(cfg: NodoAssistConfig, accountId: string): boolean {
