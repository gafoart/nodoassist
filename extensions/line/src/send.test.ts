...
vi.mock("nodoassist/plugin-sdk/plugin-config-runtime", () => ({
...
vi.mock("nodoassist/plugin-sdk/channel-activity-runtime", () => ({
...
describe("LINE send helpers", () => {
  ...
  afterAll(() => {
    ...
    vi.doUnmock("nodoassist/plugin-sdk/channel-activity-runtime");
