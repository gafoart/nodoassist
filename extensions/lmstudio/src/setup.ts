...
import { withAgentModelAliases } from "nodoassist/plugin-sdk/provider-onboard";
import {
...
function stripLmstudioStoredAuthConfig(cfg: NodoAssistConfig): NodoAssistConfig {
...
function mergeDiscoveredLmstudioAllowlistEntries(params: {
  existing?: NonNullable<NonNullable<NodoAssistConfig["agents"]>["defaults"]>["models"];
  discoveredModels: ModelDefinitionConfig[];
}) {
