...
const providerFilter = parseCsvFilter(process.env.NODOASSIST_LIVE_MUSIC_GENERATION_PROVIDERS);
const envModelMap = parseProviderModelMap(process.env.NODOASSIST_LIVE_MUSIC_GENERATION_MODELS);
