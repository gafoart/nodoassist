...
import { resolveAccountWithDefaultFallback } from "nodoassist/plugin-sdk/account-core";
...
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "nodoassist/plugin-sdk/routing";
import {
  hasConfiguredSecretInput,
  normalizeSecretInputString,
} from "nodoassist/plugin-sdk/secret-input";
import { coerceSecretRef } from "nodoassist/plugin-sdk/secret-input-runtime";
import { FsSafeError } from "nodoassist/plugin-sdk/security-runtime";
...
function inspectTokenValue(params: { cfg: NodoAssistConfig; value: unknown }): {
  token: string;
...
function hasConfiguredTelegramAccounts(cfg: NodoAssistConfig): boolean {
