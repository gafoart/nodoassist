...
import { resolveAgentMaxConcurrent } from "nodoassist/plugin-sdk/model-session-runtime";
...
function createTelegramRunnerOptions(cfg: NodoAssistConfig): RunOptions<unknown> {
  return {
    sink: {
