...
import { resolveApiKeyForProvider } from "nodoassist/plugin-sdk/agent-runtime";
import type { ModelCatalogEntry } from "nodoassist/plugin-sdk/agent-runtime";
import {
  findModelInCatalog,
  loadModelCatalog,
  modelSupportsVision,
} from "nodoassist/plugin-sdk/agent-runtime";
import { resolveDefaultModelForAgent } from "nodoassist/plugin-sdk/agent-runtime";
import type { NodoAssistConfig } from "nodoassist/plugin-sdk/config-contracts";
import { resolveAutoImageModel } from "nodoassist/plugin-sdk/media-runtime";
import {
