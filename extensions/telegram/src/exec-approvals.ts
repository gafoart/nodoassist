...
import { resolveApprovalApprovers } from "nodoassist/plugin-sdk/approval-auth-runtime";
import {
...
import { resolveApprovalRequestChannelAccountId } from "nodoassist/plugin-sdk/approval-native-runtime";
import type {
  ExecApprovalRequest,
  PluginApprovalRequest,
} from "nodoassist/plugin-sdk/approval-runtime";
import type { NodoAssistConfig } from "nodoassist/plugin-sdk/config-contracts";
import type { TelegramExecApprovalConfig } from "nodoassist/plugin-sdk/config-contracts";
...
function resolveTelegramOwnerApprovers(cfg: NodoAssistConfig): Array<string | number> {
