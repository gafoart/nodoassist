...
vi.mock("nodoassist/plugin-sdk/hook-runtime", async () => {
  const actual = await vi.importActual<typeof import("nodoassist/plugin-sdk/hook-runtime")>(
    "nodoassist/plugin-sdk/hook-runtime",
  );
  return {
    ...actual,
