...
function buildConfig(
  overrides?: Partial<NonNullable<NonNullable<NodoAssistConfig["channels"]>["telegram"]>>,
): NodoAssistConfig {
  return {
    channels: {
      telegram: {
...
const STORE_PATH = path.join(os.tmpdir(), "nodoassist-telegram-approval-native-test.json");
