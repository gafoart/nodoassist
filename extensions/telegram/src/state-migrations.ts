...
import type { ChannelLegacyStateMigrationPlan } from "nodoassist/plugin-sdk/channel-contract";
import { resolveChannelAllowFromPath } from "nodoassist/plugin-sdk/channel-pairing";
...
import { createPluginStateSyncKeyedStore } from "nodoassist/plugin-sdk/runtime-doctor";
import { statRegularFileSync } from "nodoassist/plugin-sdk/security-runtime";
...
function detectTelegramMessageDispatchLegacyStateMigration(params: {
  ...
  const env = params.stateDir
    ? { ...params.env, NODOASSIST_STATE_DIR: params.stateDir }
    : params.env;
