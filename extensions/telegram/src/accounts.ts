...
import { formatSetExplicitDefaultInstruction } from "nodoassist/plugin-sdk/routing";
import { createSubsystemLogger, isTruthyEnvValue } from "nodoassist/plugin-sdk/runtime-env";
...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.NODOASSIST_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listEnabledTelegramAccounts(cfg: NodoAssistConfig): ResolvedTelegramAccount[] {
