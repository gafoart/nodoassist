...
import { WEBHOOK_RATE_LIMIT_DEFAULTS } from "nodoassist/plugin-sdk/webhook-ingress";
...
beforeEach(async () => {
  ...
  webhookStateDir = await fs.mkdtemp(nodePath.join(os.tmpdir(), "nodoassist-telegram-webhook-"));
