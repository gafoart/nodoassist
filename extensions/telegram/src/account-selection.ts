...
function listConfiguredAccountIds(cfg: NodoAssistConfig): string[] {
...
function listBoundAccountIds(cfg: NodoAssistConfig, channelId: string): string[] {
  const ids = new Set<string>();
...
function hasImplicitDefaultTelegramAccount(cfg: NodoAssistConfig): boolean {
...
export function listTelegramAccountIds(cfg: NodoAssistConfig): string[] {
...
export function resolveDefaultTelegramAccountSelection(cfg: NodoAssistConfig): {
  accountId: string;
  accountIds: string[];
...
export function resolveDefaultTelegramAccountId(cfg: NodoAssistConfig): string {
