...
import { isTruthyEnvValue, isWSL2Sync } from "nodoassist/plugin-sdk/runtime-env";
import { normalizeOptionalLowercaseString } from "nodoassist/plugin-sdk/string-coerce-runtime";

const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV = "NODOASSIST_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "NODOASSIST_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "NODOASSIST_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable NODOASSIST_TELEGRAM_DNS_RESULT_ORDER
