...
export const WIKI_RELATED_START_MARKER = "<!-- nodoassist:wiki:related:start -->";
export const WIKI_RELATED_END_MARKER = "<!-- nodoassist:wiki:related:end -->";
export const WIKI_RAW_SOURCE_MARKER = "<!-- nodoassist:wiki:raw-source -->";
...
const HUMAN_START_MARKER = "<!-- nodoassist:human:start -->";
const HUMAN_END_MARKER = "<!-- nodoassist:human:end -->";
