...
import { resolveDefaultAgentId } from "nodoassist/plugin-sdk/memory-host-core";
import { readPositiveIntegerParam } from "nodoassist/plugin-sdk/param-readers";
import type { NodoAssistConfig, NodoAssistPluginApi } from "../api.js";
...
type GatewayMethodContext = Parameters<
  Parameters<NodoAssistPluginApi["registerGatewayMethod"]>[1]
>[0];
...
function resolveGatewayAgentId(
  ...
  appConfig: NodoAssistConfig | undefined,
): string | undefined {
  return (
