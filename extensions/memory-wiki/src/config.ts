...
import { buildPluginConfigSchema, z, type NodoAssistPluginConfigSchema } from "../api.js";
...
export const memoryWikiConfigSchema: NodoAssistPluginConfigSchema = memoryWikiConfigSchemaBase;
...
export function resolveDefaultMemoryWikiVaultPath(homedir = os.homedir()): string {
  return path.join(homedir, ".nodoassist", "wiki", "main");
}
