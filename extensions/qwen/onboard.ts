...
const qwenPresetAppliers = createModelCatalogPresetAppliers<[string]>({
  ...
  resolveParams: (_cfg: NodoAssistConfig, baseUrl: string) => {
...
export function applyQwenConfig(cfg: NodoAssistConfig): NodoAssistConfig {
  return qwenPresetAppliers.applyConfig(cfg, QWEN_GLOBAL_BASE_URL);
}

export function applyQwenConfigCn(cfg: NodoAssistConfig): NodoAssistConfig {
  return qwenPresetAppliers.applyConfig(cfg, QWEN_CN_BASE_URL);
}

export function applyQwenStandardConfig(cfg: NodoAssistConfig): NodoAssistConfig {
  return qwenPresetAppliers.applyConfig(cfg, QWEN_STANDARD_GLOBAL_BASE_URL);
}

export function applyQwenStandardConfigCn(cfg: NodoAssistConfig): NodoAssistConfig {
  return qwenPresetAppliers.applyConfig(cfg, QWEN_STANDARD_CN_BASE_URL);
}

export function applyQwenOAuthConfig(cfg: NodoAssistConfig): NodoAssistConfig {
