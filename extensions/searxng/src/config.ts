...
export function resolveSearxngCategories(config?: NodoAssistConfig): string | undefined {
  return normalizeTrimmedString(resolveSearxngWebSearchConfig(config)?.categories);
}

export function resolveSearxngLanguage(config?: NodoAssistConfig): string | undefined {
