...
import { parseFiniteNumber } from "nodoassist/plugin-sdk/number-runtime";
...
function resolveDefaultDbPath(): string {
  const home = homedir();
  const preferred = join(home, ".nodoassist", "memory", "lancedb");
  try {
...
export const memoryConfigSchema = {
  ...
  uiHints: {
    ...
    dbPath: {
      label: "Database Path",
      placeholder: "~/.nodoassist/memory/lancedb",
      advanced: true,
