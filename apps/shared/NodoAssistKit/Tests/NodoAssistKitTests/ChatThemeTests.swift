...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = NodoAssistChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = NodoAssistChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
