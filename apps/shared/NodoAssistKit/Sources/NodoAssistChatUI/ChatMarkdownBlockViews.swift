...
struct ChatMathBlockView: View {
    ...
    @ScaledMetric(relativeTo: .body) private var fontSize: CGFloat = NodoAssistChatTypography.bodySize
...
struct ChatMarkdownTableView: View {
    ...
    private func cell(_ text: String, column: Int, isHeader: Bool) -> some View {
        Text(self.inlineMarkdown(text))
            .font(isHeader ? NodoAssistChatTypography.footnoteSemiBold : NodoAssistChatTypography.footnote)
            .foregroundStyle(NodoAssistChatTheme.assistantText)
            .textSelection(.enabled)
    }
