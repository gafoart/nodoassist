        ...
        Button {
            ...
            HStack(spacing: 6) {
                Text("Preview · \(self.domain)")
                    ...
                    .foregroundStyle(NodoAssistChatTheme.assistantText.opacity(0.65))
                    .lineLimit(1)
                Spacer(minLength: 0)
            ...
            .padding(.vertical, 6)
            .background(NodoAssistChatTheme.subtleCard)
            .clipShape(RoundedRectangle(cornerRadius: 8, style: .continuous))
            .overlay(
                RoundedRectangle(cornerRadius: 8, style: .continuous)
                    .strokeBorder(NodoAssistChatTheme.divider, lineWidth: 1))
        }
        .buttonStyle(.plain)
            ...
            VStack(alignment: .leading, spacing: 3) {
                ...
                case .failed:
                    Text("No preview available")
                        .font(NodoAssistChatTypography.callout)
                        .foregroundStyle(NodoAssistChatTheme.assistantText.opacity(0.65))
                case let .loaded(metadata):
