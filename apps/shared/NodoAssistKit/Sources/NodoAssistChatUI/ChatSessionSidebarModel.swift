...
enum ChatSessionSidebarModel {
    struct Section: Identifiable, Equatable {
        let id: String
        let title: String?
        let sessions: [NodoAssistChatSessionEntry]
    }
    ...
    static func displayName(for session: NodoAssistChatSessionEntry) -> String {
    ...
    private static func visibleSessions(
        ...
        query: String) -> [NodoAssistChatSessionEntry]
    {
    ...
    private static func placeholder(key: String) -> NodoAssistChatSessionEntry {
