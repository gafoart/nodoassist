...
public typealias NodoAssistPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias NodoAssistPlatformImage = UIImage
#endif

public enum NodoAssistChatCommandFilter: String, CaseIterable, Sendable {
    case all = "All"
    case commands = "Commands"
    case skills = "Skills"
}

public struct NodoAssistChatCommandChoice: Identifiable, Hashable, Sendable {
...
public struct NodoAssistChatUsageCost: Codable, Hashable, Sendable {
...
public struct NodoAssistChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: NodoAssistChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(NodoAssistChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct NodoAssistChatMessageContent: Codable, Hashable, Sendable {
...
public struct NodoAssistChatMessage: Codable, Hashable, Identifiable, Sendable {
    private struct NodoAssistMetadata: Codable {
        let idempotencyKey: String?
    }

    public var id: UUID = .init()
    public let role: String
    public let content: [NodoAssistChatMessageContent]
    public let timestamp: Double?
    public let idempotencyKey: String?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: NodoAssistChatUsage?
    ...
    public init(from decoder: Decoder) throws {
        ...
        let decodedNodoAssist = try container.decodeIfPresent(NodoAssistMetadata.self, forKey: .nodoAssist)
        let decodedIdempotencyKey = try decodedNodoAssist?.idempotencyKey ??
        ...
        let decodedUsage = try container.decodeIfPresent(NodoAssistChatUsage.self, forKey: .usage)
        ...
        let decodedContent: [NodoAssistChatMessageContent] = if let decoded = try? container.decode(
            [NodoAssistChatMessageContent].self,
            forKey: .content)
        {
            decoded
        ...
        let audioAttachments: [NodoAssistChatMessageContent] = alreadyContainsAudio ? [] : mediaPaths
            .enumerated()
            .compactMap { index, mediaPath in
                ...
                return NodoAssistChatMessageContent(
                    type: "file",
                    text: nil,
                    mimeType: mimeType,
...
public struct NodoAssistChatInFlightRun: Codable, Sendable {
...
public struct NodoAssistChatSessionInfo: Codable, Sendable {
...
public struct NodoAssistChatHistoryPayload: Codable, Sendable {
    public let sessionKey: String
    public let sessionId: String?
    public let messages: [AnyCodable]?
    public let thinkingLevel: String?
    public let sessionInfo: NodoAssistChatSessionInfo?
    public let inFlightRun: NodoAssistChatInFlightRun?
    ...
    public init(
        ...
        sessionInfo: NodoAssistChatSessionInfo? = nil,
        inFlightRun: NodoAssistChatInFlightRun? = nil)
    {
...
public struct NodoAssistSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct NodoAssistSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [NodoAssistSessionPreviewItem]
}

public struct NodoAssistSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [NodoAssistSessionPreviewEntry]

    public init(ts: Int, previews: [NodoAssistSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct NodoAssistChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct NodoAssistChatCreateSessionResponse: Codable, Sendable {
    public let ok: Bool?
    public let key: String
    public let sessionId: String?
}

public struct NodoAssistChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct NodoAssistSessionMessageEventPayload: Codable, Sendable {
    public let sessionKey: String?
    public let agentId: String?
    public let message: NodoAssistChatMessage?
...
public struct NodoAssistAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct NodoAssistChatPendingToolCall: Identifiable, Hashable, Sendable {
    public var id: String {
        self.toolCallId
    }
...
public struct NodoAssistGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct NodoAssistPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: NodoAssistPlatformImage?
    public let durationSeconds: Double?
    ...
    public init(
        ...
        mimeType: String,
        type: String = "file",
        preview: NodoAssistPlatformImage?,
        durationSeconds: Double? = nil)
    {
        self.url = url
        self.data = data
...
public struct NodoAssistChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
