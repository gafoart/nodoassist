...
public struct NodoAssistChatContextUsage: Equatable, Sendable {
...
enum ChatContextUsageCalculator {
    ...
    static func usage(
        ...
        sessionEntry: NodoAssistChatSessionEntry?,
        defaults: NodoAssistChatSessionsDefaults?,
        modelContextWindow: Int?) -> NodoAssistChatContextUsage?
    {
        ...
        return NodoAssistChatContextUsage(
    ...
    private static func latestRunTokens(in messages: [NodoAssistChatMessage]) -> Int? {
    ...
    private static func totalCost(in messages: [NodoAssistChatMessage]) -> Double? {
...
extension NodoAssistChatViewModel {
    public var contextUsage: NodoAssistChatContextUsage? {
    ...
    private func selectedModelContextWindow(sessionEntry: NodoAssistChatSessionEntry?) -> Int? {
