...
public enum ChatTranscriptExporter {
    ...
    public static func markdown(
        sessionTitle: String?,
        sessionKey: String,
        messages: [NodoAssistChatMessage]) -> String
    {
    ...
    private static func shouldExport(_ message: NodoAssistChatMessage) -> Bool {
    ...
    private static func body(for message: NodoAssistChatMessage) -> String {
        var parts: [String] = []
        let text = self.visibleText(in: message)
        if !text.isEmpty {
            parts.append(text)
    ...
    private static func visibleText(in message: NodoAssistChatMessage) -> String {
        ChatMessageVisibleText.visibleText(in: message)
    }

    private static func attachments(in message: NodoAssistChatMessage) -> [NodoAssistChatMessageContent] {
