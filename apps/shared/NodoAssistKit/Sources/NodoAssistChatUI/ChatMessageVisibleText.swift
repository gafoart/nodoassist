...
enum ChatMessageVisibleText {
    static func visibleText(in message: NodoAssistChatMessage) -> String {
    ...
    static func hasVisibleText(in message: NodoAssistChatMessage) -> Bool {
        !self.visibleText(in: message)
            .trimmingCharacters(in: .whitespacesAndNewlines)
            .isEmpty
    }

    private static func primaryText(in message: NodoAssistChatMessage) -> String {
