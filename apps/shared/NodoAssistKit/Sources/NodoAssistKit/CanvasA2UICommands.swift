...
public enum NodoAssistCanvasA2UICommand: String, Codable, Sendable {
...
public struct NodoAssistCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct NodoAssistCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
