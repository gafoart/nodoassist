...
public struct NodoAssistSessionsCompactResponse: Decodable, Sendable {
    public let ok: Bool
    ...
    public static func requireSuccess(from data: Data) throws {
        ...
        guard response.ok else {
            throw NodoAssistSessionsCompactError(reason: response.reason)
        }
    }
}

public struct NodoAssistSessionsCompactError: Error, LocalizedError, Sendable {
    public let reason: String?
