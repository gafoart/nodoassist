...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: NodoAssistProtocol.AnyCodable]?
    {
        ...
        return [
            "id": NodoAssistProtocol.AnyCodable(identity.deviceId),
            "publicKey": NodoAssistProtocol.AnyCodable(publicKey),
            "signature": NodoAssistProtocol.AnyCodable(signature),
            "signedAt": NodoAssistProtocol.AnyCodable(signedAtMs),
            "nonce": NodoAssistProtocol.AnyCodable(nonce),
        ]
    }
}
