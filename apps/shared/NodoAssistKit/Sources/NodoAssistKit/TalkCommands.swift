...
public enum NodoAssistTalkCommand: String, Codable, Sendable {
...
public struct NodoAssistTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct NodoAssistTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
