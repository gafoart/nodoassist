...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.nodoassist", category: "node.gateway")
    ...
    {
        let timeoutLogger = Logger(subsystem: "ai.nodoassist", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: NodoAssistProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
