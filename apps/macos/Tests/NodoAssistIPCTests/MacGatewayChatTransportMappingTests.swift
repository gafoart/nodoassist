...
struct MacGatewayChatTransportMappingTests {
    ...
    @Test func `snapshot maps to health`() {
        let snapshot = Snapshot(
            presence: [],
            health: NodoAssistProtocol.AnyCodable(["ok": NodoAssistProtocol.AnyCodable(false)]),
    ...
    @Test func `health event maps to health`() {
        let frame = EventFrame(
            type: "event",
            event: "health",
            payload: NodoAssistProtocol.AnyCodable(["ok": NodoAssistProtocol.AnyCodable(true)]),
            seq: 1,
            stateversion: nil)
    ...
    @Test func `chat event maps to chat`() {
        let payload = NodoAssistProtocol.AnyCodable([
            "runId": NodoAssistProtocol.AnyCodable("run-1"),
            "sessionKey": NodoAssistProtocol.AnyCodable("main"),
            "state": NodoAssistProtocol.AnyCodable("final"),
        ])
    ...
    @Test func `session message event maps to session message`() {
        let payload = NodoAssistProtocol.AnyCodable([
            "sessionKey": NodoAssistProtocol.AnyCodable("agent:main:main"),
            "messageId": NodoAssistProtocol.AnyCodable("msg-1"),
            "messageSeq": NodoAssistProtocol.AnyCodable(7),
            "message": NodoAssistProtocol.AnyCodable([
                "role": NodoAssistProtocol.AnyCodable("user"),
                "content": NodoAssistProtocol.AnyCodable([
                    NodoAssistProtocol.AnyCodable([
                        "type": NodoAssistProtocol.AnyCodable("text"),
                        "text": NodoAssistProtocol.AnyCodable("spoken transcript"),
                    ]),
                ]),
                "timestamp": NodoAssistProtocol.AnyCodable(1234.5),
            ]),
        ])
    ...
    @Test func `unknown event maps to nil`() {
        let frame = EventFrame(
            type: "event",
            event: "unknown",
            payload: NodoAssistProtocol.AnyCodable(["a": NodoAssistProtocol.AnyCodable(1)]),
            seq: 1,
            stateversion: nil)
        let mapped = MacGatewayChatTransport.mapPushToTransportEvent(.event(frame))
        #expect(mapped == nil)
