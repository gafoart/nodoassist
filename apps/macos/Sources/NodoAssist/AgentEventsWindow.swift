...
private struct EventRow: View {
    ...
    private func prettyJSON(_ dict: [String: NodoAssistProtocol.AnyCodable]) -> String? {
...
struct AgentEventsWindow_Previews: PreviewProvider {
    static var previews: some View {
        let sample = ControlAgentEvent(
            ...
            data: [
                "phase": NodoAssistProtocol.AnyCodable("start"),
                "name": NodoAssistProtocol.AnyCodable("bash"),
            ],
            summary: nil)
