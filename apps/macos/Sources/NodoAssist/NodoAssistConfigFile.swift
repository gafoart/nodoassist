...
enum NodoAssistConfigFile {
    private static let logger = Logger(subsystem: "ai.nodoassist", category: "config")
    ...
    static func url() -> URL {
        NodoAssistPaths.configURL
    }

    static func stateDirURL() -> URL {
        NodoAssistPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        NodoAssistPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-nodoassist-config-file",
            "event": "config.write",
