...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .nodoassistSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? NodoAssistPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? NodoAssistPaths.stateDirURL.path
...
private struct SettingsTabGroup: Identifiable {
    ...
    static func defaultGroups(showDebug: Bool) -> [SettingsTabGroup] {
        var groups = [
            ...
            SettingsTabGroup(title: "NodoAssist", tabs: [.about]),
        ]
...
extension Notification.Name {
    static let nodoassistSelectSettingsTab = Notification.Name("nodoassistSelectSettingsTab")
}
