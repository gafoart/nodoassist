...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.nodoassist", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("NodoAssist/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__nodoassist__/a2ui/").absoluteString + "?platform=macos"
    }
