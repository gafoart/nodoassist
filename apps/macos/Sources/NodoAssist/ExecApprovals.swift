...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.nodoassist", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        NodoAssistPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        NodoAssistPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }

    private static func legacyStateDirURLs() -> [URL] {
        if let home = NodoAssistEnv.path("NODOASSIST_HOME") {
            var urls = [
                URL(fileURLWithPath: home, isDirectory: true)
                    .appendingPathComponent(".nodoassist", isDirectory: true),
            ]
    ...
    private static func legacyFileURLIfPending() -> URL? {
        guard NodoAssistEnv.path("NODOASSIST_STATE_DIR") != nil else { return nil }
    ...
    private static func ensureSecureStateDirectory() {
        let url = NodoAssistPaths.stateDirURL
        do {
