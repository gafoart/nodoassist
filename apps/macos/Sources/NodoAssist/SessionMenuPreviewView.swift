...
enum SessionMenuPreviewLoader {
    private static let logger = Logger(subsystem: "ai.nodoassist", category: "SessionPreview")
    ...
    private static func requestPreview(
        keys: [String],
        maxItems: Int) async throws -> NodoAssistSessionsPreviewPayload
    {
    ...
    private static func snapshot(
        from entry: NodoAssistSessionPreviewEntry,
    ...
    private static func cache(payload: NodoAssistSessionsPreviewPayload, maxItems: Int) async {
    ...
    private static func previewItems(
        from payload: NodoAssistChatHistoryPayload,
        maxItems: Int) -> [SessionPreviewItem]
    {
        let boundedItems = self.normalizeMaxItems(maxItems)
        let raw: [NodoAssistKit.AnyCodable] = payload.messages ?? []
    ...
    private static func decodeMessages(_ raw: [NodoAssistKit.AnyCodable]) -> [NodoAssistChatMessage] {
    ...
    private static func previewText(for message: NodoAssistChatMessage) -> String? {
    ...
    private static func isToolCall(_ message: NodoAssistChatMessage) -> Bool {
    ...
    private static func toolNames(for message: NodoAssistChatMessage) -> [String] {
        var names: [String] = []
    ...
    private static func mediaSummary(for message: NodoAssistChatMessage) -> String? {
