...
enum DebugActions {
    private static let verboseDefaultsKey = "nodoassist.debug.verboseMain"
    private static let sessionMenuLimit = 12
    private static let onboardingSeenKey = "nodoassist.onboardingSeen"
    ...
    static func sendTestNotification() async {
        _ = await NotificationManager().send(title: "NodoAssist", body: "Test notification", sound: nil)
    }
    ...
    private static func resolveSessionStorePath() -> String {
        ...
        let configURL = NodoAssistPaths.configURL
        guard
