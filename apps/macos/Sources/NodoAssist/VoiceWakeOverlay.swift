...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.nodoassist", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other NodoAssist windows, but below the system’s pop-up menus.
