...
struct NodoAssistApp: App {
    ...
    private static let logger = Logger(subsystem: "ai.nodoassist", category: "app")
    ...
    var body: some Scene {
        ...
        Window("NodoAssist Settings", id: SettingsWindowOpener.windowID) {
    ...
    private func applyStatusItemAppearance(paused _: Bool, sleeping _: Bool) {
        ...
        self.statusItem?.button?.toolTip = self.state.voiceWakeMeterActive
            ? "NodoAssist - Voice Wake live meter active"
            : "NodoAssist"
    }
...
final class AppDelegate: NSObject, NSApplicationDelegate {
    private static let dashboardURL = URL(string: "nodoassist://dashboard")!
    private var state: AppState?
    private let webChatAutoLogger = Logger(subsystem: "ai.nodoassist", category: "Chat")
