...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.nodoassist", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return NodoAssistConfigFile.defaultWorkspaceURL() }
