...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.nodoassist", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".nodoassist/disable-launchagent"
...
extension GatewayLaunchAgentManager {
        ...
        quiet: Bool) async -> CommandResult
    {
        ...
        #endif
        let command = CommandResolver.nodoassistCommand(
            subcommand: "gateway",
