...
actor MacNodeRuntime {
    ...
    // NODOASSIST_CONFIG_PATH; config parsing is covered by NodoAssistConfigFileTests.
    ...
    init(
        ...
        browserControlEnabled: @escaping @Sendable () -> Bool = {
            NodoAssistConfigFile.browserControlEnabled()
        },
    ...
    func handleInvoke(_ req: BridgeInvokeRequest) async -> BridgeInvokeResponse {
        ...
        do {
            ...
            case NodoAssistBrowserCommand.proxy.rawValue:
            ...
            case NodoAssistLocationCommand.get.rawValue:
            ...
            case NodoAssistSystemCommand.run.rawValue:
                return try await self.handleSystemRun(req)
            case NodoAssistSystemCommand.which.rawValue:
                return try await self.handleSystemWhich(req)
            case NodoAssistSystemCommand.notify.rawValue:
                return try await self.handleSystemNotify(req)
            case NodoAssistSystemCommand.execApprovalsGet.rawValue:
                return try await self.handleSystemExecApprovalsGet(req)
            case NodoAssistSystemCommand.execApprovalsSet.rawValue:
    ...
    private func handleA2UIInvoke(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        ...
        case NodoAssistCanvasA2UICommand.push.rawValue,
             NodoAssistCanvasA2UICommand.pushJSONL.rawValue:
    ...
    private func handleScreenSnapshotInvoke(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        ...
        let res: (data: Data, format: NodoAssistScreenSnapshotFormat, width: Int, height: Int)
        do {
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return baseUrl.appendingPathComponent("__nodoassist__/a2ui/").absoluteString + "?platform=macos"
    }
    ...
    private func handleSystemRun(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        let params = try Self.decodeParams(NodoAssistSystemRunParams.self, from: req.paramsJSON)
    ...
    private func handleSystemWhich(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        let params = try Self.decodeParams(NodoAssistSystemWhichParams.self, from: req.paramsJSON)
    ...
    private func resolveSystemRunApproval(
        ...
        params: NodoAssistSystemRunParams,
...
extension MacNodeRuntime {
    ...
    private nonisolated static func locationMode() -> NodoAssistLocationMode {
        ...
        message: String) -> BridgeInvokeResponse
    {
        BridgeInvokeResponse(
            id: req.id,
            ok: false,
            error: NodoAssistNodeError(code: code, message: message))
    }

    private static func encodeCanvasSnapshot(
        image: NSImage,
        format: NodoAssistCanvasSnapshotFormat,
        maxWidth: Int?,
