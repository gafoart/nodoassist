...
struct AboutSettings: View {
        ...
        VStack(spacing: 8) {
            Button {
                ...
                NodoAssistMascotView()
                    ...
                    .shadow(
                        color: NodoAssistMascotView.heroGlowColor(
            ...
            .buttonStyle(.plain)
            .accessibilityLabel("NodoAssist on GitHub")
            .focusable(false)
            .pointingHandCursor()
            .onHover { hover in
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "NodoAssistBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "NodoAssistBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "NodoAssistGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "NodoAssistGitCommit") as? String) ??
            "unknown"
    }
