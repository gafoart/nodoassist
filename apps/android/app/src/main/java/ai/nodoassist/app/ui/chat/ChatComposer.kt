...
import ai.nodoassist.app.ChatDraft
import ai.nodoassist.app.ChatDraftPlacement
...
import ai.nodoassist.app.ui.mobileAccentBorderStrong
...
import ai.nodoassist.app.ui.mobileHeadline
import ai.nodoassist.app.ui.mobileSurface
import ai.nodoassist.app.ui.mobileText
import ai.nodoassist.app.ui.mobileTextSecondary
import ai.nodoassist.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.nodoassist.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.nodoassist.app.ui.mobileFontFamily,
