...
import ai.nodoassist.app.gateway.GatewayCustomHeaders
import ai.nodoassist.app.gateway.GatewayRegistryStore
import ai.nodoassist.app.gateway.GatewayStoreMigration
...
class SecurePrefs(
  ...
  companion object {
    val defaultWakeWords: List<String> = listOf("nodoassist", "claude")
    private const val displayNameKey = "node.displayName"
    private const val locationModeKey = "location.enabledMode"
    private const val voiceWakeModeKey = "voiceWake.mode"
    private const val plainPrefsName = "nodoassist.node"
    private const val securePrefsName = "nodoassist.node.secure"
  ...
  internal fun getNotificationForwardingPolicy(appPackageName: String): NotificationForwardingPolicy {
    ...
    // Always block NodoAssist's own notifications in blocklist mode to prevent forwarding loops.
