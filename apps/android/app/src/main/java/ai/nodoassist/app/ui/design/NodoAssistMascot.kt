...
/**
 * Animated NodoAssist mascot mirroring the openclaw.ai hero mark: body float,
...
private fun rememberMascotPose(): MascotPose {
  ...
  val transition = rememberInfiniteTransition(label = "nodoassistMascot")
  val floatOffset =
