...
class NodeForegroundService : Service() {
  ...
  override fun onCreate() {
    super.onCreate()
    ensureChannel()
    val initial = buildNotification(title = "NodoAssist Node", text = "Starting…")
    ...
    notificationJob =
      scope.launch {
        combine(
          ...
          val title =
            when {
              state.connected && state.mode == VoiceCaptureMode.TalkMode -> "NodoAssist Node · Talk"
              state.connected -> "NodoAssist Node · Connected"
              else -> "NodoAssist Node"
            }
          val text =
  ...
  private fun ensureChannel() {
    ...
    val channel =
      NotificationChannel(
        ...
        description = "NodoAssist node connection status"
        setShowBadge(false)
      }
  ...
  companion object {
    ...
    private const val ACTION_STOP = "ai.nodoassist.app.action.STOP"
    private const val ACTION_SET_VOICE_CAPTURE_MODE = "ai.nodoassist.app.action.SET_VOICE_CAPTURE_MODE"
    private const val EXTRA_VOICE_CAPTURE_MODE = "ai.nodoassist.app.extra.VOICE_CAPTURE_MODE"
