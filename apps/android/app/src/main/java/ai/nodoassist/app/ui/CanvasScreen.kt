...
import ai.nodoassist.app.node.CanvasNavigationPolicy
...
fun CanvasScreen(
  ...
  AndroidView(
    ...
    factory = {
      ...
      if (isDebuggable) {
        Log.d("NodoAssistWebView", "userAgent: ${webSettings.userAgentString}")
      }
      ...
      webView.webViewClient =
        object : WebViewClient() {
          ...
          override fun onReceivedError(
            ...
            Log.e("NodoAssistWebView", "onReceivedError: ${error.errorCode} ${error.description} ${request.url}")
          }
          ...
          override fun onPageFinished(
            ...
            currentPageUrlRef.set(url)
            if (isDebuggable) {
              Log.d("NodoAssistWebView", "onPageFinished: $url")
            }
      ...
      if (WebViewFeature.isFeatureSupported(WebViewFeature.WEB_MESSAGE_LISTENER)) {
        ...
        Log.w("NodoAssistWebView", "WebMessageListener unsupported; canvas actions disabled")
      }
...
internal class CanvasA2UIActionBridge(
  ...
  companion object {
    const val interfaceName: String = "nodoassistCanvasA2UIAction"
