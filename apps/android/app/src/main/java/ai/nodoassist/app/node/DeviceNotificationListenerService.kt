...
import ai.nodoassist.app.NotificationBurstLimiter
import ai.nodoassist.app.SecurePrefs
import ai.nodoassist.app.allowsPackage
import ai.nodoassist.app.isWithinQuietHours
...
class DeviceNotificationListenerService : NotificationListenerService() {
  ...
  companion object {
    ...
    private fun recentPackagesPrefs(context: Context) = context.applicationContext.getSharedPreferences("nodoassist.secure", Context.MODE_PRIVATE)
