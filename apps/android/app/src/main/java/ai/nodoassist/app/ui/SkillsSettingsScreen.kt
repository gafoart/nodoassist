...
internal fun SkillsSettingsScreen(
  ...
  SettingsDetailFrame(
    title = "Skills",
    subtitle = "Installed capabilities available to NodoAssist.",
...
private fun skillSourceLabel(skill: GatewaySkillSummary): String =
  when (skill.source) {
    "nodoassist-bundled" -> if (skill.bundled) "Built-in" else "Bundled"
    "nodoassist-managed" -> "Installed"
    "nodoassist-workspace" -> "Workspace"
    "nodoassist-extra" -> "Extra"
    else -> "Skill"
  }
