...
import ai.nodoassist.app.gateway.GatewayClientInfo
import ai.nodoassist.app.gateway.GatewayConnectOptions
import ai.nodoassist.app.gateway.GatewayEndpoint
import ai.nodoassist.app.gateway.GatewayTlsParams
...
class ConnectionManager(
  ...
  fun buildUserAgent(): String {
    ...
    return "NodoAssistAndroid/$version (Android $releaseLabel; SDK ${Build.VERSION.SDK_INT})"
  }
  ...
  fun buildNodeConnectOptions(): GatewayConnectOptions =
    GatewayConnectOptions(
      ...
      client = buildClientInfo(clientId = "nodoassist-android", clientMode = "node"),
  ...
  fun buildOperatorConnectOptions(
    ...
    GatewayConnectOptions(
      ...
      commands = emptyList(),
      permissions = emptyMap(),
      client = buildClientInfo(clientId = "nodoassist-android", clientMode = "ui"),
      userAgent = buildUserAgent(),
    )
