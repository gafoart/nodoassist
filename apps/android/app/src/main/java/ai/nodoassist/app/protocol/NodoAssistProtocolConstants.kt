...
/** Capability ids advertised by the Android node to the NodoAssist gateway. */
enum class NodoAssistCapability(
  val rawValue: String,
) {
  Canvas("canvas"),
  Camera("camera"),
...
enum class NodoAssistCanvasCommand(
  val rawValue: String,
) {
...
enum class NodoAssistCanvasA2UICommand(
  val rawValue: String,
) {
...
enum class NodoAssistCameraCommand(
  val rawValue: String,
) {
  List("camera.list"),
  Snap("camera.snap"),
...
enum class NodoAssistSmsCommand(
  val rawValue: String,
) {
  Send("sms.send"),
  Search("sms.search"),
...
enum class NodoAssistTalkCommand(
  val rawValue: String,
) {
...
enum class NodoAssistLocationCommand(
  val rawValue: String,
) {
  Get("location.get"),
  ;
...
enum class NodoAssistDeviceCommand(
  val rawValue: String,
) {
...
enum class NodoAssistNotificationsCommand(
  val rawValue: String,
) {
...
enum class NodoAssistSystemCommand(
  val rawValue: String,
) {
...
enum class NodoAssistPhotosCommand(
  val rawValue: String,
) {
...
enum class NodoAssistContactsCommand(
  val rawValue: String,
) {
...
enum class NodoAssistCalendarCommand(
  val rawValue: String,
) {
...
enum class NodoAssistMotionCommand(
  val rawValue: String,
) {
...
enum class NodoAssistCallLogCommand(
  val rawValue: String,
) {
