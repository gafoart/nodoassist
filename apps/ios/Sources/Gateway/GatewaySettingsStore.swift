...
enum GatewaySettingsStore {
    private static let productionGatewayService = "ai.nodoassistfoundation.app.gateway"
    ...
    #endif
    private static let nodeService = "ai.nodoassistfoundation.app.node"
    private static let talkService = "ai.nodoassistfoundation.app.talk"
    ...
    private static let gatewayCustomHeadersService = "ai.nodoassistfoundation.app.gateway.custom-headers"
...
enum GatewayDiagnostics {
    ...
    private static let logger = Logger(subsystem: "ai.nodoassistfoundation.app", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.nodoassistfoundation.app.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("nodoassist-gateway.log")
    }
