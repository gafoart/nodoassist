...
struct CommandPanel<Content: View>: View {
    ...
    var body: some View {
        ProCard(
            ...
            radius: NodoAssistProMetric.cardRadius)
        {
            self.content
        }
    }
    ...
    var body: some View {
        HStack(alignment: .center, spacing: 12) {
            Image(systemName: self.item.icon)
                ...
                .background {
                    RoundedRectangle(cornerRadius: NodoAssistRadius.sm, style: .continuous)
...
extension View {
    func commandSessionActions(
        session: NodoAssistChatSessionEntry,
        categories: [String],
            ...
            Image(systemName: self.icon)
                ...
                .background {
                    RoundedRectangle(cornerRadius: NodoAssistRadius.xs, style: .continuous)
                        .fill(NodoAssistBrand.ok.opacity(0.10))
                }
