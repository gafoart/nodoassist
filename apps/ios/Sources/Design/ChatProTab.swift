...
struct ChatProTab: View {
    ...
    @State private var speech: NodoAssistChatSpeechController?
    ...
    var body: some View {
        ...
        .task {
            ...
            if self.speech == nil {
                ...
                self.speech = NodoAssistChatSpeechController { text in
    ...
    private var content: some View {
        self.chatSurface
                ...
                isPresented: self.$showsTranscriptExportError)
            {
                ...
                Text("NodoAssist could not prepare the Markdown file.")
                    .font(NodoAssistType.body)
            }
    }
    ...
    private var chatSurface: some View {
        if let viewModel {
            NodoAssistChatView(
                ...
                assistantAvatarTint: NodoAssistBrand.accent,
                ...
                // iMessage-style grey bubbles for agent replies in the clean chrome.
                    .environment(\.nodoAssistAssistantBubblesInCleanChrome, true)
    ...
    private var headerIdentityBadge: some View {
        Text(self.agentBadge)
            .font(NodoAssistType.avatar(size: self.agentBadge.count > 2 ? 12 : 15))
            .foregroundStyle(.white)
            .minimumScaleFactor(0.6)
            .lineLimit(1)
            .frame(width: 30, height: 30)
            .background(Circle().fill(NodoAssistBrand.accent))
    ...
    private func makeChatViewModel(sessionKey: String) -> NodoAssistChatViewModel {
        ...
        return NodoAssistChatViewModel(
    ...
    private var talkControl: NodoAssistChatTalkControl {
        NodoAssistChatTalkControl(
    ...
    private var voiceNoteControl: NodoAssistChatVoiceNoteControl {
        NodoAssistChatVoiceNoteControl(
    ...
    private func exportTranscript() {
        ...
        let directory = FileManager.default.temporaryDirectory
            .appendingPathComponent("NodoAssistTranscripts", isDirectory: true)
    ...
    private var gatewayPillColor: Color {
        ...
        case .connected:
            self.gatewayConnected ? NodoAssistBrand.ok : .secondary
        case .connecting:
    ...
    nonisolated static let emptyAssistantPrompts: [NodoAssistChatView.StarterPrompt] = [
        NodoAssistChatView.StarterPrompt(
            id: "summarize-status",
            title: String(localized: "Check NodoAssist status"),
            prompt: String(localized: "Summarize the current NodoAssist status and tell me what needs attention.")),
        NodoAssistChatView.StarterPrompt(
            id: "show-controls",
