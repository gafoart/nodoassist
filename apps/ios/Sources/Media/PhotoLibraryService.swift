...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: NodoAssistPhotosLatestParams) async throws -> NodoAssistPhotosLatestPayload {
        ...
        var results: [NodoAssistPhotoPayload] = []
        ...
        return NodoAssistPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> NodoAssistPhotoPayload
    {
