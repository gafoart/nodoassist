...
struct LocationPermissionSummary: Equatable {
    var desiredMode: NodoAssistLocationMode
    var locationServicesEnabled: Bool
    var authorizationStatus: CLAuthorizationStatus
    var accuracyAuthorization: CLAccuracyAuthorization

    var effectiveMode: NodoAssistLocationMode {
    ...
    var detailText: String {
        ...
        {
        case (.off, false, _, _):
            "Location sharing is disabled in NodoAssist. Location Services are off in iOS Settings."
        case (.off, true, .authorizedAlways, _):
            "Location sharing is disabled in NodoAssist. iOS currently allows Always."
        case (.off, true, .authorizedWhenInUse, _):
            "Location sharing is disabled in NodoAssist. iOS currently allows While Using."
        case (.off, _, _, _):
        ...
        @unknown default:
            "NodoAssist cannot determine the current iOS location permission."
        }
    }
}
