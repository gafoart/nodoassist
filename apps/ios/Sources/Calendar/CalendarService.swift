...
final class CalendarService: CalendarServicing {
    ...
    func events(params: NodoAssistCalendarEventsParams) async throws -> NodoAssistCalendarEventsPayload {
        ...
        let payload = selected.map { event in
            NodoAssistCalendarEventPayload(
        ...
        return NodoAssistCalendarEventsPayload(events: payload)
    }
    ...
    func add(params: NodoAssistCalendarAddParams) async throws -> NodoAssistCalendarAddPayload {
        ...
        let payload = NodoAssistCalendarEventPayload(
            identifier: event.eventIdentifier ?? UUID().uuidString,
        ...
        return NodoAssistCalendarAddPayload(event: payload)
    }
