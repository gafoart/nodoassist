...
struct LicenseDocumentLoaderTests {
    ...
    @Test func `derives readable titles from license filenames`() {
        ...
        #expect(LicenseDocumentLoader.title(from: "nodoassist_plugin_sdk.txt") == "nodoassist plugin sdk")
    ...
    private static func makeTemporaryDirectory() throws -> URL {
        let directory = FileManager.default.temporaryDirectory
            .appendingPathComponent("NodoAssistLicenseDocumentLoaderTests-\(UUID().uuidString)", isDirectory: true)
