# NodoAssist iOS Versioning

NodoAssist iOS release uploads use an explicit CalVer release version. The
...
```text
refs/nodoassist/mobile-releases/ios/<CFBundleShortVersionString>-<CFBundleVersion>
```

Example:

```text
refs/nodoassist/mobile-releases/ios/2026.6.11-3
```
