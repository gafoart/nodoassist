...
Maintenance update for the current NodoAssist release.
...
NodoAssist is now available on iPhone.

Connect to your NodoAssist Gateway to chat with your assistant, use realtime Talk mode, review approvals, share content from iOS, and bring device capabilities like camera, location, screen, and notifications into your private automation workflows.
...
Maintenance update for the current NodoAssist development release.
...
First App Store release of NodoAssist for iPhone. Pair with your NodoAssist Gateway to use chat, voice, sharing, and device actions from iOS.
