---
summary: "CLI reference for `nodoassist skills` (search/install/update/verify/list/info/check/workshop)"
read_when:
...
nodoassist skills search --limit 20 --json
nodoassist skills install @owner/<slug>
nodoassist skills install @owner/<slug> --version <version>
nodoassist skills install git:owner/repo
nodoassist skills install git:owner/repo@main
nodoassist skills install ./path/to/skill --as custom-name
nodoassist skills install @owner/<slug> --force
nodoassist skills install @owner/<slug> --force-install
nodoassist skills install @owner/<slug> --acknowledge-clawhub-risk
nodoassist skills install @owner/<slug> --agent <id>
nodoassist skills install @owner/<slug> --global
nodoassist skills update @owner/<slug>
nodoassist skills update @owner/<slug> --force-install
nodoassist skills update @owner/<slug> --acknowledge-clawhub-risk
nodoassist skills update @owner/<slug> --global
nodoassist skills update --all
nodoassist skills update --all --agent <id>
nodoassist skills update --all --global
nodoassist skills verify @owner/<slug>
nodoassist skills verify @owner/<slug> --version <version>
nodoassist skills verify @owner/<slug> --tag <tag>
nodoassist skills verify @owner/<slug> --card
nodoassist skills verify @owner/<slug> --global
nodoassist skills list
nodoassist skills list --eligible
nodoassist skills list --json
nodoassist skills list --verbose
nodoassist skills list --agent <id>
nodoassist skills info <name>
nodoassist skills info <name> --json
nodoassist skills info <name> --agent <id>
nodoassist skills check
nodoassist skills check --agent <id>
nodoassist skills check --json
nodoassist skills workshop propose-create --name "qa-check" --description "QA checklist" --proposal ./PROPOSAL.md
nodoassist skills workshop propose-update qa-check --proposal ./PROPOSAL.md
nodoassist skills workshop list
nodoassist skills workshop inspect <proposal-id>
nodoassist skills workshop revise <proposal-id> --proposal ./PROPOSAL.md
nodoassist skills workshop apply <proposal-id>
nodoassist skills workshop reject <proposal-id> --reason "Not reusable"
nodoassist skills workshop quarantine <proposal-id> --reason "Needs security review"
```
...
or zip/archive paths, and `nodoassist skills update` updates ClawHub-tracked
installs only.
...
| `verify` provenance              | When ClawHub returns server-resolved source provenance, verify JSON also includes a commit-pinned `nodoassist.verifiedSourceUrl`. Unavailable or self-declared source URLs stay only in the raw provenance envelope and are not promoted.                                         |
...
| Skill Card fingerprint           | Installed ClawHub bundles can include a generated `skill-card.md`. NodoAssist treats verification as a ClawHub server decision and does not reject an installed skill just because that generated card changes the bundle fingerprint.                                            |
...
skill publishers and bundled NodoAssist skill sources bypass this release-trust
prompt.

## Skill Workshop

`nodoassist skills workshop` manages pending skill proposals in the selected
...
```bash
nodoassist skills workshop propose-create \
  --name "qa-check" \
...
nodoassist skills workshop revise <proposal-id> --proposal ./PROPOSAL.md
nodoassist skills workshop apply <proposal-id>
nodoassist skills workshop reject <proposal-id> --reason "Duplicate"
nodoassist skills workshop quarantine <proposal-id> --reason "Needs security review"
```
