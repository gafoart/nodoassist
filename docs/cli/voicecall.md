---
summary: "CLI reference for `nodoassist voicecall` (voice-call plugin command surface)"
read_when:
...
nodoassist voicecall smoke    [-t <phone>] [--message <text>] [--mode <m>] [--yes] [--json]
nodoassist voicecall call     -m <text> [-t <phone>] [--mode <m>]
nodoassist voicecall start    --to <phone> [--message <text>] [--mode <m>]
nodoassist voicecall continue --call-id <id> --message <text>
nodoassist voicecall speak    --call-id <id> --message <text>
nodoassist voicecall dtmf     --call-id <id> --digits <digits>
nodoassist voicecall end      --call-id <id>
nodoassist voicecall status   [--call-id <id>] [--json]
nodoassist voicecall tail     [--file <path>] [--since <n>] [--poll <ms>]
nodoassist voicecall latency  [--file <path>] [--last <n>]
nodoassist voicecall expose   [--mode <m>] [--path <p>] [--port <port>] [--serve-path <p>]
```
...
| `--message <text>` | `NodoAssist voice call smoke test.` | Message to speak during the smoke call. |
...
nodoassist voicecall smoke --to "+15555550123"        # dry run
nodoassist voicecall smoke --to "+15555550123" --yes  # live notify call
```
...
```bash
nodoassist voicecall call --to "+15555550123" --message "Hello"
nodoassist voicecall call -m "Heads up" --mode notify
```
...
```bash
nodoassist voicecall status
nodoassist voicecall status --json
...
```bash
nodoassist voicecall expose --mode serve
nodoassist voicecall expose --mode funnel
nodoassist voicecall expose --mode off
```
