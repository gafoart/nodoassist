---
summary: "CLI reference for `nodoassist memory` (status/index/search/promote/promote-explain/rem-harness/rem-backfill)"
read_when:
...
```bash
nodoassist memory status [--agent <id>] [--deep] [--index] [--fix] [--json] [--verbose]
```
...
```bash
nodoassist memory index [--agent <id>] [--force] [--verbose]
```
...
```bash
nodoassist memory search [query] [--query <text>] [--agent <id>] [--max-results <n>] [--min-score <n>] [--json]
```
...
```bash
nodoassist memory promote [--agent <id>] [--limit <n>] [--min-score <n>] \
...
```bash
nodoassist memory promote-explain <selector> [--agent <id>] [--include-promoted] [--json]
```
...
```bash
nodoassist memory rem-harness [--agent <id>] [--path <file-or-dir>] [--grounded] [--include-promoted] [--json]
```
...
```bash
nodoassist memory rem-backfill --path <file-or-dir> [--agent <id>] [--stage-short-term] [--json]
nodoassist memory rem-backfill --rollback [--rollback-short-term] [--json]
```
