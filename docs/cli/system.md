---
summary: "CLI reference for `nodoassist system` (system events, heartbeat, presence)"
read_when:
...
nodoassist system event --text "Check for urgent follow-ups" --url ws://127.0.0.1:18789 --token "$NODOASSIST_GATEWAY_TOKEN"
nodoassist system heartbeat enable
nodoassist system heartbeat last
nodoassist system presence
```
