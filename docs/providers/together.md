...
title: "Together AI"
read_when:
  - You want to use Together AI with NodoAssist
...
NodoAssist bundles it as the `together` provider.
...
<Steps>
  ...
  <Step title="Run onboarding">
    ```bash
    nodoassist onboard --auth-choice together-api-key
    ```
  </Step>
...
<AccordionGroup>
  <Accordion title="Environment note">
    ...
    gateway processes. Use `~/.nodoassist/.env` or `env.shellEnv` config for
  ...
  <Accordion title="Troubleshooting">
    - Verify your key works: `nodoassist models list --provider together`
