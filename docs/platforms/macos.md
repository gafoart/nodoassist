---
summary: "Install and use the NodoAssist macOS menu bar app"
read_when:
...
The macOS app is the NodoAssist **menu bar companion**: native tray UI, macOS
...
Get macOS app builds from [NodoAssist GitHub releases](https://github.com/openclaw/openclaw/releases).
When a release ships macOS app assets, look for:

- `NodoAssist-<version>.dmg` (preferred)
- `NodoAssist-<version>.zip`
...
1. Install and launch **NodoAssist.app**.
...
Local mode needs an installed `nodoassist` CLI. On a fresh Mac, the app installs
