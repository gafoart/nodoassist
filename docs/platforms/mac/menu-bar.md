...
- Source: `WorkActivityStore` (`apps/macos/Sources/NodoAssist/WorkActivityStore.swift`).
...
- Settings > Debug > "Icon override" picker:
  ...
  - `Idle`
- Stored under `UserDefaults` key `nodoassist.iconOverride`; mapped to `IconState.overridden`.
