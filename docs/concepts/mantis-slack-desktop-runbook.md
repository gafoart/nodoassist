...
Linux desktop, VNC rescue, Slack Web, a real NodoAssist gateway, screenshots,
...
- **Mantis artifacts** - owned by the NodoAssist run. Live under
...
- remote logs: `slack-desktop-command.log`, `nodoassist-gateway.log`, `chrome.log`, `ffmpeg.log`
...
- `crabbox.remote_run` - sync, browser launch, NodoAssist install/build or
...
remote status but Mantis copied metadata proving either the NodoAssist gateway
