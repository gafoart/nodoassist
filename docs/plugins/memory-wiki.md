...
not currently exposing public bridge inputs. Run `nodoassist wiki doctor` first,
...
`nodoassist wiki status`, `nodoassist wiki doctor`, and `nodoassist wiki bridge
...
turn it into NodoAssist-native concept pages and compiled digests.
...
| `vault.path`                               | default `~/.nodoassist/wiki/main`              |                                                          |
...
nodoassist wiki apply synthesis "Alpha Summary" --body "..." --source-id source.alpha
