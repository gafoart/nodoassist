---
summary: "NodoAssist Anthropic Vertex provider plugin for Claude models on Google Vertex AI."
read_when:
...
NodoAssist Anthropic Vertex provider plugin for Claude models on Google Vertex AI.

## Distribution

- Package: `@nodoassist/anthropic-vertex-provider`
...
`/think off` or the native `/think xhigh|max` levels. NodoAssist publishes its
