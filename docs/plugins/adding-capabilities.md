---
summary: "Contributor guide for adding a new shared capability to the NodoAssist plugin system"
read_when:
...
<Info>
  This is a **contributor guide** for NodoAssist core developers. If you are
...
Use this when NodoAssist needs a new shared domain such as embeddings, image
