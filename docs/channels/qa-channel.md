---
summary: "Synthetic Slack-class channel plugin for deterministic NodoAssist QA scenarios"
title: "QA channel"
read_when:
...
- `botUserId` - synthetic bot user id used in target grammar (default: `nodoassist`).
- `botDisplayName` - display name for outbound messages (default: `NodoAssist QA`).
