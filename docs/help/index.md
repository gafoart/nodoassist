...
- [Doctor](/gateway/doctor) - `nodoassist doctor`: health checks, config migrations, repair steps
...
- [Environment variables](/help/environment) - where NodoAssist loads env vars and precedence
...
- [NodoAssist lore](/start/lore) - the story
