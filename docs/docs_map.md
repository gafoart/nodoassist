---
summary: "Generated heading map for NodoAssist docs pages"
...
- Headings:
  ...
  - H3: Step 6: Configure NodoAssist
...
- Headings:
  ...
  - H2: Troubleshooting
  - H3: Twilio returns 403 or NodoAssist rejects the webhook
...
- Route: /cli/approvals
- Headings:
  - H1: nodoassist approvals
  - H2: nodoassist exec-policy
  - H2: Common commands
...
- Route: /cli/devices
- Headings:
  - H1: nodoassist devices
  - H2: Common options
  - H2: Commands
  - H3: nodoassist devices list
  - H3: nodoassist devices approve [requestId] [--latest]
  - H3: nodoassist devices reject &lt;requestId&gt;
  - H3: nodoassist devices remove &lt;deviceId&gt;
  - H3: nodoassist devices clear --yes [--pending]
  - H3: nodoassist devices rotate --device &lt;id&gt; --role &lt;role&gt; [--scope &lt;scope...&gt;]
  - H3: nodoassist devices revoke --device &lt;id&gt; --role &lt;role&gt;
  - H2: Notes
  - H2: Token drift recovery checklist
  - H2: Paperclip / nodoassistgateway first-run approval
  - H2: Related
...
- Headings:
  ...
  - H2: NodoAssist as an MCP server
  ...
  - H3: Testing
  - H3: Troubleshooting
  - H2: NodoAssist as an MCP client registry
...
- Route: /cli/promos
- Headings:
  - H1: nodoassist promos
  - H2: Commands
  - H2: nodoassist promos list
  - H2: nodoassist promos claim &lt;slug&gt;
...
- Headings:
  - H2: Commands
  - H3: nodoassist sandbox list
  - H3: nodoassist sandbox recreate
  - H3: nodoassist sandbox explain
...
- Route: /cli/webhooks
- Headings:
  - H1: nodoassist webhooks
  - H2: Subcommands
  - H2: webhooks gmail setup
  - H3: Required
  - H3: Pub/Sub options
  - H3: NodoAssist delivery options
...
- Headings:
  ...
  - H2: How NodoAssist builds the system prompt
...
- Headings:
  - H1: Running NodoAssist.app with a Remote Gateway
  - H2: Setup
  - H2: How it works
  - H2: Related
...
- Headings:
  ...
  - H3: Layer 2: Gateway + dev agent smoke (what "@nodoassist" actually does)
...
- Headings:
  ...
  - H2: Local OpenAI-compatible backend works directly but fails in NodoAssist
  - H2: Plugin install fails with missing nodoassist extensions
...
- Headings:
  - H2: Prerequisites
  - H2: Option A: 1-Click NodoAssist
  - H2: Option B: NodoAssist on VPS
...
- Headings:
  ...
  - H2: Troubleshooting: nodoassist not found
...
- Headings:
  ...
  - H2: Move NodoAssist to a new machine
  - H3: Migration steps
  - H3: Common pitfalls
...
- Headings:
  ...
  - H2: Install Node
  - H2: Troubleshooting
  - H3: nodoassist: command not found
...
- Headings:
  - H2: Recommended: nodoassist update
...
- Headings:
  ...
  - H2: Config (/.nodoassist/nodoassist.json)
  - H2: macOS UI
  - H2: Android UI
  - H2: Notes
  - H2: Related
...
## nodoassist-agent-runtime.md

- Route: /nodoassist-agent-runtime
- Headings:
...
- Headings:
  ...
  - H4: /compact and explicit NodoAssist compaction
...
- Headings:
  ...
  - H2: Enable for NodoAssist (ai.nodoassist)
...
- Headings:
  - H1: NodoAssist macOS IPC architecture
  - H2: Goals
  - H2: How it works
...
- Headings:
  ...
  - H2: Install a bundle
  - H2: What NodoAssist maps from bundles
  - H3: Supported now
  - H4: Skill content
  - H4: Hook packs
  - H4: MCP for embedded NodoAssist
  - H4: Embedded NodoAssist settings
  - H4: Embedded NodoAssist LSP
...
- Headings:
  ...
  - H3: ownsNativeCompaction: opting out of NodoAssist compaction
  - H2: MCP tool bridge
...
- Headings:
  - H2: NodoAssist.app and Peekaboo
  - H2: iOS app
...
- Headings:
  - H2: Package metadata
  - H3: nodoassist fields
  - H3: nodoassist.channel
  - H3: nodoassist.install
...
- Headings:
  ...
  - H3: nodoassist.plugin.json generated metadata is stale
  - H3: package.json nodoassist.extensions must include ./dist/index.js
...
- Headings:
  - H2: Three ways to use Copilot in NodoAssist
...
- Headings:
  - H2: Built-in catalog
  - H2: Getting started
  - H2: Configure via nodoassist configure
  - H2: Capabilities
  - H3: Image generation
  - H3: Text-to-speech
  - H3: Music generation
...
- Headings:
  ...
  - H2: NodoAssist feature coverage
...
## reference/nodoassist-ai.md

- Route: /reference/nodoassist-ai
- Headings:
  - H2: Quick start
  - H2: Design contract
  - H2: Subpath exports
...
- Headings:
  ...
  - H2: NodoAssist cache-stability guards
  - H2: Tuning patterns
...
- Headings:
  ...
  - H3: nodoassist.json targets (secrets configure + secrets apply + secrets audit)
...
- Headings:
  - H1: AGENTS.md - NodoAssist Workspace
...
- Headings:
  - H1: NodoAssist v2026.6.11 Release Notes (2026-06-30)
  - H2: Highlights
...
- Headings:
  ...
  - H3: NodoAssist tools MCP bridge
...
- Headings:
  ...
  - H2: Profiles: nodoassist, user, chrome
  - H2: Configuration
...
- Headings:
  ...
  - H3: Important limitation: embedded Lobster vs nodoassist.invoke
