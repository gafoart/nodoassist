...
[Tavily](https://tavily.com) is a search API designed for AI applications. NodoAssist exposes it in two ways:
...
| --------- | --------------------------------------------------------------------------------------------- |
| Plugin id | `tavily`                                                                                      |
| Package   | `@nodoassist/tavily-plugin`                                                                   |
...
<Tip>
Choosing Tavily in onboarding or `nodoassist configure --section web` installs and enables the official Tavily plugin when needed.
</Tip>
