...
NodoAssist has two cooperating guardrails against repetitive tool-call patterns,
...
When a loop is detected, NodoAssist logs a loop event and either warns or blocks
