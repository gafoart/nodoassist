---
summary: "How NodoAssist triages, responds to, and follows up on security incidents"
...
| High     | Verified trust-boundary bypass requiring limited preconditions (for example, authenticated but unauthorized high-impact action), or exposure of NodoAssist-owned sensitive credentials. |
