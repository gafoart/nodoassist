---
summary: "NodoAssist threat model mapped to the MITRE ATLAS framework"
...
This threat model documents adversarial threats to the NodoAssist AI agent platform and ClawHub skill marketplace. It is a living document maintained by the NodoAssist community. See [Contributing to the threat model](/security/CONTRIBUTING-THREAT-MODEL) for how to report new threats, propose attack chains, or suggest mitigations.
...
| ------------------------ | -------- | ------------------------------------------------ |
| NodoAssist agent runtime | Yes      | Core agent execution, tool calls, sessions       |
...
| **Description**         | Attacker scans for exposed NodoAssist gateway endpoints              |
...
| ATLAS ID      | Technique name                 | NodoAssist threats                                               |
| ------------- | ------------------------------ | ---------------------------------------------------------------- |
...
| **ClawHub**          | NodoAssist's skill marketplace                            |
| **Gateway**          | NodoAssist's message routing and authentication layer     |
| **MCP**              | Model Context Protocol - tool provider interface          |
| **Prompt injection** | Attack where malicious instructions are embedded in input |
| **Skill**            | Downloadable extension for NodoAssist agents              |
