// Minimal @nodoassist/ai consumer: one isolated runtime, built-in providers,
// one streamed completion. Uses only the public package surface — no NodoAssist
...
const prompt =
  ...
  "Reply with one short sentence: what is @nodoassist/ai?";
