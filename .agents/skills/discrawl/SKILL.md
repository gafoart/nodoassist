...
- Repo: `nodoassist/discrawl`; use `~/GIT/_Perso/discrawl` only after verifying
  its remote targets `nodoassist/discrawl`, otherwise use a fresh checkout
...
`nodoassist/discrawl` checkout before concluding the feature is missing.
