---
name: nodoassist-refactor-docs
description: Refactor an existing NodoAssist docs page with source-audited preservation, restructuring, and verification.
---

# NodoAssist Refactor Docs

## Overview

Use this skill when the user gives a target NodoAssist docs page and asks to
rewrite, refactor, reorganize, split, shorten, or improve it.

This skill builds on `nodoassist-docs`: use that skill for style, page types,
...
Read `../nodoassist-docs/SKILL.md` first. Apply its page-type, style,
...
Before editing, decide the intended page type from `nodoassist-docs`.
