---
name: nodoassist-secret-scanning-maintainer
description: Triage, redact, clean up, and resolve NodoAssist GitHub Secret Scanning alerts in issues or PRs.
---

# NodoAssist Secret Scanning Maintainer
...
```
$REPO_ROOT/.agents/skills/nodoassist-secret-scanning-maintainer/scripts/secret-scanning.mjs
```
