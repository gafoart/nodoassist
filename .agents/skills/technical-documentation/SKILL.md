...
- Applying repository-specific documentation overlays, including NodoAssist page-type, docs IA, preservation, and validation rules when present.
...
6. For NodoAssist docs work, read `references/nodoassist.md` before the build/review playbook.
