...
When the target repo or request is NodoAssist-specific, layer `references/nodoassist.md` on top of these general rules. Otherwise ignore that repo-specific overlay.
