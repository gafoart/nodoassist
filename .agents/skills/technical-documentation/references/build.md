...
- For NodoAssist docs work, choose a page type from `references/nodoassist.md` before drafting.
- Keep task-critical NodoAssist configuration inline; link exhaustive defaults, enums, schemas, generated references, and rare debugging workflows.
...
- For NodoAssist docs work, apply the validation checklist in `references/nodoassist.md`.
