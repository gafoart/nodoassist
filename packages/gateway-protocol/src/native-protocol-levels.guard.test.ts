...
describe("native Gateway protocol levels", () => {
  it("match the TypeScript source of truth", async () => {
    ...
    const androidPath =
      "apps/android/app/src/main/java/ai/nodoassist/app/gateway/GatewayProtocol.kt";
  ...
  it("uses the min constant for native connect compatibility ranges", async () => {
    const swiftConnectFiles = [
      "apps/shared/NodoAssistKit/Sources/NodoAssistKit/GatewayChannel.swift",
      "apps/macos/Sources/NodoAssistMacCLI/WizardCommand.swift",
    ];
