...
const debugEmbeddings = isTruthyEnvValue(process.env.NODOASSIST_DEBUG_MEMORY_EMBEDDINGS);

/** Write embedding debug metadata when NODOASSIST_DEBUG_MEMORY_EMBEDDINGS is enabled. */
