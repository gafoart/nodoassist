...
/** Provider API families with first-class request/stream adapters in NodoAssist. */
...
/** Image-generation API families with first-class adapters in NodoAssist. */
...
/** Image provider ids with first-class adapters in NodoAssist. */
...
export interface UserMessage {
   ...
   * (e.g. an NodoAssist runtime-context carrier appended after the active user
...
export interface Model<TApi extends Api = Api> {
  ...
  reasoning: boolean;
  /**
   * Maps NodoAssist thinking levels to provider/model-specific values.
